...
Originally made by Brent with some code from Roblox Testing site Stacktraces, Leaked assemblies, tried to be fixed by ErringPaladin (Brr Brr Patapim) and was finished to enough to run by Intel
