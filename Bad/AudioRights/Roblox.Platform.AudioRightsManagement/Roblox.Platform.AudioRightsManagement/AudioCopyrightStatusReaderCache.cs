...
/// </summary>
public class AudioCopyrightStatusReaderCache : Roblox.Platform.AudioRightsManagement.IAudioCopyrightStatusReader
{
	...
	public bool IsAudioCopyrightProtected(Roblox.Platform.Assets.IAsset asset)
    {
        ...
        IAssetVersion currentAssetVersion = _AssetVersionFactory.GetCurrentAssetVersion((Roblox.Platform.Assets.IAsset)asset);
	...
	// Implemented implicitly via the public overload above
	...
	public System.Collections.Generic.IReadOnlyCollection<IRawContent> GetCopyrightProtectedAudio(System.Collections.Generic.IReadOnlyCollection<IRawContent> rawContents)
	{
		if (rawContents == null)
		{
			throw new ArgumentNullException("rawContents");
		}
		System.Collections.Generic.IDictionary<IRawContent, bool?> cachedStatuses = _AudioCopyrightStatusCache.GetStatuses(rawContents);
		System.Collections.Generic.HashSet<IRawContent> audioContentsWithoutCachedStatus = new System.Collections.Generic.HashSet<IRawContent>(rawContents);
		audioContentsWithoutCachedStatus.ExceptWith(cachedStatuses.Keys);
		System.Collections.Generic.IReadOnlyCollection<IRawContent> uncachedBlockedAudios = _AudioCopyrightStatusReader.GetCopyrightProtectedAudio(audioContentsWithoutCachedStatus);
		...
		System.Collections.Generic.IEnumerable<IRawContent> cachedProtectedAudios = from t in cachedStatuses
			where t.Value == true
			select t.Key;
		return (System.Collections.Generic.IReadOnlyCollection<IRawContent>)(object)uncachedBlockedAudios.Concat(cachedProtectedAudios).ToArray();
	}
}
