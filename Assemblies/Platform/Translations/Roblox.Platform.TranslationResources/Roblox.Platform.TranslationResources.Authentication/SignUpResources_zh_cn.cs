...
/// </summary>
internal class SignUpResources_zh_cn : SignUpResources_en_us, ISignUpResources, ITranslationResources
{
	/// <summary>
	...
	public SignUpResources_zh_cn(TranslationResourceState state)
		: base(state)
	{
	}
