...
/// </summary>
internal class GameFollowsResources_zh_cn : GameFollowsResources_en_us, IGameFollowsResources, ITranslationResources
{
	/// <summary>
	/// Key: "ActionCancel"
	...
	public GameFollowsResources_zh_cn(TranslationResourceState state)
		: base(state)
	{
	}
