...

{
	...
	/// </summary>
	string ExampleComment { get; }

	/// <summary>
	/// Key: "Heading.ReportAbuse"
	/// English String: "Report Abuse"
	/// </summary>
	string HeadingReportAbuse { get; }
