...
/// </summary>
internal class ShopDialogResources_zh_cn : ShopDialogResources_en_us, IShopDialogResources, ITranslationResources
{
	/// <summary>
	/// Key: "Action.Cancel"
	/// button text
	...
	public ShopDialogResources_zh_cn(TranslationResourceState state)
		: base(state)
	{
	}
