...
internal class SurveysGameRatingsResources_zh_cjv : SurveysGameRatingsResources_en_us, ISurveysGameRatingsResources, ITranslationResources
{
	...
	/// </summary>
	public override string DescriptionAnswerToDoesThisGameContainFrequently => "ç»å¸¸å‡ºçŽ°";
	...
	/// </summary>
	public override string DescriptionAnswerToDoesThisGameContainInfrequently => "ä¸å¸¸å‡ºçŽ°";
	...
	/// English String: "No"
	/// </summary>
	public override string DescriptionAnswerToDoesThisGameContainNo => "å¦";
	...
	/// English String: "Yes"
	/// </summary>
	public override string DescriptionAnswerToDoesThisGameContainYes => "æ˜¯";
	...
	/// </summary>
	public override string DescriptionCanUsersWagerRobuxInGameCurrencyPurchasedWithRobuxOrOtherItemsOfRealValue => "ç”¨æˆ·æ˜¯å¦èƒ½ä»¥ Robuxã€ç”¨ Robux è´­ä¹°çš„æ¸¸æˆå†…è´§å¸æˆ–å…¶ä»–æœ‰å®žé™…ä»·å€¼çš„é“å…·æ¥ä¸‹æ³¨ï¼Ÿ";
	...
	/// </summary>
	public override string DescriptionDefenselessViolenceQuestion => "æ­¤æ¸¸æˆæ˜¯å¦åŒ…å«é’ˆå¯¹æ— é˜²å¾¡èƒ½åŠ›è§’è‰²çš„æš´åŠ›è¡Œä¸ºï¼Ÿ";
	...
	/// </summary>
	public override string DescriptionDoesThisGameContainBathroomHumor => "æ­¤æ¸¸æˆæ˜¯å¦åŒ…å«ä¸ŽæŽ’æ³„ç‰©ç›¸å…³çš„ç¬‘è¯ï¼Ÿ";
	...
	/// </summary>
	public override string DescriptionDoesThisGameContainCrudeHumor => "æ­¤æ¸¸æˆæ˜¯å¦åŒ…å«é»„è‰²ç¬‘è¯ï¼Ÿ";
	...
	/// </summary>
	public override string DescriptionDoesThisGameContainNudityOrDepictionsOfSex => "æ­¤æ¸¸æˆæ˜¯å¦åŒ…å«è£¸éœ²ç”»é¢æˆ–è‰²æƒ…æè¿°ï¼Ÿ";
	...
	/// </summary>
	public override string DescriptionDoesThisGameContainReferencesToAlcoholTobaccoOrDrugs => "æ­¤æ¸¸æˆæ˜¯å¦åŒ…å«æœ‰å…³é…’ç²¾ã€é¦™çƒŸæˆ–æ¯’å“çš„å†…å®¹ï¼Ÿ";
	...
	/// </summary>
	public override string DescriptionDoesThisGameContainReferencesToAlcoholTobaccoOrDrugsCharactersAreShownUsingAlcoholTobac => "åŒ…å«è§’è‰²ä½¿ç”¨é…’ç²¾ã€é¦™çƒŸæˆ–æ¯’å“çš„ç”»é¢";
	...
	/// </summary>
	public override string DescriptionDoesThisGameContainReferencesToAlcoholTobaccoOrDrugsFrequentReferences => "ç»å¸¸å‡ºçŽ°";
	...
	/// </summary>
	public override string DescriptionDoesThisGameContainReferencesToAlcoholTobaccoOrDrugsInfrequentReferences => "ä¸å¸¸å‡ºçŽ°";
	...
	/// English String: "No"
	/// </summary>
	public override string DescriptionDoesThisGameContainReferencesToAlcoholTobaccoOrDrugsNo => "å¦";
	...
	/// </summary>
	public override string DescriptionDoesThisGameContainSimulatedGamblingOrPaidLootBoxes => "æ­¤æ¸¸æˆæ˜¯å¦åŒ…å«æ¨¡æ‹ŸèµŒåšæˆ–éœ€ä»˜è´¹çš„æˆ˜åˆ©å“ç®±ï¼Ÿ";
	...
	/// </summary>
	public override string DescriptionDoesThisGameContainSuggestiveSexualThemes => "æ­¤æ¸¸æˆæ˜¯å¦åŒ…å«æš—ç¤ºçš„æ€§ä¸»é¢˜ï¼Ÿ";
	...
	/// </summary>
	public override string DescriptionDoesThisGameFollowTheCommunityRules => "æ­¤æ¸¸æˆæ˜¯å¦éµå®ˆç¤¾åŒºè§„åˆ™ï¼Ÿ ";
	...
	/// English String: "No"
	/// </summary>
	public override string DescriptionDoesThisGameFollowTheCommunityRulesNo => "å¦";
	...
	/// English String: "Yes"
	/// </summary>
	public override string DescriptionDoesThisGameFollowTheCommunityRulesYes => "æ˜¯";
	...
	/// </summary>
	public override string DescriptionDoesThisGameUseProfanity => "æ­¤æ¸¸æˆæ˜¯å¦åŒ…å«è„è¯ï¼Ÿ";
	...
	/// </summary>
	public override string DescriptionDoesThisGameUseProfanityFrequentProfanity => "ç»å¸¸å‡ºçŽ°è„è¯";
	...
	/// </summary>
	public override string DescriptionDoesThisGameUseProfanityInfrequentProfanity => "ä¸å¸¸å‡ºçŽ°è„è¯";
	...
	/// English String: "No"
	/// </summary>
	public override string DescriptionDoesThisGameUseProfanityNo => "å¦";
	...
	/// </summary>
	public override string DescriptionDoesThisGameUseProfanitySomeMildBadLanguage => "ä¸€äº›è¾ƒæ¸©å’Œçš„è„è¯";
	...
	/// </summary>
	public override string DescriptionScaryForChildUnderEightQuestion => "æ­¤æ¸¸æˆæ˜¯å¦åŒ…å«å¯èƒ½å“åˆ° 8 å²ä»¥ä¸‹å„¿ç«¥çš„å†…å®¹ï¼Ÿ";
	...
	/// </summary>
	public override string DescriptionScaryForChildUnderTwelveQuestion => "æ­¤æ¸¸æˆæ˜¯å¦åŒ…å«å¯èƒ½å“åˆ° 12 å²ä»¥ä¸‹å„¿ç«¥çš„å†…å®¹ï¼Ÿ";
	...
	/// </summary>
	public override string DescriptionViolenceQuestionComicalViolence => "å–œå‰§å¼æš´åŠ›";
	...
	/// </summary>
	public override string DescriptionViolenceQuestionDoesThisGameContainViolentContent => "æ­¤æ¸¸æˆæ˜¯å¦åŒ…å«æš´åŠ›å†…å®¹ï¼Ÿ";
	...
	/// </summary>
	public override string DescriptionViolenceQuestionEasilyDistinguishableFromRealLife => "å¯è½»æ˜“ä¸ŽçŽ°å®žåŒºåˆ†çš„æš´åŠ›";
	...
	/// </summary>
	public override string DescriptionViolenceQuestionExtremeRealisticViolence => "æžåº¦é€¼çœŸçš„æš´åŠ›";
	...
	/// English String: "No"
	/// </summary>
	public override string DescriptionViolenceQuestionNo => "å¦";
	...
	/// </summary>
	public override string DescriptionViolenceQuestionSomeRealisticViolence => "ç•¥å¾®é€¼çœŸçš„æš´åŠ›";
	...
	{
		return "åŒ…å«è§’è‰²ä½¿ç”¨é…’ç²¾ã€é¦™çƒŸæˆ–æ¯’å“çš„ç”»é¢";
	}
