...
internal class PlaceThumbnailsResources_de_de : PlaceThumbnailsResources_en_us, IPlaceThumbnailsResources, ITranslationResources
{
	...
	/// </summary>
	public override string DescriptionLeaveRobloxForYouTube => "Du verlÃ¤sst jetzt Roblox, um dir ein Video auf YouTube anzusehen.";
	...
	/// </summary>
	public override string DescriptionYouTubeIsNotRoblox => "YouTube gehÃ¶rt nicht zu Roblox.com und unterliegt seinen eigenen Datenschutzrichtlinien.";
	...
	{
		return "Du verlÃ¤sst jetzt Roblox, um dir ein Video auf YouTube anzusehen.";
	}

	protected override string _GetTemplateForDescriptionYouTubeIsNotRoblox()
	{
		return "YouTube gehÃ¶rt nicht zu Roblox.com und unterliegt seinen eigenen Datenschutzrichtlinien.";
	}
