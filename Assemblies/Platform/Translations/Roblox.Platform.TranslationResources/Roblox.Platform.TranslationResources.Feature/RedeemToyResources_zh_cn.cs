...
/// </summary>
internal class RedeemToyResources_zh_cn : RedeemToyResources_en_us, IRedeemToyResources, ITranslationResources
{
	/// <summary>
	/// Key: "Action.Cancel"
	/// button text
	...
	public RedeemToyResources_zh_cn(TranslationResourceState state)
		: base(state)
	{
	}
