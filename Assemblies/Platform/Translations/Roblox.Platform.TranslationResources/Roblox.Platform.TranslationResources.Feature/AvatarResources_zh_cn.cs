...
internal class AvatarResources_zh_cn : AvatarResources_en_us, IAvatarResources, ITranslationResources
{
	...
	/// </summary>
	public override string ActionAdvanced => "é«˜çº§";
	...
	/// English String: "Create"
	/// </summary>
	public override string ActionCreateNewOutfit => "åˆ›å»º";
	...
	/// </summary>
	public override string ActionOpenRobloxApp => "æ‰“å¼€ Roblox App";
	...
	/// </summary>
	public override string ActionRedraw => "é‡ç»˜";

	/// <summary>
	/// Key: "Action.Rename"
	/// English String: "Rename"
	/// </summary>
	public override string ActionRename => "é‡å‘½å";
	...
	/// English String: "Rename"
	/// </summary>
	public override string ActionRenameOutfit => "é‡å‘½å";
	...
	/// </summary>
	public override string ActionUserUnderstands => "æ˜Žç™½";

	/// <summary>
	/// Key: "Description.AvatarEditorUpsell"
	/// English String: "To change your look you will need to use the Avatar Editor on the App."
	/// </summary>
	public override string DescriptionAvatarEditorUpsell => "è‹¥è¦æ›´æ”¹ä½ çš„å¤–è§‚ï¼Œä½ éœ€è¦åœ¨ App ä¸Šä½¿ç”¨è™šæ‹Ÿå½¢è±¡ç¼–è¾‘å™¨ã€‚";
	...
	/// </summary>
	public override string DescriptionCreateNewCostume => "å°†æ ¹æ®ä½ çš„è™šæ‹Ÿå½¢è±¡çš„å½“å‰å¤–è§‚åˆ›å»ºä¸€å¥—è£…æ‰®ã€‚";
	...
	/// </summary>
	public override string DescriptionCreateNewOutfit => "å°†æ ¹æ®ä½ çš„è™šæ‹Ÿå½¢è±¡çš„å½“å‰å¤–è§‚åˆ›å»ºä¸€å¥—ç©¿æ­ã€‚";
	...
	/// </summary>
	public override string DescriptionRenameCostume => "ä¸ºä½ çš„è£…æ‰®é€‰æ‹©ä¸€ä¸ªæ–°åç§°ã€‚";
	...
	/// </summary>
	public override string DescriptionRenameOutfit => "ä¸ºä½ çš„ç©¿æ­é€‰æ‹©ä¸€ä¸ªæ–°åç§°ã€‚";
	...
	/// </summary>
	public override string HeadingAccessoriesChange => "é…é¥°æ›´æ”¹";

	/// <summary>
	/// Key: "Heading.AdvancedOptions"
	/// English String: "Advanced Options"
	/// </summary>
	public override string HeadingAdvancedOptions => "é«˜çº§é€‰é¡¹";
	...
	/// </summary>
	public override string HeadingAnimations => "åŠ¨ç”»";
	...
	/// </summary>
	public override string HeadingAvatarPageTitle => "è™šæ‹Ÿå½¢è±¡ç¼–è¾‘å™¨";

	/// <summary>
	/// Key: "Heading.Body"
	/// English String: "Body"
	/// </summary>
	public override string HeadingBody => "èº«ä½“";

	/// <summary>
	/// Key: "Heading.BodyParts"
	/// English String: "Body Parts"
	/// </summary>
	public override string HeadingBodyParts => "èº«ä½“éƒ¨ä»¶";
	...
	/// </summary>
	public override string HeadingCreateNewCostume => "åˆ›å»ºæ–°è£…æ‰®";

	/// <summary>
	/// Key: "Heading.CreateNewOutfit"
	/// English String: "Create New Outfit"
	/// </summary>
	public override string HeadingCreateNewOutfit => "åˆ›å»ºæ–°ç©¿æ­";

	/// <summary>
	/// Key: "Heading.Delete"
	/// English String: "Delete"
	/// </summary>
	public override string HeadingDelete => "åˆ é™¤";
	...
	/// </summary>
	public override string HeadingDeleteCostume => "åˆ é™¤è£…æ‰®";

	/// <summary>
	/// Key: "Heading.DeleteOutfit"
	/// English String: "Delete Outfit"
	/// </summary>
	public override string HeadingDeleteOutfit => "åˆ é™¤ç©¿æ­";

	/// <summary>
	/// Key: "Heading.Emotes"
	/// English String: "Emotes"
	/// </summary>
	public override string HeadingEmotes => "åŠ¨ä½œ";

	/// <summary>
	/// Key: "Heading.EquipEmotes"
	/// English String: "Equip Emotes"
	/// </summary>
	public override string HeadingEquipEmotes => "è£…å¤‡åŠ¨ä½œ";

	/// <summary>
	/// Key: "Heading.Outfits"
	/// English String: "Outfits"
	/// </summary>
	public override string HeadingOutfits => "ç©¿æ­";
	...
	/// </summary>
	public override string HeadingRenameCostume => "é‡å‘½åè£…æ‰®";

	/// <summary>
	/// Key: "Heading.RenameOutfit"
	/// English String: "Rename Outfit"
	/// </summary>
	public override string HeadingRenameOutfit => "é‡å‘½åç©¿æ­";

	/// <summary>
	/// Key: "Heading.Scaling"
	/// English String: "Scaling"
	/// </summary>
	public override string HeadingScaling => "æ¯”ä¾‹";

	/// <summary>
	/// Key: "Heading.SkinToneBodyParts"
	/// English String: "Skin Tone by Body Parts"
	/// </summary>
	public override string HeadingSkinToneBodyParts => "æŒ‰èº«ä½“éƒ¨ä»¶çš„è‚¤è‰²";
	...
	/// </summary>
	public override string HeadingUpdateOutfit => "æ›´æ–°ç©¿æ­";
	...
	/// </summary>
	public override string LabelAskIfLoadingCorrectly => "è™šæ‹Ÿå½¢è±¡æœªæ­£ç¡®åŠ è½½ï¼Ÿ";
	...
	/// </summary>
	public override string LabelBackAccessories => "èƒŒé¢é…é¥°";

	/// <summary>
	/// Key: "Label.BodyType"
	/// English String: "Body Type"
	/// </summary>
	public override string LabelBodyType => "ä½“åž‹";
	...
	/// </summary>
	public override string LabelClimbAnimations => "æ”€çˆ¬åŠ¨ç”»";

	/// <summary>
	/// Key: "Label.Clothes"
	/// English String: "Clothes"
	/// </summary>
	public override string LabelClothes => "æœè£…";
	...
	/// </summary>
	public override string LabelExploreCatalog => "æŽ¢ç´¢å•†åº—ï¼Œå‘çŽ°æ›´å¤šï¼";

	/// <summary>
	/// Key: "Label.Face"
	/// English String: "Face"
	/// </summary>
	public override string LabelFace => "è¡¨æƒ…";

	/// <summary>
	/// Key: "Label.FaceAccessories"
	/// English String: "Face Accessories"
	/// </summary>
	public override string LabelFaceAccessories => "è„¸éƒ¨é…é¥°";
	...
	/// English String: "Fall"
	/// </summary>
	public override string LabelFall => "ä¸‹è½";

	/// <summary>
	/// Key: "Label.FallAnimations"
	/// English String: "Fall Animations"
	/// </summary>
	public override string LabelFallAnimations => "ä¸‹è½åŠ¨ç”»";
	...
	/// </summary>
	public override string LabelFrontAccessories => "æ­£é¢é…é¥°";
	...
	/// English String: "Hair"
	/// </summary>
	public override string LabelHair => "å‘åž‹";

	/// <summary>
	/// Key: "Label.HairAccessories"
	/// English String: "Hair Accessories"
	/// </summary>
	public override string LabelHairAccessories => "å‘åž‹é…é¥°";
	...
	/// </summary>
	public override string LabelHatAccessories => "å¸½å­é…é¥°";

	/// <summary>
	/// Key: "Label.Head"
	/// English String: "Head"
	/// </summary>
	public override string LabelHead => "å¤´éƒ¨";

	/// <summary>
	/// Key: "Label.Heads"
	/// English String: "Heads"
	/// </summary>
	public override string LabelHeads => "å¤´éƒ¨";
	...
	/// </summary>
	public override string LabelIdleAnimations => "é—²ç½®åŠ¨ç”»";

	/// <summary>
	/// Key: "Label.Jump"
	/// English String: "Jump"
	/// </summary>
	public override string LabelJump => "è·³è·ƒ";

	/// <summary>
	/// Key: "Label.JumpAnimations"
	/// English String: "Jump Animations"
	/// </summary>
	public override string LabelJumpAnimations => "è·³è·ƒåŠ¨ç”»";
	...
	/// </summary>
	public override string LabelNamePlaceholderCostume => "å‘½åä½ çš„è£…æ‰®";

	/// <summary>
	/// Key: "Label.NamePlaceholderOutfit"
	/// English String: "Name your outfit"
	/// </summary>
	public override string LabelNamePlaceholderOutfit => "å‘½åä½ çš„ç©¿æ­";

	/// <summary>
	/// Key: "Label.Neck"
	/// English String: "Neck"
	/// </summary>
	public override string LabelNeck => "é¢ˆéƒ¨";

	/// <summary>
	/// Key: "Label.NeckAccessories"
	/// English String: "Neck Accessories"
	/// </summary>
	public override string LabelNeckAccessories => "é¢ˆéƒ¨é…é¥°";
	...
	/// </summary>
	public override string LabelOutfit => "ç©¿æ­";
	...
	/// </summary>
	public override string LabelRedrawUnavailable => "æ— æ³•é‡ç»˜è™šæ‹Ÿå½¢è±¡ã€‚";
	...
	/// </summary>
	public override string LabelRunAnimations => "å¥”è·‘åŠ¨ç”»";
	...
	/// </summary>
	public override string LabelShoulderAccessories => "è‚©éƒ¨é…é¥°";

	/// <summary>
	/// Key: "Label.Shoulders"
	/// English String: "Shoulders"
	/// </summary>
	public override string LabelShoulders => "è‚©éƒ¨";

	/// <summary>
	/// Key: "Label.SkinTone"
	/// English String: "Skin Tone"
	/// </summary>
	public override string LabelSkinTone => "è‚¤è‰²";
	...
	/// </summary>
	public override string LabelSwimAnimations => "æ¸¸æ³³åŠ¨ç”»";
	...
	/// </summary>
	public override string LabelSwitchAvatarType => "åœ¨ç»å…¸ R6 è™šæ‹Ÿå½¢è±¡å’Œæ›´å…·è¡¨çŽ°åŠ›çš„ä¸‹ä¸€ä»£ R15 è™šæ‹Ÿå½¢è±¡ä¹‹é—´åˆ‡æ¢";

	/// <summary>
	/// Key: "Label.Torso"
	/// English String: "Torso"
	/// </summary>
	public override string LabelTorso => "èº¯å¹²";

	/// <summary>
	/// Key: "Label.Torsos"
	/// English String: "Torsos"
	/// </summary>
	public override string LabelTorsos => "èº¯å¹²";
	...
	/// </summary>
	public override string LabelWaistAccessories => "è…°éƒ¨é…é¥°";
	...
	/// </summary>
	public override string LabelWalkAnimations => "æ­¥è¡ŒåŠ¨ç”»";
	...
	/// </summary>
	public override string LabelYourEmotes => "ä½ çš„è¡¨æƒ…";

	/// <summary>
	/// Key: "Message.AccessoriesChange"
	/// English String: "Are you sure you want to override your current look?"
	/// </summary>
	public override string MessageAccessoriesChange => "æ˜¯å¦ç¡®å®šè¦è¦†ç›–ä½ çš„å½“å‰å¤–è§‚ï¼Ÿ";

	/// <summary>
	/// Key: "Message.ChooseEmote"
	/// English String: "Choose an Emote"
	/// </summary>
	public override string MessageChooseEmote => "é€‰æ‹©åŠ¨ä½œ";
	...
	/// </summary>
	public override string MessageChooseEmoteSlotOrEmote => "é€‰æ‹©æ ä½æˆ–åŠ¨ä½œ";
	...
	/// </summary>
	public override string MessageDefaultClothing => "é»˜è®¤æœè£…å·²åº”ç”¨è‡³ä½ çš„è™šæ‹Ÿå½¢è±¡ï¼Œè¯·ä»Žä½ çš„æœè£…ä¸­è‡ªç”±é€‰æ‹©ã€‚";
	...
	/// </summary>
	public override string MessageDeleteThisCostume => "æ˜¯å¦ç¡®å®šè¦åˆ é™¤æ­¤è£…æ‰®ï¼Ÿ";

	/// <summary>
	/// Key: "Message.DeleteThisOutfit"
	/// English String: "Are you sure you want to delete this outfit?"
	/// </summary>
	public override string MessageDeleteThisOutfit => "æ˜¯å¦ç¡®å®šè¦åˆ é™¤æ­¤ç©¿æ­ï¼Ÿ";
	...
	/// </summary>
	public override string MessageEmotesInstructions => "å‰å¾€â€œåŠ¨ç”»â€>â€œåŠ¨ä½œâ€>â€œè£…å¤‡åŠ¨ä½œâ€ä»¥è£…å¤‡åŠ¨ä½œã€‚";
	...
	/// </summary>
	public override string MessageEmptyAssetList => "ä½ æ²¡æœ‰ä»»ä½•ç´ æã€‚";
	...
	/// </summary>
	public override string MessageEmptyListOfCostumes => "ä½ æ²¡æœ‰ä»»ä½•è£…æ‰®ã€‚è¯·å°è¯•åˆ›å»ºä¸€äº›ï¼";
	...
	/// </summary>
	public override string MessageEmptyListOfOutfits => "ä½ æ²¡æœ‰ä»»ä½•ç©¿æ­ã€‚è¯·å°è¯•åˆ›å»ºä¸€äº›ç©¿æ­å§ï¼";

	/// <summary>
	/// Key: "Message.EmptyRecentItems"
	/// English String: "You don't have any recent items."
	/// </summary>
	public override string MessageEmptyRecentItems => "ä½ æ²¡æœ‰ä»»ä½•æœ€è¿‘ä½¿ç”¨è¿‡çš„ç‰©å“ã€‚";

	/// <summary>
	/// Key: "Message.ErrorCreateCostume"
	/// English String: "Unable to create costume, try again later."
	/// </summary>
	public override string MessageErrorCreateCostume => "æ— æ³•åˆ›å»ºè£…æ‰®ï¼Œè¯·ç¨åŽé‡è¯•ã€‚";

	/// <summary>
	/// Key: "Message.ErrorCreateOutfit"
	/// English String: "Unable to create outfit, try again later."
	/// </summary>
	public override string MessageErrorCreateOutfit => "æ— æ³•åˆ›å»ºç©¿æ­ï¼Œè¯·ç¨åŽé‡è¯•ã€‚";

	/// <summary>
	/// Key: "Message.ErrorDeleteEmote"
	/// English String: "Failed to delete emote."
	/// </summary>
	public override string MessageErrorDeleteEmote => "æ— æ³•åˆ é™¤åŠ¨ä½œã€‚";

	/// <summary>
	/// Key: "Message.ErrorEquipEmote"
	/// English String: "Failed to equip emote, please try again later."
	/// </summary>
	public override string MessageErrorEquipEmote => "æ— æ³•è£…å¤‡åŠ¨ä½œï¼Œè¯·ç¨åŽé‡è¯•ã€‚";

	/// <summary>
	/// Key: "Message.ErrorLoadCostume"
	/// English String: "Failed to load costume."
	/// </summary>
	public override string MessageErrorLoadCostume => "åŠ è½½è£…æ‰®å¤±è´¥ã€‚";

	/// <summary>
	/// Key: "Message.ErrorLoadEmotes"
	/// English String: "Failed to load emotes."
	/// </summary>
	public override string MessageErrorLoadEmotes => "æ— æ³•åŠ è½½åŠ¨ä½œã€‚";

	/// <summary>
	/// Key: "Message.ErrorLoadOutfits"
	/// English String: "Failed to load outfits."
	/// </summary>
	public override string MessageErrorLoadOutfits => "åŠ è½½ç©¿æ­å¤±è´¥ã€‚";

	/// <summary>
	/// Key: "Message.ErrorOutfitName"
	/// English String: "Name can contain letters, numbers, and spaces."
	/// </summary>
	public override string MessageErrorOutfitName => "åç§°å¯ä»¥åŒ…å«å­—æ¯ã€æ•°å­—å’Œç©ºæ ¼ã€‚";

	/// <summary>
	/// Key: "Message.ErrorRenameCostume"
	/// English String: "Failed to rename costume."
	/// </summary>
	public override string MessageErrorRenameCostume => "é‡å‘½åè£…æ‰®å¤±è´¥ã€‚";

	/// <summary>
	/// Key: "Message.ErrorRenameOutfit"
	/// English String: "Failed to rename outfit."
	/// </summary>
	public override string MessageErrorRenameOutfit => "é‡å‘½åç©¿æ­å¤±è´¥ã€‚";

	/// <summary>
	/// Key: "Message.ErrorUnequipEmote"
	/// English String: "Failed to unequip emote."
	/// </summary>
	public override string MessageErrorUnequipEmote => "æ— æ³•å¸ä¸‹åŠ¨ä½œã€‚";

	/// <summary>
	/// Key: "Message.ErrorUpdateCostume"
	/// English String: "Costume update failed, please try again later."
	/// </summary>
	public override string MessageErrorUpdateCostume => "è£…æ‰®æ›´æ–°å¤±è´¥ï¼Œè¯·ç¨åŽé‡è¯•ã€‚";

	/// <summary>
	/// Key: "Message.ErrorUpdateEmote"
	/// English String: "Updating emote slot failed, please try again later."
	/// </summary>
	public override string MessageErrorUpdateEmote => "æ— æ³•æ›´æ–°åŠ¨ä½œæ ä½ï¼Œè¯·ç¨å€™é‡è¯•ã€‚";

	/// <summary>
	/// Key: "Message.ErrorUpdateOutfit"
	/// English String: "Outfit update failed, please try again later."
	/// </summary>
	public override string MessageErrorUpdateOutfit => "ç©¿æ­æ›´æ–°å¤±è´¥ï¼Œè¯·ç¨åŽé‡è¯•ã€‚";
	...
	/// </summary>
	public override string MessageErrorUpdateWorn => "æ›´æ–°å·²ç©¿æˆ´ç‰©å“æ—¶å‡ºé”™ã€‚";

	/// <summary>
	/// Key: "Message.ErrorWearCostume"
	/// English String: "Failed to wear costume."
	/// </summary>
	public override string MessageErrorWearCostume => "å®Œæˆè£…æ‰®å¤±è´¥ã€‚";

	/// <summary>
	/// Key: "Message.ErrorWearOutfit"
	/// English String: "Failed to wear outfit."
	/// </summary>
	public override string MessageErrorWearOutfit => "å®Œæˆç©¿æ­å¤±è´¥ã€‚";

	/// <summary>
	/// Key: "Message.FailedDeleteCostume"
	/// English String: "Failed to delete costume."
	/// </summary>
	public override string MessageFailedDeleteCostume => "åˆ é™¤è£…æ‰®å¤±è´¥ã€‚";

	/// <summary>
	/// Key: "Message.FailedDeleteEmote"
	/// English String: "Failed to delete emote."
	/// </summary>
	public override string MessageFailedDeleteEmote => "æ— æ³•åˆ é™¤åŠ¨ä½œã€‚";

	/// <summary>
	/// Key: "Message.FailedDeleteOutfit"
	/// English String: "Failed to delete outfit."
	/// </summary>
	public override string MessageFailedDeleteOutfit => "åˆ é™¤ç©¿æ­å¤±è´¥ã€‚";

	/// <summary>
	/// Key: "Message.FailedLoadAssets"
	/// English String: "Failed to load assets list."
	/// </summary>
	public override string MessageFailedLoadAssets => "åŠ è½½èµ„äº§åˆ—è¡¨å¤±è´¥ã€‚";

	/// <summary>
	/// Key: "Message.FailedLoadRecent"
	/// English String: "Failed to load recent items."
	/// </summary>
	public override string MessageFailedLoadRecent => "æ— æ³•åŠ è½½æœ€è¿‘ç‰©å“ã€‚";

	/// <summary>
	/// Key: "Message.FailedUpdateBodyColor"
	/// English String: "Failed to update skin tone."
	/// </summary>
	public override string MessageFailedUpdateBodyColor => "æ›´æ–°è‚¤è‰²å¤±è´¥ã€‚";
	...
	/// </summary>
	public override string MessageFailedUpdateDeletedCostume => "ä½ å°è¯•æ›´æ–°çš„è£…æ‰®å·²ä¸å­˜åœ¨ã€‚";
	...
	/// </summary>
	public override string MessageFailedUpdateDeletedOutfit => "ä½ å°è¯•æ›´æ–°çš„ç©¿æ­å·²ä¸å­˜åœ¨ã€‚";

	/// <summary>
	/// Key: "Message.FailedUpdateScales"
	/// English String: "Failed to update scales."
	/// </summary>
	public override string MessageFailedUpdateScales => "æ›´æ–°æ¯”ä¾‹å¤±è´¥ã€‚";
	...
	/// </summary>
	public override string MessageFailedUpdateType => "æ›´æ–°è™šæ‹Ÿå½¢è±¡ç±»åž‹å¤±è´¥ã€‚";

	/// <summary>
	/// Key: "Message.FailedWearPackage"
	/// English String: "Failed to wear package."
	/// </summary>
	public override string MessageFailedWearPackage => "ç©¿æˆ´å¥—è£…å¤±è´¥ã€‚";

	/// <summary>
	/// Key: "Message.HatLimitTooltip"
	/// English String: "You can wear up to 3 hats"
	/// </summary>
	public override string MessageHatLimitTooltip => "ä½ æœ€å¤šå¯æˆ´ 3 é¡¶å¸½å­";

	/// <summary>
	/// Key: "Message.InvalidOutfitName"
	/// English String: "Name must be appropriate and less than 200 characters."
	/// </summary>
	public override string MessageInvalidOutfitName => "åç§°å¿…é¡»é€‚å½“ï¼Œä¸”å°‘äºŽ 200 ä¸ªå­—ç¬¦ã€‚";
	...
	/// </summary>
	public override string MessagePageUnavailable => "è™šæ‹Ÿå½¢è±¡é¡µé¢æš‚æ—¶ä¸å¯ç”¨ã€‚";
	...
	/// </summary>
	public override string MessagePresetCostumesDelay => "è¯·æ³¨æ„ï¼šæˆ‘ä»¬æ­£è¿›è¡Œä¸€äº›ç»´æŠ¤ï¼Œä½ çš„æ‰€æœ‰ç©¿æ­å¯èƒ½éœ€è¦å‡ åˆ†é’Ÿçš„æ—¶é—´æ‰èƒ½æ˜¾ç¤ºã€‚è¯·ç¨åŽå†æŸ¥çœ‹ï¼";

	/// <summary>
	/// Key: "Message.ReachedMaxCostumes"
	/// English String: "You have reached the maximum number of costumes."
	/// </summary>
	public override string MessageReachedMaxCostumes => "ä½ çš„è£…æ‰®æ•°é‡å·²è¾¾ä¸Šé™ã€‚";

	/// <summary>
	/// Key: "Message.ReachedMaxOutfits"
	/// English String: "You have reached the maximum number of outfits."
	/// </summary>
	public override string MessageReachedMaxOutfits => "ä½ çš„ç©¿æ­æ•°é‡å·²è¾¾ä¸Šé™ã€‚";
	...
	/// </summary>
	public override string MessageRedirectAvatarSettings => "ä½ å¯ä»¥åœ¨ Roblox Studio é¡¹ç›®ä¸­è¿›è¡Œè™šæ‹Ÿå½¢è±¡è®¾ç½®ã€‚åœ¨ Roblox Studio ä¸­ï¼Œå‰å¾€é¦–é¡µ > æ¸¸æˆè®¾ç½® > è™šæ‹Ÿå½¢è±¡";

	/// <summary>
	/// Key: "Message.RedrawFloodchecked"
	/// English String: "You have redrawn your avatar too many times, please try again later."
	/// </summary>
	public override string MessageRedrawFloodchecked => "ä½ é‡ç»˜è™šæ‹Ÿå½¢è±¡çš„æ¬¡æ•°è¿‡å¤šï¼Œè¯·ç¨åŽé‡è¯•ã€‚";

	/// <summary>
	/// Key: "Message.RedrawThumbnailFailed"
	/// English String: "Failed to redraw thumbnail."
	/// </summary>
	public override string MessageRedrawThumbnailFailed => "æ— æ³•é‡ç»˜ç¼©ç•¥å›¾ã€‚";
	...
	/// </summary>
	public override string MessageSelectEnableScaling => "é€‰æ‹© R15 ä»¥å¯ç”¨æ¯”ä¾‹ã€‚";
	...
	/// </summary>
	public override string MessageSuccessCreateCostume => "å·²åˆ›å»ºè£…æ‰®";

	/// <summary>
	/// Key: "Message.SuccessCreateOutfit"
	/// English String: "Created outfit"
	/// </summary>
	public override string MessageSuccessCreateOutfit => "å·²åˆ›å»ºç©¿æ­";
	...
	/// </summary>
	public override string MessageSuccessDeleteCostume => "å·²åˆ é™¤è£…æ‰®";

	/// <summary>
	/// Key: "Message.SuccessDeleteOutfit"
	/// English String: "Deleted outfit"
	/// </summary>
	public override string MessageSuccessDeleteOutfit => "å·²åˆ é™¤ç©¿æ­";

	/// <summary>
	/// Key: "Message.SuccessEquipEmote"
	/// English String: "Equipped Emote"
	/// </summary>
	public override string MessageSuccessEquipEmote => "åŠ¨ä½œå·²è£…å¤‡";

	/// <summary>
	/// Key: "Message.SuccessRenameCostume"
	/// English String: "Renamed costume"
	/// </summary>
	public override string MessageSuccessRenameCostume => "å·²é‡å‘½åè£…æ‰®";

	/// <summary>
	/// Key: "Message.SuccessRenameOutfit"
	/// English String: "Renamed outfit"
	/// </summary>
	public override string MessageSuccessRenameOutfit => "å·²é‡å‘½åç©¿æ­";

	/// <summary>
	/// Key: "Message.SuccessSavedAccessories"
	/// English String: "Saved accessories"
	/// </summary>
	public override string MessageSuccessSavedAccessories => "å·²ä¿å­˜é…é¥°";

	/// <summary>
	/// Key: "Message.SuccessUnequipEmote"
	/// English String: "Unequipped emote"
	/// </summary>
	public override string MessageSuccessUnequipEmote => "å·²å¸ä¸‹åŠ¨ä½œ";

	/// <summary>
	/// Key: "Message.SuccessUpdatedCostume"
	/// English String: "Updated costume"
	/// </summary>
	public override string MessageSuccessUpdatedCostume => "å·²æ›´æ–°è£…æ‰®";

	/// <summary>
	/// Key: "Message.SuccessUpdatedOutfit"
	/// English String: "Updated outfit"
	/// </summary>
	public override string MessageSuccessUpdatedOutfit => "å·²æ›´æ–°ç©¿æ­";

	/// <summary>
	/// Key: "Message.SuccessWoreCostume"
	/// English String: "Successfully wore costume"
	/// </summary>
	public override string MessageSuccessWoreCostume => "å·²æˆåŠŸå®Œæˆè£…æ‰®";

	/// <summary>
	/// Key: "Message.SuccessWoreOutfit"
	/// English String: "Successfully wore outfit"
	/// </summary>
	public override string MessageSuccessWoreOutfit => "å·²æˆåŠŸå®Œæˆç©¿æ­";
	...
	/// </summary>
	public override string MessageUpdateThisCostume => "æ˜¯å¦æƒ³æ›´æ–°æ­¤è£…æ‰®ï¼Ÿè¿™æ ·çš„è¯ï¼Œæ­¤è£…æ‰®å°†è¦†ç›–ä½ è™šæ‹Ÿå½¢è±¡çš„å½“å‰å¤–è§‚ã€‚";
	...
	/// </summary>
	public override string MessageUpdateThisOutfit => "æ˜¯å¦æƒ³æ›´æ–°æ­¤ç©¿æ­ï¼Ÿè¿™æ ·çš„è¯ï¼Œæ­¤ç©¿æ­å°†è¦†ç›–ä½ è™šæ‹Ÿå½¢è±¡çš„å½“å‰å¤–è§‚ã€‚";
	...
	{
		return "è™šæ‹Ÿå½¢è±¡æœªæ­£ç¡®åŠ è½½ï¼Ÿ";
	}
	...
	{
		return $"å¥—è£…å·²è¢«ç§»è‡³è£…æ‰®ã€‚è¯·æŸ¥çœ‹{startBold}è£…æ‰®{rightArrow}é¢„è®¾è£…æ‰®{endBold}";
	}
	...
	{
		return $"â€œèº«ä½“â€ç±»åˆ«ä¸­å¯ä½¿ç”¨æ¯”ä¾‹é€‰é¡¹ã€‚æŸ¥çœ‹{startBold}èº«ä½“{rightArrow}æ¯”ä¾‹{endBold}";
	}
	...
	{
		return "æŽ¢ç´¢å•†åº—ï¼Œå‘çŽ°æ›´å¤šï¼";
	}
	...
	{
		return "åœ¨ç»å…¸ R6 è™šæ‹Ÿå½¢è±¡å’Œæ›´å…·è¡¨çŽ°åŠ›çš„ä¸‹ä¸€ä»£ R15 è™šæ‹Ÿå½¢è±¡ä¹‹é—´åˆ‡æ¢";
	}
	...
	{
		return "æ˜¯å¦ç¡®å®šè¦è¦†ç›–ä½ çš„å½“å‰å¤–è§‚ï¼Ÿ";
	}
	...
	{
		return "é€‰æ‹©æ ä½æˆ–åŠ¨ä½œ";
	}

	protected override string _GetTemplateForMessageDefaultClothing()
	{
		return "é»˜è®¤æœè£…å·²åº”ç”¨è‡³ä½ çš„è™šæ‹Ÿå½¢è±¡ï¼Œè¯·ä»Žä½ çš„æœè£…ä¸­è‡ªç”±é€‰æ‹©ã€‚";
	}
	...
	{
		return $"æ˜¯å¦ç¡®å®šè¦åˆ é™¤æ­¤{outfitType}ï¼Ÿ";
	}
	...
	{
		return $"ä½ æ²¡æœ‰æ­¤ç‰©å“ï¼š{itemType}";
	}
	...
	{
		return $"æ­¤ç©¿æ­ä¸­ä½ ç¼ºå°‘çš„ç‰©å“æ•°ç›®ï¼š{number}";
	}
	...
	{
		return $"æ˜¯å¦è¦æ›´æ–°æ­¤{outfitType1}ï¼Ÿè¿™æ ·çš„è¯ï¼Œ{outfitType1}å°†ä¼šè¦†ç›–ä½ è™šæ‹Ÿå½¢è±¡å½“å‰å¤–è§‚çš„{outfitType2}ã€‚";
	}
	...
	{
		return "æ˜¯å¦æƒ³æ›´æ–°æ­¤è£…æ‰®ï¼Ÿè¿™æ ·çš„è¯ï¼Œæ­¤è£…æ‰®å°†è¦†ç›–ä½ è™šæ‹Ÿå½¢è±¡çš„å½“å‰å¤–è§‚ã€‚";
	}

	protected override string _GetTemplateForMessageUpdateThisOutfit()
	{
		return "æ˜¯å¦æƒ³æ›´æ–°æ­¤ç©¿æ­ï¼Ÿè¿™æ ·çš„è¯ï¼Œæ­¤ç©¿æ­å°†è¦†ç›–ä½ è™šæ‹Ÿå½¢è±¡çš„å½“å‰å¤–è§‚ã€‚";
	}
