...
/// </summary>
internal class EmailConfirmationResources_zh_cn : EmailConfirmationResources_en_us, IEmailConfirmationResources, ITranslationResources
{
	/// <summary>
	/// Key: "Action.Done"
	/// button label
	...
	public EmailConfirmationResources_zh_cn(TranslationResourceState state)
		: base(state)
	{
	}
