...
internal class RobloxCreditResources_pt_br : RobloxCreditResources_en_us, IRobloxCreditResources, ITranslationResources
{
	...
	/// </summary>
	public override string HeadingRobloxCredit => "Cr̩dito no Roblox";
	...
	/// </summary>
	public override string MessageFailedDebitRobloxCredit => "Ocorreu um erro ao processar seu cr̩dito no Roblox. Tente de novo mais tarde!";
	...
	/// </summary>
	public override string MessageFailedGrantingRobux => "Adicionamos seus cr̩ditos no Roblox, mas houve um erro ao processar o recebimento de Robux. Entre em contato com o suporte ao cliente para receber seus Robux.";
	...
	{
		return $"Resgate seu cr̩dito no Roblox de {balance} para {robuxAmount}";
	}
	...
	{
		return $"Resgate seu cr̩dito no Roblox de {balance} para {iconRobux} {robuxAmount}";
	}
	...
	{
		return "Ocorreu um erro ao processar seu cr̩dito no Roblox. Tente de novo mais tarde!";
	}

	protected override string _GetTemplateForMessageFailedGrantingRobux()
	{
		return "Adicionamos seus cr̩ditos no Roblox, mas houve um erro ao processar o recebimento de Robux. Entre em contato com o suporte ao cliente para receber seus Robux.";
	}
	...
	{
		return $"Voc̻ resgatou {robuxAmount} Robux!";
	}
