...
{
    internal class VotingPanelResources_es_es : VotingPanelResources_en_us, IVotingPanelResources
    {
        ...
        public IReadOnlyDictionary<string, string> GetAllKeys()
        {
            return new Dictionary<string, string>()
            {
                ...
                {"Label.AccountPageTitle", LabelAccountPageTitle},
                {"Label.AccountUnderDayOneMessage", LabelAccountUnderDayOneMessage},
                {"Label.AccountUnderDayOneTitle", LabelAccountUnderDayOneTitle},
                {"Label.AssetNotVoteableMessage", LabelAssetNotVoteableMessage},
                {"Label.AssetNotVoteableTitle", LabelAssetNotVoteableTitle},
                {"Label.BuyGamePassMessage", LabelBuyGamePassMessage},
                {"Label.BuyGamePassTitle", LabelBuyGamePassTitle},
                {"Label.Decline", LabelDecline},
                {"Label.EmailVerifiedTitle", LabelEmailVerifiedTitle},
                {"Label.FloodCheckMessage", LabelFloodCheckMessage},
                {"Label.FloodCheckTitle", LabelFloodCheckTitle},
                {"Label.GuestUserTitle", LabelGuestUserTitle},
                {"Label.InstallPluginMessage", LabelInstallPluginMessage},
                {"Label.InstallPluginTitle", LabelInstallPluginTitle},
                {"Label.Login", LabelLogin},
                {"Label.LoginOrRegisterPageTitle", LabelLoginOrRegisterPageTitle},
                {"Label.Ok", LabelOk},
                {"Label.PlayGameMessage", LabelPlayGameMessage},
                {"Label.PlayGameTitle", LabelPlayGameTitle},
                {"Label.UnknownProblemMessage", LabelUnknownProblemMessage},
                {"Label.UnknownProblemTitle", LabelUnknownProblemTitle},
                {"Label.UseModelMessage", LabelUseModelMessage},
                {"Label.UseModelTitle", LabelUseModelTitle},
                {"Label.YouMustLoginToVote", LabelYouMustLoginToVote},
            };
        }
