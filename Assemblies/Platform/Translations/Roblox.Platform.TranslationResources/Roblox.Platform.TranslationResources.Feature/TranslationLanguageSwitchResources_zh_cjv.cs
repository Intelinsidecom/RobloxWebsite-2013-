...
/// </summary>
internal class TranslationLanguageSwitchResources_zh_cjv : TranslationLanguageSwitchResources_en_us, ITranslationLanguageSwitchResources, ITranslationResources
{
	/// <summary>
	...
	public TranslationLanguageSwitchResources_zh_cjv(TranslationResourceState state)
		: base(state)
	{
	}
