...

{
	...
	/// English String: "OK"
	/// </summary>
	string ActionDialogAddGearOk { get; }

	/// <summary>
	/// Key: "Action.Filter.Apply"
	/// English String: "Apply"
	/// </summary>
	string ActionFilterApply { get; }

	/// <summary>
	/// Key: "Action.Filter.Cancel"
	/// English String: "Cancel"
	/// </summary>
	string ActionFilterCancel { get; }
	...
	/// </summary>
	string LabelAmazon { get; }

	/// <summary>
	/// Key: "Label.BreadCrumb.Free"
	/// English String: "Free"
	/// </summary>
	string LabelBreadCrumbFree { get; }

	/// <summary>
	/// Key: "Label.BreadCrumb.Group"
	/// English String: "Group:"
	/// </summary>
	string LabelBreadCrumbGroup { get; }
	...
	/// English String: "By"
	/// </summary>
	string LabelCardCreatorBy { get; }

	/// <summary>
	/// Key: "Label.Card.PriceWas"
	/// English String: "Was"
	/// </summary>
	string LabelCardPriceWas { get; }

	/// <summary>
	/// Key: "Label.Card.Remaining"
	/// English String: "Remaining:"
	/// </summary>
	string LabelCardRemaining { get; }

	/// <summary>
	/// Key: "Label.CategoryAttributes"
	/// English String: "Attributes"
	/// </summary>
	string LabelCategoryAttributes { get; }

	/// <summary>
	/// Key: "Label.CategoryType"
	/// English String: "Type"
	/// </summary>
	string LabelCategoryType { get; }
	...
	/// </summary>
	string LabelCommunityCreations { get; }

	/// <summary>
	/// Key: "Label.Dialog.AddGearTitle"
	/// English String: "Add Gear to Your Game"
	/// </summary>
	string LabelDialogAddGearTitle { get; }
	...
	/// </summary>
	string LabelFeaturedBundles { get; }
	...
	/// English String: "Sale"
	/// </summary>
	string LabelSale { get; }

	/// <summary>
	/// Key: "Label.SearchField"
	/// English String: "Search"
	/// </summary>
	string LabelSearchField { get; }

	/// <summary>
	/// Key: "Label.SeeAll"
	/// English String: "See All"
	/// </summary>
	string LabelSeeAll { get; }
	...
	/// </summary>
	string LabelGearAll { get; }

	/// <summary>
	/// Key: "LabelGearBuilding"
	/// English String: "Building"
	/// </summary>
	string LabelGearBuilding { get; }

	/// <summary>
	/// Key: "LabelGearExplosive"
	/// English String: "Explosive"
	/// </summary>
	string LabelGearExplosive { get; }

	/// <summary>
	/// Key: "LabelGearMelee"
	/// English String: "Melee"
	/// </summary>
	string LabelGearMelee { get; }

	/// <summary>
	/// Key: "LabelGearMusical"
	/// English String: "Musical"
	/// </summary>
	string LabelGearMusical { get; }

	/// <summary>
	/// Key: "LabelGearNavigation"
	/// English String: "Navigation"
	/// </summary>
	string LabelGearNavigation { get; }

	/// <summary>
	/// Key: "LabelGearPersonalTransport"
	/// English String: "Transport"
	/// </summary>
	string LabelGearPersonalTransport { get; }

	/// <summary>
	/// Key: "LabelGearPowerUps"
	/// English String: "Power Up"
	/// </summary>
	string LabelGearPowerUps { get; }

	/// <summary>
	/// Key: "LabelGearRanged"
	/// English String: "Ranged"
	/// </summary>
	string LabelGearRanged { get; }

	/// <summary>
	/// Key: "LabelGearSocial"
	/// English String: "Social"
	/// </summary>
	string LabelGearSocial { get; }

	/// <summary>
	/// Key: "LabelGenreAdventure"
	/// English String: "Adventure"
	/// </summary>
	string LabelGenreAdventure { get; }

	/// <summary>
	/// Key: "LabelGenreAll"
	/// English String: "All Genres"
	/// </summary>
	string LabelGenreAll { get; }

	/// <summary>
	/// Key: "LabelGenreBuilding"
	/// English String: "Building"
	/// </summary>
	string LabelGenreBuilding { get; }

	/// <summary>
	/// Key: "LabelGenreComedy"
	/// English String: "Comedy"
	/// </summary>
	string LabelGenreComedy { get; }

	/// <summary>
	/// Key: "LabelGenreFantasy"
	/// English String: "Medieval"
	/// </summary>
	string LabelGenreFantasy { get; }

	/// <summary>
	/// Key: "LabelGenreFighting"
	/// English String: "Fighting"
	/// </summary>
	string LabelGenreFighting { get; }

	/// <summary>
	/// Key: "LabelGenreFPS"
	/// English String: "FPS"
	/// </summary>
	string LabelGenreFPS { get; }

	/// <summary>
	/// Key: "LabelGenreFunny"
	/// English String: "Comedy"
	/// </summary>
	string LabelGenreFunny { get; }

	/// <summary>
	/// Key: "LabelGenreHorror"
	/// English String: "Horror"
	/// </summary>
	string LabelGenreHorror { get; }

	/// <summary>
	/// Key: "LabelGenreMedieval"
	/// English String: "Medieval"
	/// </summary>
	string LabelGenreMedieval { get; }

	/// <summary>
	/// Key: "LabelGenreMilitary"
	/// English String: "Military"
	/// </summary>
	string LabelGenreMilitary { get; }

	/// <summary>
	/// Key: "LabelGenreNaval"
	/// English String: "Naval"
	/// </summary>
	string LabelGenreNaval { get; }

	/// <summary>
	/// Key: "LabelGenreNinja"
	/// English String: "Fighting"
	/// </summary>
	string LabelGenreNinja { get; }

	/// <summary>
	/// Key: "LabelGenrePirate"
	/// English String: "Naval"
	/// </summary>
	string LabelGenrePirate { get; }

	/// <summary>
	/// Key: "LabelGenreRPG"
	/// English String: "RPG"
	/// </summary>
	string LabelGenreRPG { get; }

	/// <summary>
	/// Key: "LabelGenreScary"
	/// English String: "Horror"
	/// </summary>
	string LabelGenreScary { get; }

	/// <summary>
	/// Key: "LabelGenreSciFi"
	/// English String: "Sci-Fi"
	/// </summary>
	string LabelGenreSciFi { get; }

	/// <summary>
	/// Key: "LabelGenreSports"
	/// English String: "Sports"
	/// </summary>
	string LabelGenreSports { get; }

	/// <summary>
	/// Key: "LabelGenreTownAndCity"
	/// English String: "Town and City"
	/// </summary>
	string LabelGenreTownAndCity { get; }

	/// <summary>
	/// Key: "LabelGenreTutorial"
	/// English String: "Building"
	/// </summary>
	string LabelGenreTutorial { get; }

	/// <summary>
	/// Key: "LabelGenreWar"
	/// English String: "Military"
	/// </summary>
	string LabelGenreWar { get; }

	/// <summary>
	/// Key: "LabelGenreWestern"
	/// English String: "Western"
	/// </summary>
	string LabelGenreWestern { get; }

	/// <summary>
	/// Key: "LabelGenreWildWest"
	/// English String: "Western"
	/// </summary>
	string LabelGenreWildWest { get; }
	...
	/// </summary>
	string ResponseErrorFilter { get; }
	...
	/// </summary>
	string ResponseNoItemsFound { get; }
