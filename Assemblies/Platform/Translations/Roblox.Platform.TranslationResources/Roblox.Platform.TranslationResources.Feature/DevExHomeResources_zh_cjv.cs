...
/// </summary>
internal class DevExHomeResources_zh_cjv : DevExHomeResources_en_us, IDevExHomeResources, ITranslationResources
{
	/// <summary>
	/// Key: "GetActionCancel"
	...
	public DevExHomeResources_zh_cjv(TranslationResourceState state)
		: base(state)
	{
	}
