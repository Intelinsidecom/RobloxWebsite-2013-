...
/// </summary>
internal class SupportResources_zh_cjv : SupportResources_en_us, ISupportResources, ITranslationResources
{
	/// <summary>
	...
	public SupportResources_zh_cjv(TranslationResourceState state)
		: base(state)
	{
	}
