...
namespace Roblox.Platform.TranslationResources.Featureinternal {
    class PremiumMigrationWebResources_en_us : TranslationResourcesBase, IPremiumMigrationWebResources, ITranslationResources

{
	...
	{
		return $"Going forward, you will receive a full monthâ€™s worth of Robux on the day of your subscription renewal. Today, weâ€™re giving you this month's Robux minus what youâ€™ve already received this month: {robuxAmount}.{newLine}{newLine}\nCheck your Roblox inbox for more details.";
	}
