...
/// </summary>
internal class CreatePlaceProductPromotionResources_zh_cn : CreatePlaceProductPromotionResources_en_us, ICreatePlaceProductPromotionResources, ITranslationResources
{
	/// <summary>
	/// Key: "Label.AddToGame"
	...
	public CreatePlaceProductPromotionResources_zh_cn(TranslationResourceState state)
		: base(state)
	{
	}
