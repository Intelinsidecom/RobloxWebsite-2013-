...
internal class PremiumMigrationResources_pt_br : PremiumMigrationResources_en_us, IPremiumMigrationResources, ITranslationResources
{
	...
	/// English String: "Builders Club is now Roblox Premium"
	/// </summary>
	public override string PopUpTitle => "O Builders Club agora Ã© Roblox Premium";
	...
	{
		return $"O Premium agora dÃ¡ uma mesada de Robux de uma vez, em vez de uma quantia diÃ¡ria! Hoje, estamos dando a vocÃª um pagamento Ãºnico de {robuxAmount}.\n\nConfira sua caixa de entrada do Roblox para saber mais sobre seu pagamento de Robux e assinatura Premium. ";
	}
	...
	{
		return $"O Premium agora dÃ¡ uma mesada de Robux de uma vez, em vez de uma quantia diÃ¡ria! Hoje, estamos dando a vocÃª um pagamento Ãºnico de {robuxAmount}.{newLine}{newLine}Confira sua caixa de entrada do Roblox para saber mais sobre seu pagamento de Robux e assinatura Premium.  ";
	}
