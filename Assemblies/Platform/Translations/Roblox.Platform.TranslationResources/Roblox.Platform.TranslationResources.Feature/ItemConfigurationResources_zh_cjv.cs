...
/// </summary>
internal class ItemConfigurationResources_zh_cjv : ItemConfigurationResources_en_us, IItemConfigurationResources, ITranslationResources
{
	/// <summary>
	...
	public ItemConfigurationResources_zh_cjv(TranslationResourceState state)
		: base(state)
	{
	}
