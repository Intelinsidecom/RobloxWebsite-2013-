...
internal class FeedsResources_pt_br : FeedsResources_en_us, IFeedsResources, ITranslationResources
{
	...
	{
		return $"Visite o {avatarLinkStart}Editor de Avatar{avatarLinkEnd} para personalizar seu personagem. Compre peÃ§as de roupa no {catalogLinkStart}CatÃ¡logo{catalogLinkEnd}.";
	}
