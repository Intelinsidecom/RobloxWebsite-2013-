...

{
	...
	/// </summary>
	string ActionInstall { get; }

	/// <summary>
	/// Key: "Action.Inventory"
	/// English String: "Inventory"
	/// </summary>
	string ActionInventory { get; }
	...
	/// </summary>
	string ActionRemoveFromProfile { get; }

	/// <summary>
	/// Key: "Action.Rent"
	/// English String: "Rent"
	/// </summary>
	string ActionRent { get; }

	/// <summary>
	/// Key: "Action.ReportItem"
	/// English String: "Report Item"
	/// </summary>
	string ActionReportItem { get; }

	/// <summary>
	/// Key: "Action.Sell"
	/// English String: "Sell"
	/// </summary>
	string ActionSell { get; }
	...
	/// </summary>
	string ActionTakeOff { get; }

	/// <summary>
	/// Key: "Action.TakeOffSale"
	/// English String: "Take Off Sale"
	/// </summary>
	string ActionTakeOffSale { get; }

	/// <summary>
	/// Key: "Action.TryOn"
	/// English String: "Try On"
	/// </summary>
	string ActionTryOn { get; }
	...
	/// </summary>
	string HeadingIncludedItems { get; }
	...
	/// </summary>
	string LabelBuildersClubExclusive { get; }
	...
	/// </summary>
	string LabelDeleteFromInventoryConfirm { get; }
	...
	/// </summary>
	string LabelDisableBadgeConfirm { get; }
	...
	/// </summary>
	string LabelDiscontinuedItem { get; }
	...
	/// </summary>
	string LabelEnableBadgeConfirm { get; }
	...
	/// </summary>
	string LabelInvalidProduct { get; }
	...
	/// </summary>
	string LabelItemNotForSale { get; }

	/// <summary>
	/// Key: "Label.ItemOwned"
	/// English String: "Item Owned"
	/// </summary>
	string LabelItemOwned { get; }
	...
	/// </summary>
	string LabelSellYourCollectibleItem { get; }
	...
	/// </summary>
	string LabelThirteenPlusOnly { get; }
	...
	/// </summary>
	string ResponseAddedToProfile { get; }
	...
	/// </summary>
	string ResponseAddedToYourAvater { get; }
	...
	/// </summary>
	string ResponseAlreadyHaveMaxItems { get; }
	...
	/// </summary>
	string ResponseDisabledBadge { get; }
	...
	/// </summary>
	string ResponseEnabledBadge { get; }
	...
	/// </summary>
	string ResponseFailedToAddToProfile { get; }
	...
	/// </summary>
	string ResponseFailedToDeleteFromInventory { get; }
	...
	/// </summary>
	string ResponseFailedToDisableBadge { get; }
	...
	/// </summary>
	string ResponseFailedToEnableBadge { get; }
	...
	/// </summary>
	string ResponseFailedToRemoveFromProfile { get; }
	...
	/// </summary>
	string ResponseRemovedFromInventory { get; }
	...
	/// </summary>
	string ResponseRemovedFromProfile { get; }
	...
	/// </summary>
	string ResponseRemovedFromYourAvater { get; }
	...
	/// </summary>
	string LabelAllowPlayersPlusEarn(string affiliateSaleTotal);

	/// <summary>
	/// Key: "Label.By"
	/// English String: "By {creator}"
	/// </summary>
	string LabelBy(string creator);
	...
	/// </summary>
	string LabelCountdownTimerDayHourMinute(string numberOfDays, string numberOfHours, string numberOfMinutes);
	...
	/// </summary>
	string LabelEarnBadgeGameLink(string placeLink);

	/// <summary>
	/// Key: "Label.ItemOwnedAmount"
	/// English String: "Item Owned ({amount})"
	/// </summary>
	string LabelItemOwnedAmount(string amount);

	/// <summary>
	/// Key: "Label.ItemRecentPrice"
	/// English String: "{name}'s recent average price is {price}."
	/// </summary>
	string LabelItemRecentPrice(string name, string price);
	...
	/// </summary>
	string LabelMarketplaceFee(string percent);
	...
	/// </summary>
	string LabelOffsaleCountdownHourMinuteSecond(string numberOfHours, string numberOfMinutes, string numberOfSeconds);

	/// <summary>
	/// Key: "Label.SellConfirm"
	/// English String: "Are you sure you want to sell {name} for {price}?"
	/// </summary>
	string LabelSellConfirm(string name, string price);

	/// <summary>
	/// Key: "Label.SerialNumberOfTotal"
	/// English String: "Serial #{number} of {total}"
	/// </summary>
	string LabelSerialNumberOfTotal(string number, string total);

	/// <summary>
	/// Key: "Label.UpdatedBy"
	/// English String: "(by {link})"
	/// </summary>
	string LabelUpdatedBy(string link);
	...
	/// </summary>
	string LabelUseGamePassLink(string placeLink);
	...
	/// </summary>
	string ResponseGearAddSuccess(string placeName);
