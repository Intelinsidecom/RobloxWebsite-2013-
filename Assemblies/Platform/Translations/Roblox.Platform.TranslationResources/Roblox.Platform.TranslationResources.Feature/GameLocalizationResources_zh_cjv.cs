...
/// </summary>
internal class GameLocalizationResources_zh_cjv : GameLocalizationResources_en_us, IGameLocalizationResources, ITranslationResources
{
	/// <summary>
	/// Key: "Action.Cancel"
	...
	public GameLocalizationResources_zh_cjv(TranslationResourceState state)
		: base(state)
	{
	}
