...
/// </summary>
internal class PaymentResources_zh_cn : PaymentResources_en_us, IPaymentResources, ITranslationResources
{
	/// <summary>
	...
	public PaymentResources_zh_cn(TranslationResourceState state)
		: base(state)
	{
	}
