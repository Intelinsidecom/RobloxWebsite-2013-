...
/// </summary>
internal class PromotedChannelsResources_zh_cn : PromotedChannelsResources_en_us, IPromotedChannelsResources, ITranslationResources
{
	/// <summary>
	/// Key: "Action.AddLink"
	...
	public PromotedChannelsResources_zh_cn(TranslationResourceState state)
		: base(state)
	{
	}
