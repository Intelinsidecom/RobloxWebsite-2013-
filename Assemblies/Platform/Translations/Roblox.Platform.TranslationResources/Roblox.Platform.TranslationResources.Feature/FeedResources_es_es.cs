...
internal class FeedResources_es_es : FeedResources_en_us, IFeedResources, ITranslationResources
{
	...
	{
		return $"Visita la {avatarLinkStart} pÃ¡gina de Avatar {avatarLinkEnd} para personalizar tu avatar. Consigue ropa nueva en el {catalogLinkStart}CatÃ¡logo{catalogLinkEnd}.";
	}
