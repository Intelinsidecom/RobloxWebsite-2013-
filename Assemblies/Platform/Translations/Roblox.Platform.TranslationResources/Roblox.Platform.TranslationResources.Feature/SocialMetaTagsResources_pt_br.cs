...
internal class SocialMetaTagsResources_pt_br : SocialMetaTagsResources_en_us, ISocialMetaTagsResources, ITranslationResources
{
	...
	/// </summary>
	public override string DescriptionDevelopLanding => "Crie qualquer coisa que imaginar com o sistema de criaÃ§Ã£o imersivo e livre do Roblox. Comece a criar jogos hoje mesmo!";
	...
	/// </summary>
	public override string DescriptionGamesPage => "Jogue milhÃµes de jogos gratuitos em seu smartphone, tablet, computador, Xbox One, Oculus Rift e muito mais.";
	...
	/// </summary>
	public override string DescriptionRoblox => "Roblox anuncia o comeÃ§o de uma nova geraÃ§Ã£o de entretenimento. Imagine, crie e jogue com milhÃµes de jogadores em uma infinita variedade de mundos 3D imersivos gerados por usuÃ¡rios.";
	...
	/// </summary>
	public override string LabelCatalogPage => "Personalize seu avatar com uma variedade sem fim de opÃ§Ãµes, acessÃ³rios, equipamentos e muito mais!";
	...
	/// </summary>
	public override string LabelCatalogPageTItle => "CatÃ¡logo do Roblox";
	...
	{
		return "Crie qualquer coisa que imaginar com o sistema de criaÃ§Ã£o imersivo e livre do Roblox. Comece a criar jogos hoje mesmo!";
	}
	...
	{
		return $"Visite os favoritos de {userName} e confira suas preferÃªncias no Roblox. Descubra seus locais, acessÃ³rios e outras coisas favoritas. Veja tambÃ©m os equipamentos mais usados por esta pessoa em jogo e adquira um para vocÃª!";
	}
	...
	{
		return $"Confira {gameName}. Este jogo Ã© uma das milhÃµes de experiÃªncias 3D imersivas Ãºnicas criadas por jogadores no Roblox. {gameDescription}";
	}
	...
	{
		return "Jogue milhÃµes de jogos gratuitos em seu smartphone, tablet, computador, Xbox One, Oculus Rift e muito mais.";
	}
	...
	{
		return $"Visite o inventÃ¡rio de {userName1} para ver os itens legais que conseguiu. DÃª uma olhada em seus passes de jogo e consiga um para vocÃª! Confira a coleÃ§Ã£o de chapÃ©us, camisas, equipamento e outros itens de {userName2}.";
	}
	...
	{
		return "Roblox anuncia o comeÃ§o de uma nova geraÃ§Ã£o de entretenimento. Imagine, crie e jogue com milhÃµes de jogadores em uma infinita variedade de mundos 3D imersivos gerados por usuÃ¡rios.";
	}
	...
	{
		return $"{userName1} Ã© um dos milhÃµes de usuÃ¡rios jogando, criando e explorando as possibilidades infinitas do Roblox. Junte-se a {userName2} no Roblox e explorem juntos!";
	}
	...
	{
		return "Personalize seu avatar com uma variedade sem fim de opÃ§Ãµes, acessÃ³rios, equipamentos e muito mais!";
	}

	protected override string _GetTemplateForLabelCatalogPageTItle()
	{
		return "CatÃ¡logo do Roblox";
	}
