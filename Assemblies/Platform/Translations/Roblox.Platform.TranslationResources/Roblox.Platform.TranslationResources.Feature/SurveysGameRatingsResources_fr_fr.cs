...
/// </summary>
internal class SurveysGameRatingsResources_fr_fr : SurveysGameRatingsResources_en_us, ISurveysGameRatingsResources, ITranslationResources
{
	/// <summary>
	...
	/// </summary>
	public override string DescriptionAnswerToDoesThisGameContainFrequently => "De faÃ§on rÃ©currente";
	...
	/// </summary>
	public override string DescriptionAnswerToDoesThisGameContainInfrequently => "De faÃ§on occasionnelle";
	...
	/// English String: "No"
	/// </summary>
	public override string DescriptionAnswerToDoesThisGameContainNo => "Non";
	...
	/// English String: "Yes"
	/// </summary>
	public override string DescriptionAnswerToDoesThisGameContainYes => "Oui";
	...
	/// </summary>
	public override string DescriptionCanUsersWagerRobuxInGameCurrencyPurchasedWithRobuxOrOtherItemsOfRealValue => "Les utilisateurs peuvent-ils miser Ã  l'aide de Robux, de monnaie en jeu achetÃ©e via des Robux ou d'autres objets ayant une valeur rÃ©elle\u00a0?";
	...
	/// </summary>
	public override string DescriptionDefenselessViolenceQuestion => "Ce jeu contient-il de la violence envers des personnages sans dÃ©fense\u00a0?";
	...
	/// </summary>
	public override string DescriptionDoesThisGameContainBathroomHumor => "Ce jeu contient-il de l'humour scabreux\u00a0?";
	...
	/// </summary>
	public override string DescriptionDoesThisGameContainCrudeHumor => "Ce jeu contient-il de l'humour grossier\u00a0?";
	...
	/// </summary>
	public override string DescriptionDoesThisGameContainNudityOrDepictionsOfSex => "Ce jeu contient-il de la nuditÃ© ou la reprÃ©sentation de contacts sexuels\u00a0?";
	...
	/// </summary>
	public override string DescriptionDoesThisGameContainReferencesToAlcoholTobaccoOrDrugs => "Ce jeu fait-il rÃ©fÃ©rence Ã  des drogues, de l'alcool ou du tabac\u00a0?";
	...
	/// </summary>
	public override string DescriptionDoesThisGameContainReferencesToAlcoholTobaccoOrDrugsCharactersAreShownUsingAlcoholTobac => "Des personnages sont montrÃ©s consommant des drogues, de l'alcool ou du tabac";
	...
	/// </summary>
	public override string DescriptionDoesThisGameContainReferencesToAlcoholTobaccoOrDrugsFrequentReferences => "De nombreuses rÃ©fÃ©rences";
	...
	/// </summary>
	public override string DescriptionDoesThisGameContainReferencesToAlcoholTobaccoOrDrugsInfrequentReferences => "Quelques rÃ©fÃ©rences";
	...
	/// English String: "No"
	/// </summary>
	public override string DescriptionDoesThisGameContainReferencesToAlcoholTobaccoOrDrugsNo => "Non";
	...
	/// </summary>
	public override string DescriptionDoesThisGameContainSimulatedGamblingOrPaidLootBoxes => "Ce jeu contient-il une simulation de jeu de hasard ou des objets virtuels alÃ©atoires payants\u00a0?";
	...
	/// </summary>
	public override string DescriptionDoesThisGameContainSuggestiveSexualThemes => "Ce jeu contient-il des insinuations Ã  caractÃ¨re sexuel\u00a0?";
	...
	/// </summary>
	public override string DescriptionDoesThisGameFollowTheCommunityRules => "Ce jeu suit-il le rÃ¨glement de la communautÃ©\u00a0? ";
	...
	/// English String: "No"
	/// </summary>
	public override string DescriptionDoesThisGameFollowTheCommunityRulesNo => "Non";
	...
	/// English String: "Yes"
	/// </summary>
	public override string DescriptionDoesThisGameFollowTheCommunityRulesYes => "Oui";
	...
	/// </summary>
	public override string DescriptionDoesThisGameUseProfanity => "Ce jeu contient-il des jurons\u00a0?";
	...
	/// </summary>
	public override string DescriptionDoesThisGameUseProfanityFrequentProfanity => "Des jurons rÃ©currents";
	...
	/// </summary>
	public override string DescriptionDoesThisGameUseProfanityInfrequentProfanity => "Quelques jurons";
	...
	/// English String: "No"
	/// </summary>
	public override string DescriptionDoesThisGameUseProfanityNo => "Non";
	...
	/// </summary>
	public override string DescriptionDoesThisGameUseProfanitySomeMildBadLanguage => "De la grossiÃ¨retÃ© lÃ©gÃ¨re";
	...
	/// </summary>
	public override string DescriptionScaryForChildUnderEightQuestion => "Ce jeu propose-t-il du contenu pouvant faire peur Ã  un enfant de moins de 8\u00a0ans\u00a0?";
	...
	/// </summary>
	public override string DescriptionScaryForChildUnderTwelveQuestion => "Ce jeu propose-t-il du contenu pouvant faire peur Ã  un enfant de moins de 12\u00a0ans\u00a0?";
	...
	/// </summary>
	public override string DescriptionViolenceQuestionComicalViolence => "Violence traitÃ©e avec humour";
	...
	/// </summary>
	public override string DescriptionViolenceQuestionDoesThisGameContainViolentContent => "Ce jeu propose-t-il du contenu violent\u00a0?";
	...
	/// </summary>
	public override string DescriptionViolenceQuestionEasilyDistinguishableFromRealLife => "Violence non rÃ©aliste";
	...
	/// </summary>
	public override string DescriptionViolenceQuestionExtremeRealisticViolence => "Violence extrÃªme et rÃ©aliste";
	...
	/// English String: "No"
	/// </summary>
	public override string DescriptionViolenceQuestionNo => "Non";
	...
	/// </summary>
	public override string DescriptionViolenceQuestionSomeRealisticViolence => "Violence rÃ©aliste";

	public SurveysGameRatingsResources_fr_fr(TranslationResourceState state)
		: base(state)
	{
	}
	...
	{
		return "Les utilisateurs peuvent-ils miser Ã  l'aide de Robux, de monnaie en jeu achetÃ©e via des Robux ou d'autres objets ayant une valeur rÃ©elle\u00a0?";
	}

	protected override string _GetTemplateForDescriptionDefenselessViolenceQuestion()
	{
		return "Ce jeu contient-il de la violence envers des personnages sans dÃ©fense\u00a0?";
	}

	protected override string _GetTemplateForDescriptionDoesThisGameContainBathroomHumor()
	{
		return "Ce jeu contient-il de l'humour scabreux\u00a0?";
	}

	protected override string _GetTemplateForDescriptionDoesThisGameContainCrudeHumor()
	{
		return "Ce jeu contient-il de l'humour grossier\u00a0?";
	}

	protected override string _GetTemplateForDescriptionDoesThisGameContainNudityOrDepictionsOfSex()
	{
		return "Ce jeu contient-il de la nuditÃ© ou la reprÃ©sentation de contacts sexuels\u00a0?";
	}

	protected override string _GetTemplateForDescriptionDoesThisGameContainReferencesToAlcoholTobaccoOrDrugs()
	{
		return "Ce jeu fait-il rÃ©fÃ©rence Ã  des drogues, de l'alcool ou du tabac\u00a0?";
	}
	...
	{
		return "Des personnages sont montrÃ©s consommant des drogues, de l'alcool ou du tabac";
	}
	...
	{
		return "De nombreuses rÃ©fÃ©rences";
	}
	...
	{
		return "Ce jeu contient-il une simulation de jeu de hasard ou des objets virtuels alÃ©atoires payants\u00a0?";
	}

	protected override string _GetTemplateForDescriptionDoesThisGameContainSuggestiveSexualThemes()
	{
		return "Ce jeu contient-il des insinuations Ã  caractÃ¨re sexuel\u00a0?";
	}

	protected override string _GetTemplateForDescriptionDoesThisGameFollowTheCommunityRules()
	{
		return "Ce jeu suit-il le rÃ¨glement de la communautÃ©\u00a0? ";
	}
