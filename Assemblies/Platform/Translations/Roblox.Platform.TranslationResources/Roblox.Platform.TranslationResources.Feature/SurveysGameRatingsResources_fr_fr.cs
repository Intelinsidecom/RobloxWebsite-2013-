...
internal class SurveysGameRatingsResources_fr_fr : SurveysGameRatingsResources_en_us, ISurveysGameRatingsResources, ITranslationResources
{
	...
	/// </summary>
	public override string DescriptionAnswerToDoesThisGameContainFrequently => "De façon récurrente";
	...
	/// </summary>
	public override string DescriptionAnswerToDoesThisGameContainInfrequently => "De façon occasionnelle";
	...
	/// </summary>
	public override string DescriptionCanUsersWagerRobuxInGameCurrencyPurchasedWithRobuxOrOtherItemsOfRealValue => "Les utilisateurs peuvent-ils miser à l'aide de Robux, de monnaie en jeu achetée via des Robux ou d'autres objets ayant une valeur réelle\u00a0?";
	...
	/// </summary>
	public override string DescriptionDefenselessViolenceQuestion => "Ce jeu contient-il de la violence envers des personnages sans défense\u00a0?";
	...
	/// </summary>
	public override string DescriptionDoesThisGameContainNudityOrDepictionsOfSex => "Ce jeu contient-il de la nudité ou la représentation de contacts sexuels\u00a0?";
	...
	/// </summary>
	public override string DescriptionDoesThisGameContainReferencesToAlcoholTobaccoOrDrugs => "Ce jeu fait-il référence à des drogues, de l'alcool ou du tabac\u00a0?";
	...
	/// </summary>
	public override string DescriptionDoesThisGameContainReferencesToAlcoholTobaccoOrDrugsCharactersAreShownUsingAlcoholTobac => "Des personnages sont montrés consommant des drogues, de l'alcool ou du tabac";
	...
	/// </summary>
	public override string DescriptionDoesThisGameContainReferencesToAlcoholTobaccoOrDrugsFrequentReferences => "De nombreuses références";
	...
	/// </summary>
	public override string DescriptionDoesThisGameContainReferencesToAlcoholTobaccoOrDrugsInfrequentReferences => "Quelques références";
	...
	/// </summary>
	public override string DescriptionDoesThisGameContainSimulatedGamblingOrPaidLootBoxes => "Ce jeu contient-il une simulation de jeu de hasard ou des objets virtuels aléatoires payants\u00a0?";
	...
	/// </summary>
	public override string DescriptionDoesThisGameContainSuggestiveSexualThemes => "Ce jeu contient-il des insinuations à caractère sexuel\u00a0?";
	...
	/// </summary>
	public override string DescriptionDoesThisGameFollowTheCommunityRules => "Ce jeu suit-il le règlement de la communauté\u00a0? ";
	...
	/// </summary>
	public override string DescriptionDoesThisGameUseProfanityFrequentProfanity => "Des jurons récurrents";
	...
	/// </summary>
	public override string DescriptionDoesThisGameUseProfanitySomeMildBadLanguage => "De la grossièreté légère";
	...
	/// </summary>
	public override string DescriptionScaryForChildUnderEightQuestion => "Ce jeu propose-t-il du contenu pouvant faire peur à un enfant de moins de 8\u00a0ans\u00a0?";
	...
	/// </summary>
	public override string DescriptionScaryForChildUnderTwelveQuestion => "Ce jeu propose-t-il du contenu pouvant faire peur à un enfant de moins de 12\u00a0ans\u00a0?";
	...
	/// </summary>
	public override string DescriptionViolenceQuestionComicalViolence => "Violence traitée avec humour";
	...
	/// </summary>
	public override string DescriptionViolenceQuestionEasilyDistinguishableFromRealLife => "Violence non réaliste";
	...
	/// </summary>
	public override string DescriptionViolenceQuestionExtremeRealisticViolence => "Violence extrême et réaliste";
	...
	/// </summary>
	public override string DescriptionViolenceQuestionSomeRealisticViolence => "Violence réaliste";
	...
	{
		return "Les utilisateurs peuvent-ils miser à l'aide de Robux, de monnaie en jeu achetée via des Robux ou d'autres objets ayant une valeur réelle\u00a0?";
	}

	protected override string _GetTemplateForDescriptionDefenselessViolenceQuestion()
	{
		return "Ce jeu contient-il de la violence envers des personnages sans défense\u00a0?";
	}
	...
	{
		return "Ce jeu contient-il de la nudité ou la représentation de contacts sexuels\u00a0?";
	}

	protected override string _GetTemplateForDescriptionDoesThisGameContainReferencesToAlcoholTobaccoOrDrugs()
	{
		return "Ce jeu fait-il référence à des drogues, de l'alcool ou du tabac\u00a0?";
	}
	...
	{
		return "Des personnages sont montrés consommant des drogues, de l'alcool ou du tabac";
	}
	...
	{
		return "De nombreuses références";
	}
	...
	{
		return "Ce jeu contient-il une simulation de jeu de hasard ou des objets virtuels aléatoires payants\u00a0?";
	}

	protected override string _GetTemplateForDescriptionDoesThisGameContainSuggestiveSexualThemes()
	{
		return "Ce jeu contient-il des insinuations à caractère sexuel\u00a0?";
	}

	protected override string _GetTemplateForDescriptionDoesThisGameFollowTheCommunityRules()
	{
		return "Ce jeu suit-il le règlement de la communauté\u00a0? ";
	}
