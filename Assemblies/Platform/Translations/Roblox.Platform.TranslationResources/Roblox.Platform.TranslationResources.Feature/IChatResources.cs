...

{
	...
	/// English String: "Join"
	/// </summary>
	string ActionJoinVoice { get; }

	/// <summary>
	/// Key: "Action.Leave"
	/// English String: "Leave"
	/// </summary>
	string ActionLeave { get; }
	...
	/// English String: "Mute"
	/// </summary>
	string ActionMute { get; }

	/// <summary>
	/// Key: "Action.MuteMic"
	/// English String: "Mute Your Microphone"
	/// </summary>
	string ActionMuteMic { get; }
	...
	/// </summary>
	string ActionStartParty { get; }

	/// <summary>
	/// Key: "Action.Stay"
	/// English String: "Stay"
	/// </summary>
	string ActionStay { get; }

	/// <summary>
	/// Key: "Action.TurnOn"
	/// English String: "Turn On"
	/// </summary>
	string ActionTurnOn { get; }
	...
	/// </summary>
	string DescriptionUserInVoice { get; }
	...
	/// </summary>
	string DescriptionVoiceNotConnect { get; }
	...
	/// </summary>
	string LabelConversationNotifications { get; }
	...
	/// </summary>
	string LabelInputPlaceHolderSearchForFriends { get; }

	/// <summary>
	/// Key: "Label.InputPlaceHolder.SendMessage"
	/// English String: "Send a message"
	/// </summary>
	string LabelInputPlaceHolderSendMessage { get; }

	/// <summary>
	/// Key: "Label.InStudio"
	/// English String: "In Studio"
	/// </summary>
	string LabelInStudio { get; }

	/// <summary>
	/// Key: "Label.JoinButton"
	/// English String: "Join"
	/// </summary>
	string LabelJoinButton { get; }

	/// <summary>
	/// Key: "Label.JoinGame"
	/// English String: "Join Game"
	/// </summary>
	string LabelJoinGame { get; }

	/// <summary>
	/// Key: "Label.JoinParty"
	/// English String: "Join Party"
	/// </summary>
	string LabelJoinParty { get; }

	/// <summary>
	/// Key: "Label.LeaveChatGroup"
	/// English String: "Leave Chat Group"
	/// </summary>
	string LabelLeaveChatGroup { get; }

	/// <summary>
	/// Key: "Label.LeaveParty"
	/// English String: "Leave Party"
	/// </summary>
	string LabelLeaveParty { get; }

	/// <summary>
	/// Key: "Label.Member"
	/// English String: "Member"
	/// </summary>
	string LabelMember { get; }

	/// <summary>
	/// Key: "Label.Members"
	/// English String: "Members"
	/// </summary>
	string LabelMembers { get; }
	...
	/// </summary>
	string LabelNotImplementedMessageType { get; }

	/// <summary>
	/// Key: "Label.NotInCall"
	/// English String: "Not in call"
	/// </summary>
	string LabelNotInCall { get; }
	...
	/// </summary>
	string LabelPinGameTooltip { get; }
	...
	/// </summary>
	string LabelPinnedGame { get; }

	/// <summary>
	/// Key: "Label.PlayButton"
	/// English String: "Play"
	/// </summary>
	string LabelPlayButton { get; }
	...
	/// </summary>
	string LabelPlayTogether { get; }

	/// <summary>
	/// Key: "Label.RecommendedGames"
	/// English String: "Recommended"
	/// </summary>
	string LabelRecommendedGames { get; }

	/// <summary>
	/// Key: "Label.SeeLess"
	/// English String: "See Less"
	/// </summary>
	string LabelSeeLess { get; }
	...
	/// </summary>
	string ResponsePartyInvite { get; }
	...
	/// </summary>
	string LabelBuyAccessToGameForModal(string placeName, string creatorName, string robux);

	/// <summary>
	/// Key: "Label.MemberJoinText"
	/// English String: "{userName} joined the party"
	/// </summary>
	string LabelMemberJoinText(string userName);
	...
	/// English String: "Mute {username}"
	/// </summary>
	string LableMuteUser(string username);
	...
	/// </summary>
	string MessagePinGameUpdate(string userName, string gameName);
