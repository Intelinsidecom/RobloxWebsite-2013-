...
internal class AccountSettingsResources_zh_cjv : AccountSettingsResources_en_us, IAccountSettingsResources, ITranslationResources
{
	...
	/// </summary>
	public override string ActionBillingHistoryLoadMore => "åŠ è½½æ›´å¤š";

	/// <summary>
	/// Key: "Action.CancelRenewal"
	/// English String: "Cancel Renewal"
	/// </summary>
	public override string ActionCancelRenewal => "å–æ¶ˆç»­è®¢";

	/// <summary>
	/// Key: "Action.Dialog.AddEmail"
	/// English String: "Add Email"
	/// </summary>
	public override string ActionDialogAddEmail => "æ·»åŠ ç”µå­é‚®ä»¶";

	/// <summary>
	/// Key: "Action.Dialog.AddPhone"
	/// English String: "Add Phone"
	/// </summary>
	public override string ActionDialogAddPhone => "æ·»åŠ æ‰‹æœº";
	...
	/// </summary>
	public override string ActionDialogChangeEmail => "æ›´æ”¹ç”µå­é‚®ä»¶";

	/// <summary>
	/// Key: "Action.Dialog.ChangeEmailConfirmation"
	/// English String: "OK"
	/// </summary>
	public override string ActionDialogChangeEmailConfirmation => "å¥½";

	/// <summary>
	/// Key: "Action.Dialog.ChangePassword"
	/// English String: "Update"
	/// </summary>
	public override string ActionDialogChangePassword => "æ›´æ–°";

	/// <summary>
	/// Key: "Action.Dialog.ChangePasswordConfirmation"
	/// English String: "OK"
	/// </summary>
	public override string ActionDialogChangePasswordConfirmation => "å¥½";

	/// <summary>
	/// Key: "Action.Dialog.ChangeUsernameBuy"
	/// English String: "Buy"
	/// </summary>
	public override string ActionDialogChangeUsernameBuy => "è´­ä¹°";
	...
	/// </summary>
	public override string ActionDialogEditPhonePrimary => "ç¼–è¾‘æ‰‹æœº";

	/// <summary>
	/// Key: "Action.Dialog.EditPhoneSecondary"
	/// English String: "Remove Phone Number"
	/// </summary>
	public override string ActionDialogEditPhoneSecondary => "ç§»é™¤æ‰‹æœºå·ç ";

	/// <summary>
	/// Key: "Action.Dialog.InsufficientFundsBuy"
	/// English String: "Buy"
	/// </summary>
	public override string ActionDialogInsufficientFundsBuy => "è´­ä¹°";

	/// <summary>
	/// Key: "Action.Dialog.No"
	/// English String: "No"
	/// </summary>
	public override string ActionDialogNo => "å¦";

	/// <summary>
	/// Key: "Action.Dialog.PinCreate"
	/// English String: "Add"
	/// </summary>
	public override string ActionDialogPinCreate => "æ·»åŠ ";

	/// <summary>
	/// Key: "Action.Dialog.PinCreateOk"
	/// English String: "OK"
	/// </summary>
	public override string ActionDialogPinCreateOk => "å¥½";

	/// <summary>
	/// Key: "Action.Dialog.PinUnlock"
	/// English String: "Unlock"
	/// </summary>
	public override string ActionDialogPinUnlock => "è§£é”";

	/// <summary>
	/// Key: "Action.Dialog.RemovePhonePrimary"
	/// English String: "Remove"
	/// </summary>
	public override string ActionDialogRemovePhonePrimary => "ç§»é™¤";

	/// <summary>
	/// Key: "Action.Dialog.RemovePhoneSecondary"
	/// English String: "Cancel"
	/// </summary>
	public override string ActionDialogRemovePhoneSecondary => "å–æ¶ˆ";
	...
	/// English String: "OK"
	/// </summary>
	public override string ActionDialogSuccess => "å¥½";

	/// <summary>
	/// Key: "Action.Dialog.Update"
	/// English String: "Update"
	/// </summary>
	public override string ActionDialogUpdate => "æ›´æ–°";

	/// <summary>
	/// Key: "Action.Dialog.VerifyEmailOk"
	/// English String: "OK"
	/// </summary>
	public override string ActionDialogVerifyEmailOk => "å¥½";

	/// <summary>
	/// Key: "Action.Dialog.VerifyEmailPrimary"
	/// English String: "Verify Email"
	/// </summary>
	public override string ActionDialogVerifyEmailPrimary => "éªŒè¯ç”µå­é‚®ä»¶";

	/// <summary>
	/// Key: "Action.Dialog.VerifyEmailRetry"
	/// English String: "Retry"
	/// </summary>
	public override string ActionDialogVerifyEmailRetry => "é‡è¯•";

	/// <summary>
	/// Key: "Action.Dialog.VerifyPhonePrimary"
	/// English String: "Verify"
	/// </summary>
	public override string ActionDialogVerifyPhonePrimary => "éªŒè¯";

	/// <summary>
	/// Key: "Action.Dialog.VerifyPhoneResendLink"
	/// English String: "Resend Code"
	/// </summary>
	public override string ActionDialogVerifyPhoneResendLink => "é‡æ–°å‘é€éªŒè¯ç ";

	/// <summary>
	/// Key: "Action.Dialog.VerifyPhoneSecondary"
	/// English String: "Cancel"
	/// </summary>
	public override string ActionDialogVerifyPhoneSecondary => "å–æ¶ˆ";

	/// <summary>
	/// Key: "Action.Dialog.Yes"
	/// English String: "Yes"
	/// </summary>
	public override string ActionDialogYes => "æ˜¯";

	/// <summary>
	/// Key: "Action.Hide"
	/// English String: "Hide"
	/// </summary>
	public override string ActionHide => "éšè—";
	...
	/// </summary>
	public override string ActionJoinBuildersClub => "åŠ å…¥ Builders Club";
	...
	/// English String: "Show"
	/// </summary>
	public override string ActionShow => "æ˜¾ç¤º";

	/// <summary>
	/// Key: "Action.SignoutAllSessions"
	/// English String: "Sign out"
	/// </summary>
	public override string ActionSignoutAllSessions => "æ³¨é”€";

	/// <summary>
	/// Key: "Action.SocialDisconnect"
	/// English String: "Disconnect"
	/// </summary>
	public override string ActionSocialDisconnect => "æ–­å¼€è¿žæŽ¥";

	/// <summary>
	/// Key: "Action.SuccessDialogButtonText"
	/// English String: "OK"
	/// </summary>
	public override string ActionSuccessDialogButtonText => "å¥½";

	/// <summary>
	/// Key: "Action.Unblock"
	/// English String: "Unblock"
	/// </summary>
	public override string ActionUnblock => "å–æ¶ˆå±è”½";

	/// <summary>
	/// Key: "Action.UpgradeMembership"
	/// English String: "Upgrade Membership"
	/// </summary>
	public override string ActionUpgradeMembership => "å‡çº§ä¼šå‘˜èµ„æ ¼";
	...
	/// </summary>
	public override string DescriptionAccountControls => "ä½ å¯ä»¥è®¾ç½®å¸æˆ·é™åˆ¶ï¼Œé™åˆ¶å¯¹å¸æˆ·è®¾ç½®åŠæœªç­›é€‰å†…å®¹çš„è®¿é—®æƒé™";
	...
	/// </summary>
	public override string DescriptionAccountEmailRevertEmailSubject => "é‡ç½® Roblox ç”µå­é‚®ä»¶";

	/// <summary>
	/// Key: "Description.DesktopPush1"
	/// English String: "See notifications on this computer even when Roblox is closed."
	/// </summary>
	public override string DescriptionDesktopPush1 => "Roblox å…³é—­æ—¶ä»å¯åœ¨æ­¤ç”µè„‘ä¸Šæ”¶åˆ°é€šçŸ¥ã€‚";
	...
	/// </summary>
	public override string DescriptionDesktopPush2 => "è¦çœ‹åˆ°é€šçŸ¥ï¼Œç³»ç»Ÿå¯èƒ½ä¼šæç¤ºä½ æ‰“å¼€æµè§ˆå™¨çš„æŽ¨é€é€šçŸ¥ã€‚";

	/// <summary>
	/// Key: "Description.DesktopPush3"
	/// English String: "Desktop notifications for this device."
	/// </summary>
	public override string DescriptionDesktopPush3 => "æ­¤è®¾å¤‡çš„æ¡Œé¢é€šçŸ¥ã€‚";
	...
	/// </summary>
	public override string DescriptionDialogAddPhone => "è¯·ç¡®è®¤ä½ çš„å›½å®¶ä»£ç å¹¶è¾“å…¥ä½ çš„ç”µè¯å·ç ã€‚æˆ‘ä»¬ä¼šå‘é€çŸ­ä¿¡ä»¥å®ŒæˆéªŒè¯ã€‚ï¼ˆæ³¨æ„ï¼šå‘é€çŸ­ä¿¡æ—¶å¯èƒ½ä¼šäº§ç”Ÿé€šä¿¡è´¹ç”¨ï¼‰";

	/// <summary>
	/// Key: "Description.Dialog.ChangeEmailConfirmation"
	/// English String: "An email has been sent for verification"
	/// </summary>
	public override string DescriptionDialogChangeEmailConfirmation => "å·²å‘é€éªŒè¯ç”µå­é‚®ä»¶";
	...
	/// </summary>
	public override string DescriptionDialogChangeEmailWarning => "æ–°ç”µå­é‚®ä»¶éªŒè¯åŽï¼Œæ‰èƒ½å¯¹å¸æˆ·é‚®ä»¶è¿›è¡Œæ›´æ”¹ã€‚";

	/// <summary>
	/// Key: "Description.Dialog.ChangePasswordConfirmation"
	/// English String: "You have successfully changed your password."
	/// </summary>
	public override string DescriptionDialogChangePasswordConfirmation => "ä½ å·²æˆåŠŸæ›´æ”¹å¯†ç ã€‚";
	...
	/// </summary>
	public override string DescriptionDialogChangeUsernameDisclaimer => "é‡è¦é€šçŸ¥ï¼šåŽŸå§‹å¸æˆ·çš„åˆ›å»ºæ—¥æœŸå°†è½¬ç§»è‡³ä½ çš„æ–°ç”¨æˆ·åä¸‹ã€‚";
	...
	/// </summary>
	public override string DescriptionDialogChangeUsernameForFree => "å¯å…è´¹æ›´æ”¹ç”¨æˆ·åä¸€æ¬¡ã€‚";
	...
	/// </summary>
	public override string DescriptionDialogChangeUsernameHistory => "æ­¤å‰çš„è®ºå›å‘å¸–ä¼šæ˜¾ç¤ºåœ¨ä½ çš„æ—§ç”¨æˆ·åä¸‹ï¼Œä¸ä¼šè½¬ç§»è‡³ä½ çš„æ–°ç”¨æˆ·åä¸‹ã€‚";

	/// <summary>
	/// Key: "Description.Dialog.ChangeUsernameTitle"
	/// English String: "Change Username"
	/// </summary>
	public override string DescriptionDialogChangeUsernameTitle => "æ›´æ”¹ç”¨æˆ·å";
	...
	/// </summary>
	public override string DescriptionDialogEditPhoneWarning => "æ–°æ‰‹æœºå·ç éªŒè¯åŽï¼Œæ‰èƒ½å¯¹æ‰‹æœºå·ç è¿›è¡Œæ›´æ”¹ã€‚";
	...
	/// </summary>
	public override string DescriptionDialogEmailProvideAndVerifyWarning => "ä½ å¿…é¡»å…ˆæä¾›å¹¶éªŒè¯ç”µå­é‚®ä»¶ï¼Œæ‰èƒ½æ›´æ”¹ç”¨æˆ·åã€‚";

	/// <summary>
	/// Key: "Description.Dialog.EmailVerificationSent"
	/// English String: "Thanks! Your verification email has been sent."
	/// </summary>
	public override string DescriptionDialogEmailVerificationSent => "è°¢è°¢ï¼ä½ çš„éªŒè¯ç”µå­é‚®ä»¶å·²å‘é€ã€‚";

	/// <summary>
	/// Key: "Description.Dialog.EmailVerifyWarning"
	/// English String: "You must verify your email before you can change your username."
	/// </summary>
	public override string DescriptionDialogEmailVerifyWarning => "ä½ å¿…é¡»å…ˆéªŒè¯ç”µå­é‚®ä»¶ï¼Œæ‰èƒ½æ›´æ”¹ç”¨æˆ·åã€‚";
	...
	/// </summary>
	public override string DescriptionDialogFacebookDisconnectWarning => "è¯·å…ˆæ·»åŠ å¯†ç ä¿æŠ¤ä½ çš„å¸æˆ·ï¼Œç„¶åŽå†ä»Ž Facebook æ–­å¼€è¿žæŽ¥ã€‚";
	...
	/// </summary>
	public override string DescriptionDialogMissingEmailAccountPin => "ä½ å¿…é¡»å…ˆæä¾›å¹¶éªŒè¯ç”µå­é‚®ä»¶ï¼Œæ‰èƒ½æ·»åŠ å¸æˆ· PINã€‚";
	...
	/// </summary>
	public override string DescriptionDialogMissingEmailTwoStepVerification => "ä½ å¿…é¡»å…ˆæä¾›å¹¶éªŒè¯ç”µå­é‚®ä»¶ï¼Œæ‰èƒ½å¯ç”¨ä¸¤æ­¥éªŒè¯ã€‚";
	...
	/// English String: "You must provide and verify your email before you can change your username."
	/// </summary>
	public override string DescriptionDialogMissingEmailUsername => "ä½ å¿…é¡»å…ˆæä¾›å¹¶éªŒè¯ç”µå­é‚®ä»¶ï¼Œæ‰èƒ½æ›´æ”¹ç”¨æˆ·åã€‚";

	/// <summary>
	/// Key: "Description.Dialog.PinUnlock"
	/// English String: "Enter the Account PIN attached to your account"
	/// </summary>
	public override string DescriptionDialogPinUnlock => "è¯·è¾“å…¥ä¸Žä½ çš„å¸æˆ·ç›¸å…³è”çš„ PIN";
	...
	/// </summary>
	public override string DescriptionDialogUnverifiedEmailAccountPin => "ä½ å¿…é¡»å…ˆéªŒè¯ç”µå­é‚®ä»¶ï¼Œæ‰èƒ½æ·»åŠ å¸æˆ· PIN ç ã€‚";
	...
	/// </summary>
	public override string DescriptionDialogUnverifiedEmailTwoStepVerification => "ä½ å¿…é¡»å…ˆéªŒè¯ç”µå­é‚®ä»¶ï¼Œæ‰èƒ½å¯ç”¨ä¸¤æ­¥éªŒè¯ã€‚";
	...
	/// English String: "You must verify your email before you can change your username."
	/// </summary>
	public override string DescriptionDialogUnverifiedEmailUsername => "ä½ å¿…é¡»å…ˆéªŒè¯ç”µå­é‚®ä»¶ï¼Œæ‰èƒ½æ›´æ”¹ç”¨æˆ·åã€‚";
	...
	/// </summary>
	public override string DescriptionFastTrack => "ç”±äºŽä½ æŒç»­æäº¤äº†ä¼˜è´¨çš„æ»¥ç”¨è¡Œä¸ºæŠ¥å‘Šï¼Œä½ å·²è¢«åŠ è‡³å¿«é€Ÿè¿½è¸ªæŠ¥å‘Šè®¡åˆ’ã€‚ä½ æäº¤çš„æ»¥ç”¨è¡Œä¸ºæŠ¥å‘Šå°†ä¼šæ›´å¿«åœ°å¾—åˆ°å®¡æ ¸ã€‚ç»§ç»­æäº¤ä¼˜è´¨çš„æ»¥ç”¨è¡Œä¸ºæŠ¥å‘Šï¼Œä½ å³å¯ç»§ç»­ç•™åœ¨æœ¬è®¡åˆ’ã€‚æ„Ÿè°¢ä½ å¸®åŠ© Roblox ç»´æŠ¤ä¼˜è´¨çŽ¯å¢ƒï¼";
	...
	/// </summary>
	public override string DescriptionFastTrackStatistics => "ç»Ÿè®¡ä¿¡æ¯";
	...
	/// </summary>
	public override string DescriptionHelpTextDescription => "è¯·å‹¿æä¾›ä»»ä½•èƒ½åœ¨ Roblox ä»¥å¤–ç”¨äºŽè¯†åˆ«ä¸ªäººèº«ä»½çš„è¯¦ç»†ä¿¡æ¯ã€‚";
	...
	/// </summary>
	public override string DescriptionHelpTextFastTrackAccuracy => "å‡†ç¡®æ€§ä»£è¡¨çš„æ˜¯å®¡æ ¸å›¢é˜Ÿæ‰¹å‡†æ»¥ç”¨æŠ¥å‘Šçš„é¢‘çŽ‡ã€‚åœ¨ä½ æäº¤ä¸€å®šæ•°é‡çš„æŠ¥å‘ŠåŽå°†ä¼šæ˜¾ç¤ºè¯¥é¡¹æ•°æ®ã€‚â€œæ‰€æœ‰äººâ€åˆ™æ˜¯ä»£è¡¨æ‰€æœ‰å¿«é€Ÿè¿½è¸ªè®¡åˆ’çš„æˆå‘˜ã€‚";

	/// <summary>
	/// Key: "Description.HelpText.PrivacyMode"
	/// English String: "Updating age to under 13 will enable Privacy Mode."
	/// </summary>
	public override string DescriptionHelpTextPrivacyMode => "å°†å¹´é¾„æ›´æ–°ä¸º 13 å²ä»¥ä¸‹ä¼šå¯ç”¨éšç§æ¨¡å¼ã€‚";

	/// <summary>
	/// Key: "Description.HoverText.ChangePassword"
	/// English String: "Change Password"
	/// </summary>
	public override string DescriptionHoverTextChangePassword => "æ›´æ”¹å¯†ç ";

	/// <summary>
	/// Key: "Description.HoverText.ChangeUsername"
	/// English String: "Change Username"
	/// </summary>
	public override string DescriptionHoverTextChangeUsername => "æ›´æ”¹ç”¨æˆ·å";

	/// <summary>
	/// Key: "Description.HoverText.UpdateEmail"
	/// English String: "Update Email"
	/// </summary>
	public override string DescriptionHoverTextUpdateEmail => "æ›´æ–°ç”µå­é‚®ä»¶";

	/// <summary>
	/// Key: "Description.MembershipHelp"
	/// English String: "For billing and payment questions: info@roblox.com"
	/// </summary>
	public override string DescriptionMembershipHelp => "å…³äºŽè´¦å•ä¸Žä»˜æ¬¾é—®é¢˜ï¼Œè¯·è”ç³»ï¼šinfo@roblox.com";

	/// <summary>
	/// Key: "Description.MembershipStatus"
	/// English String: "You're not a member yet. Join Builders Club today!"
	/// </summary>
	public override string DescriptionMembershipStatus => "ä½ è¿˜ä¸æ˜¯ä¼šå‘˜ã€‚å¿«æ¥åŠ å…¥ Builders Club å§ï¼";

	/// <summary>
	/// Key: "Description.MembershipStatusRobloxPremium"
	/// English String: "You're not a member yet. Join Roblox Premium today!"
	/// </summary>
	public override string DescriptionMembershipStatusRobloxPremium => "ä½ è¿˜ä¸æ˜¯ä¼šå‘˜ã€‚å¿«æ¥åŠ å…¥ Roblox Premium å§ï¼";
	...
	/// </summary>
	public override string DescriptionMobilePush1 => "åœ¨ä½ çš„è®¾å¤‡ä¸»ç”»é¢çœ‹åˆ°é€šçŸ¥ã€‚ä½ å¯ä»¥ä»Ž Roblox App ä¸­å¼€å¯æˆ–å…³é—­è¿™é¡¹è®¾ç½®ã€‚";

	/// <summary>
	/// Key: "Description.MobilePush2"
	/// English String: "Mobile push notifications for this device."
	/// </summary>
	public override string DescriptionMobilePush2 => "æ­¤è®¾å¤‡çš„ç§»åŠ¨æŽ¨é€é€šçŸ¥ã€‚";
	...
	/// </summary>
	public override string DescriptionNotificationStream1 => "åœ¨æˆ‘çš„åŠ¨æ€æ¶ˆæ¯ä¸­çœ‹åˆ°é€šçŸ¥ã€‚ç‚¹å‡»é¡¶éƒ¨æ ä¸­çš„é€šçŸ¥å›¾æ ‡ï¼Œå³å¯æŸ¥çœ‹è¿™äº›é€šçŸ¥ã€‚";
	...
	/// </summary>
	public override string DescriptionNotificationStream2 => "å½“ä½ å…³é—­æŸç§é€šçŸ¥ç±»åž‹åŽï¼Œæˆ‘ä»¬åˆ™ä¸ä¼šå†å‘ä½ å‘é€ä»»ä½•è¯¥ç±»åž‹çš„æ–°é€šçŸ¥ã€‚";
	...
	/// </summary>
	public override string DescriptionRenevalFromWebsiteOnly => "æ³¨æ„ï¼šå¦‚æžœä½ æƒ³å–æ¶ˆä¼šå‘˜èµ„æ ¼ç»­è®¢ï¼Œè¯·ä»Žç½‘ç«™ç™»å½•ã€‚";

	/// <summary>
	/// Key: "Description.SuccessDialogMessage"
	/// English String: "Saved  Successfully!"
	/// </summary>
	public override string DescriptionSuccessDialogMessage => "å·²æˆåŠŸä¿å­˜ï¼";

	/// <summary>
	/// Key: "Description.TwoStepVerificationSecondary"
	/// English String: "A verified email is required"
	/// </summary>
	public override string DescriptionTwoStepVerificationSecondary => "éœ€è¦å·²éªŒè¯çš„ç”µå­é‚®ä»¶";
	...
	/// </summary>
	public override string DescriptionUsernameChangeEmailSubject => "Roblox ç”¨æˆ·åæ›´æ”¹";
	...
	/// </summary>
	public override string DescriptionVerificationEmailSubjectOver13 => "Roblox ç”µå­é‚®ä»¶éªŒè¯";
	...
	/// </summary>
	public override string DescriptionVerificationEmailSubjectUnder13 => "Roblox å¸æˆ·æŽˆæƒ";

	/// <summary>
	/// Key: "Example.Description"
	/// English String: "Describe yourself(1000 character limit)"
	/// </summary>
	public override string ExampleDescription => "è‡ªæˆ‘ä»‹ç»ï¼ˆé™ 1000 ä¸ªå­—ç¬¦ä»¥å†…ï¼‰";

	/// <summary>
	/// Key: "Example.Facebook"
	/// English String: "e.g. www.facebook.com/Roblox"
	/// </summary>
	public override string ExampleFacebook => "ä¾‹å¦‚ï¼šwww.facebook.com/Roblox";

	/// <summary>
	/// Key: "Example.GooglePlus"
	/// English String: "e.g. http://plus.google.com/profileId"
	/// </summary>
	public override string ExampleGooglePlus => "ä¾‹å¦‚ï¼šhttp://plus.google.com/profileId";

	/// <summary>
	/// Key: "Example.Twitch"
	/// English String: "e.g. www.twitch.tv/roblox/profile"
	/// </summary>
	public override string ExampleTwitch => "ä¾‹å¦‚ï¼šwww.twitch.tv/roblox/profile";

	/// <summary>
	/// Key: "Example.Twitter"
	/// English String: "e.g. @Roblox"
	/// </summary>
	public override string ExampleTwitter => "ä¾‹å¦‚ï¼š@Roblox";

	/// <summary>
	/// Key: "Example.YouTube"
	/// English String: "e.g. www.youtube.com/user/roblox"
	/// </summary>
	public override string ExampleYouTube => "ä¾‹å¦‚ï¼šwww.youtube.com/user/roblox";

	/// <summary>
	/// Key: "Heading.AccountControls"
	/// English String: "What are Account Controls?"
	/// </summary>
	public override string HeadingAccountControls => "ä»€ä¹ˆæ˜¯å¸æˆ·æŽ§åˆ¶ï¼Ÿ";

	/// <summary>
	/// Key: "Heading.AccountInfo"
	/// English String: "Account Info"
	/// </summary>
	public override string HeadingAccountInfo => "å¸æˆ·ä¿¡æ¯";

	/// <summary>
	/// Key: "Heading.Billing"
	/// English String: "Billing"
	/// </summary>
	public override string HeadingBilling => "è´¦å•";

	/// <summary>
	/// Key: "Heading.BlockedUsers"
	/// English String: "Blocked Users"
	/// </summary>
	public override string HeadingBlockedUsers => "å·²å±è”½ç”¨æˆ·";

	/// <summary>
	/// Key: "Heading.ContactSettings"
	/// English String: "Contact Settings"
	/// </summary>
	public override string HeadingContactSettings => "è”ç³»äººè®¾ç½®";

	/// <summary>
	/// Key: "Heading.DesktopPush"
	/// English String: "Desktop Push"
	/// </summary>
	public override string HeadingDesktopPush => "æ¡Œé¢æŽ¨é€";

	/// <summary>
	/// Key: "Heading.Dialog.AddPassword"
	/// English String: "Add Password"
	/// </summary>
	public override string HeadingDialogAddPassword => "æ·»åŠ å¯†ç ";

	/// <summary>
	/// Key: "Heading.Dialog.AddPhone"
	/// English String: "Add Phone"
	/// </summary>
	public override string HeadingDialogAddPhone => "æ·»åŠ æ‰‹æœº";

	/// <summary>
	/// Key: "Heading.Dialog.ChangeEmail"
	/// English String: "Change My Email"
	/// </summary>
	public override string HeadingDialogChangeEmail => "æ›´æ”¹æˆ‘çš„ç”µå­é‚®ä»¶";

	/// <summary>
	/// Key: "Heading.Dialog.ChangeEmailConfirmation"
	/// English String: "Email Address Changed"
	/// </summary>
	public override string HeadingDialogChangeEmailConfirmation => "ç”µå­é‚®ä»¶åœ°å€å·²æ›´æ”¹";

	/// <summary>
	/// Key: "Heading.Dialog.ChangePassword"
	/// English String: "Change Password"
	/// </summary>
	public override string HeadingDialogChangePassword => "æ›´æ”¹å¯†ç ";
	...
	/// English String: "Change Username"
	/// </summary>
	public override string HeadingDialogChangeUsername => "æ›´æ”¹ç”¨æˆ·å";

	/// <summary>
	/// Key: "Heading.Dialog.DefaultError"
	/// English String: "Error"
	/// </summary>
	public override string HeadingDialogDefaultError => "é”™è¯¯";
	...
	/// English String: "Edit Phone"
	/// </summary>
	public override string HeadingDialogEditPhone => "ç¼–è¾‘æ‰‹æœº";

	/// <summary>
	/// Key: "Heading.Dialog.InsufficientFunds"
	/// English String: "Insufficient Funds"
	/// </summary>
	public override string HeadingDialogInsufficientFunds => "èµ„é‡‘ä¸è¶³";
	...
	/// </summary>
	public override string HeadingDialogPinCreate => "æ·»åŠ  PIN";
	...
	/// </summary>
	public override string HeadingDialogPinUnlock => "éœ€è¦å¸æˆ· PIN";

	/// <summary>
	/// Key: "Heading.Dialog.RemovePhone"
	/// English String: "Remove Phone"
	/// </summary>
	public override string HeadingDialogRemovePhone => "ç§»é™¤æ‰‹æœº";

	/// <summary>
	/// Key: "Heading.Dialog.VerifiedEmailRequired"
	/// English String: "Verified Email Required"
	/// </summary>
	public override string HeadingDialogVerifiedEmailRequired => "éœ€è¦å·²éªŒè¯çš„ç”µå­é‚®ä»¶";

	/// <summary>
	/// Key: "Heading.Dialog.VerifyEmail"
	/// English String: "Verify Email"
	/// </summary>
	public override string HeadingDialogVerifyEmail => "éªŒè¯ç”µå­é‚®ä»¶";

	/// <summary>
	/// Key: "Heading.Dialog.VerifyPhone"
	/// English String: "Verify Phone"
	/// </summary>
	public override string HeadingDialogVerifyPhone => "éªŒè¯æ‰‹æœº";
	...
	/// </summary>
	public override string HeadingFastTrack => "å¿«é€Ÿè¿½è¸ª";

	/// <summary>
	/// Key: "Heading.MembershipStatus"
	/// English String: "Membership status"
	/// </summary>
	public override string HeadingMembershipStatus => "ä¼šå‘˜çŠ¶æ€";

	/// <summary>
	/// Key: "Heading.NotificationOptions"
	/// English String: "Notify me when"
	/// </summary>
	public override string HeadingNotificationOptions => "æœ‰ä¸‹åˆ—æƒ…å½¢æ—¶é€šçŸ¥æˆ‘";
	...
	/// English String: "Notify me when"
	/// </summary>
	public override string HeadingNotificationsActionWhen => "æœ‰ä¸‹åˆ—æƒ…å½¢æ—¶é€šçŸ¥æˆ‘";

	/// <summary>
	/// Key: "Heading.Notifications.DesktopPush"
	/// English String: "Desktop Push"
	/// </summary>
	public override string HeadingNotificationsDesktopPush => "æ¡Œé¢æŽ¨é€";

	/// <summary>
	/// Key: "Heading.Notifications.MobilePush"
	/// English String: "Mobile Push"
	/// </summary>
	public override string HeadingNotificationsMobilePush => "ç§»åŠ¨æŽ¨é€";

	/// <summary>
	/// Key: "Heading.Notifications.Stream"
	/// English String: "Notification Stream"
	/// </summary>
	public override string HeadingNotificationsStream => "åŠ¨æ€æ¶ˆæ¯";

	/// <summary>
	/// Key: "Heading.NotificationStream"
	/// English String: "Notification Stream"
	/// </summary>
	public override string HeadingNotificationStream => "åŠ¨æ€æ¶ˆæ¯";

	/// <summary>
	/// Key: "Heading.OtherSettings"
	/// English String: "Other Settings"
	/// </summary>
	public override string HeadingOtherSettings => "å…¶ä»–è®¾ç½®";

	/// <summary>
	/// Key: "Heading.PageTitle"
	/// English String: "My Settings"
	/// </summary>
	public override string HeadingPageTitle => "æˆ‘çš„è®¾ç½®";

	/// <summary>
	/// Key: "Heading.Personal"
	/// English String: "Personal"
	/// </summary>
	public override string HeadingPersonal => "ä¸ªäººèµ„æ–™";

	/// <summary>
	/// Key: "Heading.Pin"
	/// English String: "Account PIN"
	/// </summary>
	public override string HeadingPin => "å¸æˆ· PIN";

	/// <summary>
	/// Key: "Heading.PrivacySettings"
	/// English String: "Privacy Settings"
	/// </summary>
	public override string HeadingPrivacySettings => "éšç§è®¾ç½®";

	/// <summary>
	/// Key: "Heading.RenevalDate"
	/// English String: "Renewal date"
	/// </summary>
	public override string HeadingRenevalDate => "ç»­è®¢æ—¥æœŸ";

	/// <summary>
	/// Key: "Heading.Restrictions"
	/// English String: "Account Restrictions"
	/// </summary>
	public override string HeadingRestrictions => "å¸æˆ·é™åˆ¶";

	/// <summary>
	/// Key: "Heading.SecureSignOut"
	/// English String: "Secure Sign Out"
	/// </summary>
	public override string HeadingSecureSignOut => "å®‰å…¨æ³¨é”€";

	/// <summary>
	/// Key: "Heading.SocialNetworks"
	/// English String: "Social Networks"
	/// </summary>
	public override string HeadingSocialNetworks => "ç¤¾äº¤ç½‘ç»œ";

	/// <summary>
	/// Key: "Heading.SocialSignOn"
	/// English String: "Social Sign On"
	/// </summary>
	public override string HeadingSocialSignOn => "ç¤¾äº¤ç™»å½•";
	...
	/// English String: "Account Info"
	/// </summary>
	public override string HeadingTabAccountInfo => "å¸æˆ·ä¿¡æ¯";

	/// <summary>
	/// Key: "Heading.Tab.Billing"
	/// English String: "Billing"
	/// </summary>
	public override string HeadingTabBilling => "è´¦å•";
	...
	/// English String: "Fast Track"
	/// </summary>
	public override string HeadingTabFastTrack => "å¿«é€Ÿè¿½è¸ª";
	...
	/// </summary>
	public override string HeadingTabPrivacy => "éšç§";

	/// <summary>
	/// Key: "Heading.Tab.Security"
	/// English String: "Security"
	/// </summary>
	public override string HeadingTabSecurity => "å®‰å…¨";

	/// <summary>
	/// Key: "Heading.Transactions"
	/// English String: "Transactions"
	/// </summary>
	public override string HeadingTransactions => "äº¤æ˜“";

	/// <summary>
	/// Key: "Heading.TwoStepVerification"
	/// English String: "2 Step Verification"
	/// </summary>
	public override string HeadingTwoStepVerification => "ä¸¤æ­¥éªŒè¯";
	...
	/// </summary>
	public override string LabelAccountPinDisabled => "å¸æˆ· PIN å½“å‰å·²åœç”¨";

	/// <summary>
	/// Key: "Label.AccountPinEnabled"
	/// English String: "Account PIN is currently enabled"
	/// </summary>
	public override string LabelAccountPinEnabled => "å¸æˆ· PIN å½“å‰å·²å¯ç”¨";

	/// <summary>
	/// Key: "Label.AccountRestrictionDisabled"
	/// English String: "Account Restrictions is currently disabled"
	/// </summary>
	public override string LabelAccountRestrictionDisabled => "å¸æˆ·é™åˆ¶å½“å‰å·²åœç”¨";

	/// <summary>
	/// Key: "Label.AccountRestrictionEnabled"
	/// English String: "Account Restrictions is currently enabled"
	/// </summary>
	public override string LabelAccountRestrictionEnabled => "å¸æˆ·é™åˆ¶å½“å‰å·²å¯ç”¨";

	/// <summary>
	/// Key: "Label.AddEmail"
	/// English String: "Add Email"
	/// </summary>
	public override string LabelAddEmail => "æ·»åŠ ç”µå­é‚®ä»¶";

	/// <summary>
	/// Key: "Label.AddEmailParent"
	/// English String: "Add Parent's Email"
	/// </summary>
	public override string LabelAddEmailParent => "æ·»åŠ å®¶é•¿ç”µå­é‚®ä»¶";

	/// <summary>
	/// Key: "Label.AddPassword"
	/// English String: "Add Password:"
	/// </summary>
	public override string LabelAddPassword => "æ·»åŠ å¯†ç ï¼š";

	/// <summary>
	/// Key: "Label.AddPhone"
	/// English String: "Add Phone"
	/// </summary>
	public override string LabelAddPhone => "æ·»åŠ æ‰‹æœº";

	/// <summary>
	/// Key: "Label.AddPhoneLink"
	/// English String: "Add Phone"
	/// </summary>
	public override string LabelAddPhoneLink => "æ·»åŠ æ‰‹æœº";

	/// <summary>
	/// Key: "Label.BillingHelp"
	/// English String: "For billing and payment questions:"
	/// </summary>
	public override string LabelBillingHelp => "å…³äºŽè´¦å•ä¸Žä»˜æ¬¾é—®é¢˜ï¼š";
	...
	/// English String: "Date"
	/// </summary>
	public override string LabelBillingHistoryDate => "æ—¥æœŸ";

	/// <summary>
	/// Key: "Label.BillingHistoryDescription"
	/// English String: "Description"
	/// </summary>
	public override string LabelBillingHistoryDescription => "æè¿°";
	...
	/// </summary>
	public override string LabelBillingHistoryGeneralErrors => "æœåŠ¡å½“å‰å·²åœç”¨ï¼Œè¯·ç¨åŽé‡è¯•ã€‚";

	/// <summary>
	/// Key: "Label.BillingHistoryNoTransactions"
	/// English String: "No Transactions"
	/// </summary>
	public override string LabelBillingHistoryNoTransactions => "æ— äº¤æ˜“";

	/// <summary>
	/// Key: "Label.BillingHistoryPaymentType"
	/// English String: "Payment Type"
	/// </summary>
	public override string LabelBillingHistoryPaymentType => "ä»˜æ¬¾ç±»åž‹";
	...
	/// </summary>
	public override string LabelChangeYourUsername => "æ›´æ”¹ä½ çš„ç”¨æˆ·å";

	/// <summary>
	/// Key: "Label.ChooseLanguage"
	/// English String: "Choose Language"
	/// </summary>
	public override string LabelChooseLanguage => "é€‰æ‹©è¯­è¨€";
	...
	/// English String: "Off"
	/// </summary>
	public override string LabelClassicTheme => "å…³é—­";

	/// <summary>
	/// Key: "Label.ConnectAccount"
	/// English String: "Connect account:"
	/// </summary>
	public override string LabelConnectAccount => "è¿žæŽ¥å¸æˆ·ï¼š";

	/// <summary>
	/// Key: "Label.Country"
	/// English String: "Choose a Country/Region"
	/// </summary>
	public override string LabelCountry => "é€‰æ‹©å›½å®¶/åœ°åŒº";
	...
	/// </summary>
	public override string LabelCountryTitle => "ä½ç½®";
	...
	/// English String: "Dark"
	/// </summary>
	public override string LabelDarkTheme => "é»‘è‰²";

	/// <summary>
	/// Key: "Label.Dialog.AddEmailOver13"
	/// English String: "Add My Email"
	/// </summary>
	public override string LabelDialogAddEmailOver13 => "æ·»åŠ æˆ‘çš„ç”µå­é‚®ä»¶";

	/// <summary>
	/// Key: "Label.Dialog.AddEmailUnder13"
	/// English String: "Add Parent's Email"
	/// </summary>
	public override string LabelDialogAddEmailUnder13 => "æ·»åŠ å®¶é•¿ç”µå­é‚®ä»¶";

	/// <summary>
	/// Key: "Label.Dialog.AddPhoneField"
	/// English String: "Phone Number"
	/// </summary>
	public override string LabelDialogAddPhoneField => "æ‰‹æœºå·ç ";

	/// <summary>
	/// Key: "Label.Dialog.AddPhonePassword"
	/// English String: "Verify Account Password"
	/// </summary>
	public override string LabelDialogAddPhonePassword => "éªŒè¯å¸æˆ·å¯†ç ";

	/// <summary>
	/// Key: "Label.Dialog.ChangeEmailField"
	/// English String: "Change My Email"
	/// </summary>
	public override string LabelDialogChangeEmailField => "æ›´æ”¹æˆ‘çš„ç”µå­é‚®ä»¶";

	/// <summary>
	/// Key: "Label.Dialog.ChangeEmailOver13"
	/// English String: "Change My Email"
	/// </summary>
	public override string LabelDialogChangeEmailOver13 => "æ›´æ”¹æˆ‘çš„ç”µå­é‚®ä»¶";

	/// <summary>
	/// Key: "Label.Dialog.ChangeEmailUnder13"
	/// English String: "Change Parent's Email"
	/// </summary>
	public override string LabelDialogChangeEmailUnder13 => "æ›´æ”¹å®¶é•¿ç”µå­é‚®ä»¶";

	/// <summary>
	/// Key: "Label.Dialog.ChangePasswordConfirm"
	/// English String: "Confirm Password"
	/// </summary>
	public override string LabelDialogChangePasswordConfirm => "ç¡®è®¤å¯†ç ";

	/// <summary>
	/// Key: "Label.Dialog.ChangePasswordCurrent"
	/// English String: "Current Password"
	/// </summary>
	public override string LabelDialogChangePasswordCurrent => "å½“å‰å¯†ç ";

	/// <summary>
	/// Key: "Label.Dialog.ChangePasswordNew"
	/// English String: "New Password"
	/// </summary>
	public override string LabelDialogChangePasswordNew => "æ–°å¯†ç ";

	/// <summary>
	/// Key: "Label.Dialog.ChangeUsernameAccountPassword"
	/// English String: "Account Password"
	/// </summary>
	public override string LabelDialogChangeUsernameAccountPassword => "å¸æˆ·å¯†ç ";

	/// <summary>
	/// Key: "Label.Dialog.ChangeUsernameField"
	/// English String: "Desired Username (3-20 characters)"
	/// </summary>
	public override string LabelDialogChangeUsernameField => "æƒ³ä½¿ç”¨çš„ç”¨æˆ·åï¼ˆ3-20 ä¸ªå­—ç¬¦ï¼‰";

	/// <summary>
	/// Key: "Label.Dialog.ConfirmPin"
	/// English String: "Confirm your PIN"
	/// </summary>
	public override string LabelDialogConfirmPin => "ç¡®è®¤ä½ çš„ PIN";

	/// <summary>
	/// Key: "Label.Dialog.EditPhoneCurrentNumber"
	/// English String: "Current Number:"
	/// </summary>
	public override string LabelDialogEditPhoneCurrentNumber => "å½“å‰å·ç ï¼š";

	/// <summary>
	/// Key: "Label.Dialog.EmailAddressChanged"
	/// English String: "Email Address Changed"
	/// </summary>
	public override string LabelDialogEmailAddressChanged => "ç”µå­é‚®ä»¶åœ°å€å·²æ›´æ”¹";

	/// <summary>
	/// Key: "Label.Dialog.EmailRequired"
	/// English String: "Email Required"
	/// </summary>
	public override string LabelDialogEmailRequired => "éœ€è¦ç”µå­é‚®ä»¶";

	/// <summary>
	/// Key: "Label.Dialog.VerifiedEmail"
	/// English String: "Verified email:"
	/// </summary>
	public override string LabelDialogVerifiedEmail => "å·²éªŒè¯çš„ç”µå­é‚®ä»¶ï¼š";

	/// <summary>
	/// Key: "Label.Dialog.VerifyPassword"
	/// English String: "Verify Account Password"
	/// </summary>
	public override string LabelDialogVerifyPassword => "éªŒè¯å¸æˆ·å¯†ç ";

	/// <summary>
	/// Key: "Label.Dialog.VerifyPhoneCodeLabel"
	/// English String: "Enter the code we just sent to your phone"
	/// </summary>
	public override string LabelDialogVerifyPhoneCodeLabel => "è¯·è¾“å…¥æˆ‘ä»¬åˆšå‘é€è‡³ä½ æ‰‹æœºçš„éªŒè¯ç ";

	/// <summary>
	/// Key: "Label.Dialog.VerifySms"
	/// English String: "Verify SMS"
	/// </summary>
	public override string LabelDialogVerifySms => "éªŒè¯çŸ­ä¿¡";

	/// <summary>
	/// Key: "Label.DropDown.Custom"
	/// English String: "Custom"
	/// </summary>
	public override string LabelDropDownCustom => "è‡ªå®šä¹‰";

	/// <summary>
	/// Key: "Label.DropDown.Default"
	/// English String: "Default"
	/// </summary>
	public override string LabelDropDownDefault => "é»˜è®¤";

	/// <summary>
	/// Key: "Label.DropDown.Everyone"
	/// English String: "Everyone"
	/// </summary>
	public override string LabelDropDownEveryone => "æ¯ä¸ªäºº";

	/// <summary>
	/// Key: "Label.DropDown.Followers"
	/// English String: "Friends, Users I Follow, and Followers"
	/// </summary>
	public override string LabelDropDownFollowers => "å¥½å‹ã€æˆ‘å…³æ³¨çš„ç”¨æˆ·å’Œç²‰ä¸";

	/// <summary>
	/// Key: "Label.DropDown.Following"
	/// English String: "Friends and Users I Follow"
	/// </summary>
	public override string LabelDropDownFollowing => "å¥½å‹å’Œæˆ‘å…³æ³¨çš„ç”¨æˆ·";

	/// <summary>
	/// Key: "Label.DropDown.Friends"
	/// English String: "Friends"
	/// </summary>
	public override string LabelDropDownFriends => "å¥½å‹";
	...
	/// English String: "None"
	/// </summary>
	public override string LabelDropDownNone => "æ— ";

	/// <summary>
	/// Key: "Label.DropDown.NoOne"
	/// English String: "No one"
	/// </summary>
	public override string LabelDropDownNoOne => "æ²¡æœ‰äºº";

	/// <summary>
	/// Key: "Label.DropDown.Off"
	/// English String: "Off"
	/// </summary>
	public override string LabelDropDownOff => "å…³é—­";

	/// <summary>
	/// Key: "Label.Email"
	/// English String: "Email address:"
	/// </summary>
	public override string LabelEmail => "ç”µå­é‚®ä»¶åœ°å€ï¼š";

	/// <summary>
	/// Key: "Label.EmailParent"
	/// English String: "Parent's Email address:"
	/// </summary>
	public override string LabelEmailParent => "å®¶é•¿ç”µå­é‚®ä»¶åœ°å€ï¼š";

	/// <summary>
	/// Key: "Label.EmailVerificationPending"
	/// English String: "Pending verification"
	/// </summary>
	public override string LabelEmailVerificationPending => "å¾…å¤„ç†éªŒè¯";

	/// <summary>
	/// Key: "Label.ExpirationDate"
	/// English String: "Expiration date"
	/// </summary>
	public override string LabelExpirationDate => "å¤±æ•ˆæ—¥æœŸ";

	/// <summary>
	/// Key: "Label.Facebook"
	/// English String: "Facebook:"
	/// </summary>
	public override string LabelFacebook => "Facebookï¼š";
	...
	/// </summary>
	public override string LabelFastTrackAccuracy => "å‡†ç¡®æ€§";
	...
	/// English String: "Everyone"
	/// </summary>
	public override string LabelFastTrackAllFastTrackMembers => "æ‰€æœ‰äºº";
	...
	/// English String: "Statistics"
	/// </summary>
	public override string LabelFastTrackStatistics => "ç»Ÿè®¡ä¿¡æ¯";
	...
	/// English String: "You"
	/// </summary>
	public override string LabelFastTrackYou => "ä½ ";
	...
	/// </summary>
	public override string LabelGooglePlus => "Google+ï¼š";
	...
	/// </summary>
	public override string LabelLightTheme => "ç™½è‰²";
	...
	/// </summary>
	public override string LabelLocaleTitle => "è¯­è¨€";

	/// <summary>
	/// Key: "Label.MembershipStatusRobloxPremium"
	/// English String: "You're not a member yet. Join Roblox Premium today!"
	/// </summary>
	public override string LabelMembershipStatusRobloxPremium => "ä½ è¿˜ä¸æ˜¯ä¼šå‘˜ã€‚å¿«æ¥åŠ å…¥ Roblox Premium å§ï¼";

	/// <summary>
	/// Key: "Label.Notifications.AddedToPrivateServer"
	/// English String: "I am invited to a VIP server"
	/// </summary>
	public override string LabelNotificationsAddedToPrivateServer => "æˆ‘å—é‚€è¿›å…¥ VIP æœåŠ¡å™¨";

	/// <summary>
	/// Key: "Label.Notifications.Chat"
	/// English String: "Someone chats with me"
	/// </summary>
	public override string LabelNotificationsChat => "æœ‰äººä¸Žæˆ‘èŠå¤©";
	...
	/// </summary>
	public override string LabelNotificationsConversationUniverseChanged => "æœ‰äººç½®é¡¶äº†æ–°æ¸¸æˆä¸€èµ·çŽ©";

	/// <summary>
	/// Key: "Label.Notifications.DeveloperMetricsAvailable"
	/// English String: "Analytics report becomes available"
	/// </summary>
	public override string LabelNotificationsDeveloperMetricsAvailable => "åˆ†æžæŠ¥å‘ŠçŽ°å·²å¯ç”¨";

	/// <summary>
	/// Key: "Label.Notifications.FriendRequestAccepted"
	/// English String: "Someone accepts my friend request"
	/// </summary>
	public override string LabelNotificationsFriendRequestAccepted => "æœ‰äººæŽ¥å—äº†æˆ‘çš„å¥½å‹è¯·æ±‚";

	/// <summary>
	/// Key: "Label.Notifications.FriendRequestReceived"
	/// English String: "I receive a friend request"
	/// </summary>
	public override string LabelNotificationsFriendRequestReceived => "æˆ‘æ”¶åˆ°å¥½å‹è¯·æ±‚";
	...
	/// </summary>
	public override string LabelNotificationsGameUpdate => "æˆ‘æ”¶åˆ°æ›´æ–°é€šçŸ¥";

	/// <summary>
	/// Key: "Label.Notifications.PartyInvited"
	/// English String: "Someone invites me to a party"
	/// </summary>
	public override string LabelNotificationsPartyInvited => "æœ‰äººé‚€è¯·æˆ‘å‚åŠ æ´¾å¯¹";

	/// <summary>
	/// Key: "Label.Notifications.PartyJoined"
	/// English String: "Someone joins a party I'm in"
	/// </summary>
	public override string LabelNotificationsPartyJoined => "æœ‰äººåŠ å…¥æˆ‘å½“å‰çš„æ´¾å¯¹";

	/// <summary>
	/// Key: "Label.Notifications.PrivateMessage"
	/// English String: "I receive a private message"
	/// </summary>
	public override string LabelNotificationsPrivateMessage => "æˆ‘æ”¶åˆ°ç§äººä¿¡æ¯";

	/// <summary>
	/// Key: "Label.Notifications.TeamCreateInvite"
	/// English String: "Someone invites me to edit a game"
	/// </summary>
	public override string LabelNotificationsTeamCreateInvite => "æœ‰äººé‚€è¯·æˆ‘ç¼–è¾‘æ¸¸æˆ";

	/// <summary>
	/// Key: "Label.Password"
	/// English String: "Password:"
	/// </summary>
	public override string LabelPassword => "å¯†ç ï¼š";

	/// <summary>
	/// Key: "Label.Phone"
	/// English String: "Phone Number:"
	/// </summary>
	public override string LabelPhone => "æ‰‹æœºå·ç ï¼š";
	...
	/// </summary>
	public override string LabelPinTimeRemaining => "å‰©ä½™æ—¶é—´";
	...
	/// </summary>
	public override string LabelPreviousUsernames => "æ—§ç”¨æˆ·åï¼š";

	/// <summary>
	/// Key: "Label.PrivacyMode"
	/// English String: "Privacy Mode"
	/// </summary>
	public override string LabelPrivacyMode => "éšç§æ¨¡å¼";

	/// <summary>
	/// Key: "Label.RenevalDate"
	/// English String: "Renewal date"
	/// </summary>
	public override string LabelRenevalDate => "ç»­è®¢æ—¥æœŸ";

	/// <summary>
	/// Key: "Label.SignOutAllSessions"
	/// English String: "Sign out of all other sessions"
	/// </summary>
	public override string LabelSignOutAllSessions => "æ³¨é”€æ‰€æœ‰å…¶ä»–ä¼šè¯";

	/// <summary>
	/// Key: "Label.SocialLinksVisibility"
	/// English String: "Visible to:"
	/// </summary>
	public override string LabelSocialLinksVisibility => "å¯è§å¯¹è±¡ï¼š";

	/// <summary>
	/// Key: "Label.ThemeTitle"
	/// English String: "Theme"
	/// </summary>
	public override string LabelThemeTitle => "ä¸»é¢˜";
	...
	/// </summary>
	public override string LabelToolTipContactSettings => "è‡ªå®šä¹‰ - æŽ§åˆ¶ä½ è‡ªå·±çš„è®¾ç½®ã€‚é»˜è®¤ - å¯ç”¨ä¸Žå¥½å‹èŠå¤©å¹¶å‘é€ä¿¡æ¯ç­‰åŠŸèƒ½ã€‚å…³é—­ - åœç”¨èŠå¤©å’Œå‘é€ä¿¡æ¯åŠŸèƒ½ã€‚";

	/// <summary>
	/// Key: "Label.ToolTip.PinLocked"
	/// English String: "All settings are locked. To edit, please unlock with your PIN"
	/// </summary>
	public override string LabelToolTipPinLocked => "è®¾ç½®å·²å…¨éƒ¨é”å®šã€‚è‹¥è¦ç¼–è¾‘ï¼Œè¯·ä½¿ç”¨ PIN è§£é”";

	/// <summary>
	/// Key: "Label.ToolTip.PinUnlocked"
	/// English String: "Click to lock your Settings page"
	/// </summary>
	public override string LabelToolTipPinUnlocked => "ç‚¹æŒ‰ä»¥é”å®šä½ çš„è®¾ç½®é¡µé¢";

	/// <summary>
	/// Key: "Label.ToolTip.PrivacyMode"
	/// English String: "Click here for more information"
	/// </summary>
	public override string LabelToolTipPrivacyMode => "ç‚¹å‡»æ­¤å¤„äº†è§£æ›´å¤šä¿¡æ¯";
	...
	/// </summary>
	public override string LabelToolTipWhoCanChatInApp => "æ­¤è®¾ç½®å†³å®šæ­¤ç”¨æˆ·åœ¨ App ä¸­åŠç½‘ç»œä¸Šå¯ä»¥èŠå¤©çš„å¯¹è±¡ï¼ˆæ— æ³•æŽ§åˆ¶æ¸¸æˆä¸­çš„èŠå¤©å¯¹è±¡ï¼‰ã€‚æ­¤è®¾ç½®ä¹Ÿå¯é˜»æ­¢æ­¤ç”¨æˆ·åœ¨è®ºå›å’Œç¾¤ç»„ç•™è¨€æ¿ä¸Šå‘å¸–ã€‚";
	...
	/// </summary>
	public override string LabelToolTipWhoCanChatInGame => "æ­¤è®¾ç½®å†³å®šæ­¤ç”¨æˆ·åœ¨æ¸¸æˆä¸­å¯ä»¥èŠå¤©çš„å¯¹è±¡ã€‚";
	...
	/// </summary>
	public override string LabelToolTipWhoCanFindMeByPhone => "æ­¤è®¾ç½®å†³å®šè°å¯ä»¥é€šè¿‡ä½ æä¾›çš„æ‰‹æœºå·ç æ‰¾åˆ°ä½ ã€‚";
	...
	/// </summary>
	public override string LabelToolTipWhoCanInviteVIP => "æ­¤è®¾ç½®å†³å®šè°å¯ä»¥åœ¨ VIP æœåŠ¡å™¨ä¸­åŠ å…¥æ­¤ç”¨æˆ· - VIP æœåŠ¡å™¨åªèƒ½é€šè¿‡æœåŠ¡å™¨ä¸»äººçš„é‚€è¯·æ‰èƒ½åŠ å…¥ã€‚";
	...
	/// </summary>
	public override string LabelToolTipWhoCanJoinGame => "æ­¤è®¾ç½®å†³å®šè°èƒ½çœ‹åˆ°æˆ‘åœ¨å“ªä¸ªæ¸¸æˆä¸­ï¼Œå¹¶åŠ å…¥æˆ‘çš„æœåŠ¡å™¨ã€‚é€‰æ‹©â€œæ²¡æœ‰äººâ€ï¼Œè¡¨ç¤ºæ²¡æœ‰äººå¯ä»¥è·Ÿéšæˆ‘è¿›å…¥æˆ‘çš„ç‰¹å®šæœåŠ¡å™¨ï¼Œä½†æˆ‘å¯ä»¥è·Ÿå…¶ä»–ç”¨æˆ·ä¸€èµ·çŽ©æ¸¸æˆã€‚";
	...
	/// </summary>
	public override string LabelToolTipWhoCanMessageMe => "æ­¤è®¾ç½®å†³å®šè°å¯ä»¥å‘æ­¤ç”¨æˆ·çš„ä¿¡æ¯æ”¶ä»¶ç®±å‘é€ä¿¡æ¯ã€‚";

	/// <summary>
	/// Key: "Label.ToolTip.WhoCanSeeInventory"
	/// English String: "This setting controls who can see your inventory."
	/// </summary>
	public override string LabelToolTipWhoCanSeeInventory => "è¿™é¡¹è®¾ç½®å†³å®šè°å¯ä»¥çœ‹åˆ°ä½ çš„é“å…·ã€‚";

	/// <summary>
	/// Key: "Label.TradeFilter"
	/// English String: "Trade quality filter"
	/// </summary>
	public override string LabelTradeFilter => "äº¤æ˜“å“è´¨è¿‡æ»¤å™¨";
	...
	/// </summary>
	public override string LabelTwitter => "Twitterï¼š";

	/// <summary>
	/// Key: "Label.TwoStepEmail"
	/// English String: "enable 2 Step Verification"
	/// </summary>
	public override string LabelTwoStepEmail => "å¯ç”¨ä¸¤æ­¥éªŒè¯";

	/// <summary>
	/// Key: "Label.TwoStepPrerequisite"
	/// English String: "A verified email is required."
	/// </summary>
	public override string LabelTwoStepPrerequisite => "éœ€è¦å·²éªŒè¯çš„ç”µå­é‚®ä»¶ã€‚";
	...
	/// </summary>
	public override string LabelTwoStepVerification => "æé«˜ä½ çš„å¸æˆ·å®‰å…¨æ€§ã€‚å½“ä½ ä»Žæ–°è®¾å¤‡ç™»å½•æ—¶ï¼Œéœ€è¦è¾“å…¥éªŒè¯ç ã€‚";

	/// <summary>
	/// Key: "Label.TwoStepVerificationEnabled"
	/// English String: "Your account is protected!"
	/// </summary>
	public override string LabelTwoStepVerificationEnabled => "ä½ çš„å¸æˆ·å·²å—åˆ°ä¿æŠ¤ï¼";

	/// <summary>
	/// Key: "Label.UpdateEmail"
	/// English String: "Update Email"
	/// </summary>
	public override string LabelUpdateEmail => "æ›´æ–°ç”µå­é‚®ä»¶";

	/// <summary>
	/// Key: "Label.UpdatePhone"
	/// English String: "Update Phone"
	/// </summary>
	public override string LabelUpdatePhone => "æ›´æ–°æ‰‹æœº";
	...
	/// </summary>
	public override string LabelUseDeviceLanguage => "ä½¿ç”¨è®¾å¤‡è¯­è¨€";

	/// <summary>
	/// Key: "Label.Username"
	/// English String: "Username:"
	/// </summary>
	public override string LabelUsername => "ç”¨æˆ·åï¼š";

	/// <summary>
	/// Key: "Label.Verified"
	/// English String: "Verified"
	/// </summary>
	public override string LabelVerified => "å·²éªŒè¯";
	...
	/// </summary>
	public override string LabelWhoCanChatInApp => "è°å¯ä»¥åœ¨ App ä¸­ä¸Žæˆ‘èŠå¤©ï¼Ÿ";

	/// <summary>
	/// Key: "Label.WhoCanChatInGame"
	/// English String: "Who can chat with me?"
	/// </summary>
	public override string LabelWhoCanChatInGame => "è°å¯ä»¥ä¸Žæˆ‘èŠå¤©ï¼Ÿ";
	...
	/// </summary>
	public override string LabelWhoCanInviteVIP => "è°å¯ä»¥é‚€è¯·æˆ‘åŠ å…¥ VIP æœåŠ¡å™¨ï¼Ÿ";

	/// <summary>
	/// Key: "Label.WhoCanJoinGame"
	/// English String: "Who can join me?"
	/// </summary>
	public override string LabelWhoCanJoinGame => "è°å¯ä»¥åŠ å…¥æˆ‘ï¼Ÿ";

	/// <summary>
	/// Key: "Label.WhoCanMessageMe"
	/// English String: "Who can message me?"
	/// </summary>
	public override string LabelWhoCanMessageMe => "è°å¯ä»¥å‘æˆ‘å‘é€æ¶ˆæ¯ï¼Ÿ";
	...
	/// </summary>
	public override string MessageInsufficientRobuxErrorForUserName => "ä½ çš„ Robux ä½™é¢ä¸è¶³ï¼Œæ— æ³•æ›´æ”¹ç”¨æˆ·åã€‚";

	/// <summary>
	/// Key: "MessageInvalidEmail"
	/// English String: "Invalid Email"
	/// </summary>
	public override string MessageInvalidEmail => "ç”µå­é‚®ä»¶æ— æ•ˆ";

	/// <summary>
	/// Key: "MessageNoEmailAssociatedError"
	/// English String: "You must associate an email address with your account"
	/// </summary>
	public override string MessageNoEmailAssociatedError => "ä½ å¿…é¡»å°†ç”µå­é‚®ä»¶åœ°å€ä¸Žä½ çš„å¸æˆ·ç›¸å…³è”";

	/// <summary>
	/// Key: "MessagePermissionError"
	/// English String: "You don't have enough Robux to change your username."
	/// </summary>
	public override string MessagePermissionError => "ä½ çš„ Robux ä¸è¶³ï¼Œæ— æ³•æ›´æ”¹ç”¨æˆ·åã€‚";

	/// <summary>
	/// Key: "MessagePinLockedError"
	/// English String: "PIN is locked."
	/// </summary>
	public override string MessagePinLockedError => "PIN å·²é”å®šã€‚";

	/// <summary>
	/// Key: "MessageSameEmailError"
	/// English String: "This is already the current verified email."
	/// </summary>
	public override string MessageSameEmailError => "è¿™å·²ç»æ˜¯å½“å‰å·²éªŒè¯çš„ç”µå­é‚®ä»¶ã€‚";

	/// <summary>
	/// Key: "MessageSettingsUpdateSuccess"
	/// English String: "Your settings have been updated."
	/// </summary>
	public override string MessageSettingsUpdateSuccess => "ä½ çš„è®¾ç½®å·²æ›´æ–°ã€‚";

	/// <summary>
	/// Key: "MessageTooManyAccountsOnEmailError"
	/// English String: "There are too many accounts associated with this email address."
	/// </summary>
	public override string MessageTooManyAccountsOnEmailError => "æ­¤ç”µå­é‚®ä»¶åœ°å€çš„å…³è”å¸æˆ·è¿‡å¤šã€‚";

	/// <summary>
	/// Key: "MessageTooManyAttemptsError"
	/// English String: "Too many attempts. Please try again later."
	/// </summary>
	public override string MessageTooManyAttemptsError => "å°è¯•æ¬¡æ•°è¿‡å¤šã€‚è¯·ç¨åŽé‡è¯•ã€‚";

	/// <summary>
	/// Key: "MessageUnknownError"
	/// English String: "An unknown error occurred."
	/// </summary>
	public override string MessageUnknownError => "å‘ç”ŸæœªçŸ¥é”™è¯¯ã€‚";

	/// <summary>
	/// Key: "MessageWrongPassword"
	/// English String: "Your password is incorrect."
	/// </summary>
	public override string MessageWrongPassword => "ä½ çš„å¯†ç ä¸æ­£ç¡®ã€‚";
	...
	/// </summary>
	public override string ResponesInvalidCodePhone => "éªŒè¯ç æ— æ•ˆã€‚è¯·æŸ¥çœ‹ä½ çš„æ‰‹æœºå¹¶é‡è¯•ã€‚";
	...
	/// </summary>
	public override string ResponesInventoryAndTradePrivacyConflictError => "â€œè°å¯ä»¥ä¸Žæˆ‘äº¤æ˜“â€œçš„è®¾ç½®åº”ä¸Žâ€è°å¯ä»¥çœ‹åˆ°æˆ‘çš„é“å…·â€œç›¸ç¬¦ï¼Œæˆ–æ¯”åŽè€…æ›´ä¸¥æ ¼ã€‚";
	...
	/// </summary>
	public override string ResponseCodeRequired => "éœ€è¦éªŒè¯ç ã€‚è¯·è¾“å…¥ä½ çš„éªŒè¯ç ã€‚";
	...
	/// </summary>
	public override string ResponseDialogBirthdayChangeDefaultWarning => "å°†ä½ çš„ç”Ÿæ—¥æ›´æ”¹ä¸º 13 å²ä»¥ä¸‹åˆ™æ— æ³•è¿˜åŽŸã€‚æ˜¯å¦ç¡®å®šè¦ç»§ç»­ï¼Ÿ";
	...
	/// </summary>
	public override string ResponseDialogBirthdayChangePasswordBody => "è‹¥è¦æ›´æ”¹ç”Ÿæ—¥ï¼Œä½ å¿…é¡»å…ˆä¸ºä½ çš„ Roblox å¸æˆ·æ·»åŠ å¯†ç ã€‚";

	/// <summary>
	/// Key: "Response.Dialog.BirthdayChangePasswordTitle"
	/// English String: "Must Add Password"
	/// </summary>
	public override string ResponseDialogBirthdayChangePasswordTitle => "å¿…é¡»æ·»åŠ å¯†ç ";
	...
	/// </summary>
	public override string ResponseDialogBirthdayChangeSocialWarning => "å°†ä½ çš„ç”Ÿæ—¥æ›´æ”¹ä¸º 13 å²ä»¥ä¸‹åˆ™æ— æ³•è¿˜åŽŸã€‚ä½ çš„ Facebook ç¤¾äº¤ç™»å½•å°†è¢«åœç”¨ï¼Œä½ ä¹Ÿå°†å¿…é¡»ä½¿ç”¨ Roblox å¯†ç ç™»å½•ã€‚";
	...
	/// </summary>
	public override string ResponseDialogChangePasswordIncorrectPassword => "ä½ å½“å‰çš„å¯†ç ä¸æ­£ç¡®ï¼Œå¯†ç æœªæ›´æ”¹ã€‚";

	/// <summary>
	/// Key: "Response.Dialog.ChangePasswordNoMatch"
	/// English String: "Passwords do not match"
	/// </summary>
	public override string ResponseDialogChangePasswordNoMatch => "å¯†ç ä¸ç¬¦";

	/// <summary>
	/// Key: "Response.Dialog.ChangePasswordTooShortError"
	/// English String: "Must be at least 8 characters long"
	/// </summary>
	public override string ResponseDialogChangePasswordTooShortError => "å¿…é¡»è‡³å°‘ä¸º 8 ä¸ªå­—ç¬¦";

	/// <summary>
	/// Key: "Response.Dialog.ChangeUsernameNoInput"
	/// English String: "Please enter a username."
	/// </summary>
	public override string ResponseDialogChangeUsernameNoInput => "è¯·è¾“å…¥ç”¨æˆ·åã€‚";
	...
	/// </summary>
	public override string ResponseDialogChangeUsernameNotAllowed => "ç”¨æˆ·åä¸é€‚ç”¨äºŽ Robloxã€‚";

	/// <summary>
	/// Key: "Response.Dialog.ChangeUsernameNotAvailable"
	/// English String: "This username is already in use."
	/// </summary>
	public override string ResponseDialogChangeUsernameNotAvailable => "æ­¤ç”¨æˆ·åå·²è¢«ä½¿ç”¨ã€‚";
	...
	/// </summary>
	public override string ResponseDialogChangeUsernameSuccess => "å·²æˆåŠŸæ›´æ”¹ç”¨æˆ·åã€‚";

	/// <summary>
	/// Key: "Response.Dialog.CountryListError"
	/// English String: "Error loading country list"
	/// </summary>
	public override string ResponseDialogCountryListError => "åŠ è½½å›½å®¶åˆ—è¡¨æ—¶å‡ºé”™";

	/// <summary>
	/// Key: "Response.Dialog.CurrencyServiceError"
	/// English String: "There was an error with the currency service. Try again later."
	/// </summary>
	public override string ResponseDialogCurrencyServiceError => "è¿è¡Œè´§å¸æœåŠ¡æ—¶å‘ç”Ÿé”™è¯¯ã€‚è¯·ç¨åŽé‡è¯•ã€‚";

	/// <summary>
	/// Key: "Response.Dialog.DefaultErrorMessage"
	/// English String: "Something went wrong, please try again later."
	/// </summary>
	public override string ResponseDialogDefaultErrorMessage => "å‘ç”Ÿé”™è¯¯ï¼Œè¯·ç¨åŽé‡è¯•ã€‚";

	/// <summary>
	/// Key: "Response.Dialog.DefaultErrorTitle"
	/// English String: "Error occured"
	/// </summary>
	public override string ResponseDialogDefaultErrorTitle => "å‘ç”Ÿé”™è¯¯";

	/// <summary>
	/// Key: "Response.Dialog.DefaultSuccessMessage"
	/// English String: "Saved Successfully!"
	/// </summary>
	public override string ResponseDialogDefaultSuccessMessage => "ä¿å­˜æˆåŠŸï¼";
	...
	/// </summary>
	public override string ResponseDialogDisconnectXBoxError => "æ–­å¼€ä½ çš„ Xbox å¸æˆ·è¿žæŽ¥æ—¶å‘ç”Ÿé”™è¯¯ï¼Œè¯·ç¨åŽé‡è¯•ã€‚";

	/// <summary>
	/// Key: "Response.Dialog.EmailSentForVerification"
	/// English String: "An email has been sent for verification."
	/// </summary>
	public override string ResponseDialogEmailSentForVerification => "å·²å‘é€éªŒè¯ç”µå­é‚®ä»¶ã€‚";

	/// <summary>
	/// Key: "Response.Dialog.InvalidEmailAddress"
	/// English String: "Invalid Email Address"
	/// </summary>
	public override string ResponseDialogInvalidEmailAddress => "ç”µå­é‚®ä»¶åœ°å€æ— æ•ˆ";

	/// <summary>
	/// Key: "Response.Dialog.InvalidPhoneNumber"
	/// English String: "Invalid phone number"
	/// </summary>
	public override string ResponseDialogInvalidPhoneNumber => "æ‰‹æœºå·ç æ— æ•ˆ";
	...
	/// </summary>
	public override string ResponseDialogInvalidUsername => "æŒ‰â€œå‘é€â€æäº¤ç¥¨å•ï¼Œæˆ–æŒ‰â€å–æ¶ˆâ€ä»¥ç¼–è¾‘ç”¨æˆ·åã€‚ç”¨æˆ·åæ˜¯éžå¸¸é‡è¦çš„ä¿¡æ¯ï¼Œæœ‰åŠ©äºŽåŠ å¿«è§£å†³ä½ çš„é—®é¢˜ã€‚";
	...
	/// </summary>
	public override string ResponseDialogPasswordRulesError => "å¯†ç é¡»è‡³å°‘åŒ…å« 2 ä¸ªæ•°å­—ã€4 ä¸ªå­—æ¯ã€1 ä¸ªç¬¦å·ï¼Œä¸”è‡³å°‘ä¸º 8 ä¸ªå­—ç¬¦ã€‚";
	...
	/// </summary>
	public override string ResponseDialogPinCreateConfirmation => "ä½ çš„ PIN çŽ°å·²è®¾ç½®å¥½ã€‚ä½ å°†éœ€è¦å…ˆè¾“å…¥æ­¤ PINï¼Œæ‰èƒ½è®¿é—®è®¾ç½®é¡µé¢ã€‚";

	/// <summary>
	/// Key: "Response.Dialog.PinCreateMismatch"
	/// English String: "PINs do not match"
	/// </summary>
	public override string ResponseDialogPinCreateMismatch => "PIN ä¸åŒ¹é…";
	...
	/// </summary>
	public override string ResponseDialogSignoutSessionFailed => "æ³¨é”€æ‰€æœ‰å…¶ä»–ä¼šè¯æ—¶å‘ç”Ÿé”™è¯¯ï¼Œè¯·ç¨åŽé‡è¯•ã€‚";

	/// <summary>
	/// Key: "Response.Dialog.SignoutSessionsConfirmation"
	/// English String: "You have been signed out of all other sessions."
	/// </summary>
	public override string ResponseDialogSignoutSessionsConfirmation => "ä½ å·²æ³¨é”€æ‰€æœ‰å…¶ä»–ä¼šè¯ã€‚";
	...
	/// </summary>
	public override string ResponseDialogTwoStepDisableWarning => "å¦‚æžœå…³é—­ä¸¤æ­¥éªŒè¯ï¼Œé‚£ä¹ˆä¸‹æ¬¡å½“ä½ ä»Žæ–°è®¾å¤‡ç™»å½•æ—¶ï¼Œä½ å°†åªéœ€è¦è¾“å…¥å¯†ç ã€‚æ˜¯å¦ç¡®å®šï¼Ÿ";

	/// <summary>
	/// Key: "Response.Dialog.TwoStepSuccessTitle"
	/// English String: "2 Step Verification Enabled"
	/// </summary>
	public override string ResponseDialogTwoStepSuccessTitle => "ä¸¤æ­¥éªŒè¯å·²å¯ç”¨";
	...
	/// </summary>
	public override string ResponseDialogTwoStepSucessBody => "ä½ çš„å¸æˆ·çŽ°å·²å—åˆ°ä¿æŠ¤ï¼Œç›®å‰æ— éœ€ä»»ä½•ä¸‹ä¸€æ­¥çš„æ“ä½œã€‚ä¸‹æ¬¡å½“ä½ ä»Žæ–°è®¾å¤‡ç™»å½•æ—¶ï¼Œç³»ç»Ÿå°†ä¼šå‘é€ä¸€ä¸ªå®‰å…¨ç ã€‚";
	...
	/// </summary>
	public override string ResponseDialogUpdateInventorySetting => "æˆ‘ä»¬å·²æ›´æ–°äº†ä½ çš„é“å…·éšç§è®¾ç½®ã€‚é“å…·ä¸Žäº¤æ˜“çš„è®¾ç½®é¡»ä¿æŒä¸€è‡´ã€‚";
	...
	/// </summary>
	public override string ResponseDialogUpdateNotificationSettingsError => "æ›´æ–°ä½ çš„é€šçŸ¥è®¾ç½®æ—¶å‘ç”Ÿé”™è¯¯ï¼Œè¯·ç¨åŽé‡è¯•ã€‚";
	...
	/// </summary>
	public override string ResponseDialogUpdateTradeSetting => "æˆ‘ä»¬å·²æ›´æ–°äº†ä½ çš„é“å…·éšç§è®¾ç½®ã€‚é“å…·ä¸Žäº¤æ˜“çš„è®¾ç½®é¡»ä¿æŒä¸€è‡´ã€‚";

	/// <summary>
	/// Key: "Response.Dialog.VerifyPhoneInvalidCode"
	/// English String: "Code is invalid. Please check your phone and try again."
	/// </summary>
	public override string ResponseDialogVerifyPhoneInvalidCode => "éªŒè¯ç æ— æ•ˆã€‚è¯·æŸ¥çœ‹ä½ çš„æ‰‹æœºå¹¶é‡è¯•ã€‚";
	...
	/// English String: "This feature is currently disabled. Please try again later."
	/// </summary>
	public override string ResponseFeatureDisabled => "æ­¤åŠŸèƒ½å½“å‰å·²åœç”¨ã€‚è¯·ç¨åŽé‡è¯•ã€‚";
	...
	/// </summary>
	public override string ResponseGeneralError => "å‘ç”Ÿé”™è¯¯ã€‚è¯·é‡è¯•ã€‚";
	...
	/// </summary>
	public override string ResponseIncorrectCodeTooManyTimes => "ä½ è¾“å…¥é”™è¯¯éªŒè¯ç çš„æ¬¡æ•°è¿‡å¤šã€‚";
	...
	/// </summary>
	public override string ResponseIncorrectPasswordTryAgain => "å¯†ç ä¸æ­£ç¡®ã€‚è¯·æ£€æŸ¥ä½ çš„å¯†ç å¹¶é‡è¯•ã€‚";
	...
	/// </summary>
	public override string ResponseInvalidPhoneTryAgain => "æ‰‹æœºå·ç æ ¼å¼æ— æ•ˆã€‚è¯·æ£€æŸ¥å¹¶é‡è¯•ã€‚";

	/// <summary>
	/// Key: "Response.NotificationBar.PhoneRemovedConfirmation"
	/// English String: "Phone has been removed"
	/// </summary>
	public override string ResponseNotificationBarPhoneRemovedConfirmation => "æ‰‹æœºå·²ç§»é™¤";

	/// <summary>
	/// Key: "Response.NotificationBar.PhoneVerifyConfirmation"
	/// English String: "Phone has been successfully updated!"
	/// </summary>
	public override string ResponseNotificationBarPhoneVerifyConfirmation => "æ‰‹æœºå·²æ›´æ–°æˆåŠŸï¼";
	...
	/// </summary>
	public override string ResponseNumberAlreadyAssociated => "æ­¤å·ç å·²ä¸Žå¦ä¸€å¸æˆ·ç›¸å…³è”ã€‚";
	...
	/// </summary>
	public override string ResponsePinRequired => "è¯·è¾“å…¥ä½ çš„ PIN ä»¥æ›´æ”¹è®¾ç½®ã€‚";

	/// <summary>
	/// Key: "Response.SocialMedia.ValidationError"
	/// English String: "The social network link is not valid."
	/// </summary>
	public override string ResponseSocialMediaValidationError => "ç¤¾äº¤ç½‘ç»œé“¾æŽ¥æ— æ•ˆã€‚";
	...
	/// </summary>
	public override string ResponseAgeDownError => "æŠ±æ­‰ï¼Œä½ æ— æ³•å°†ä½ çš„å¹´é¾„æ”¹ä¸º 13 å²ä»¥ä¸‹ã€‚å¦‚æžœä½ æœªæ»¡ 13 å²ï¼Œè¯·åˆ›å»ºä¸€ä¸ªæ–°å¸æˆ·ï¼Œè”ç³»æŠ€æœ¯æ”¯æŒä»¥åˆ é™¤ä½ çš„æ—§å¸æˆ·ã€‚";
	...
	{
		return "ä½ å¯ä»¥è®¾ç½®å¸æˆ·é™åˆ¶ï¼Œé™åˆ¶å¯¹å¸æˆ·è®¾ç½®åŠæœªç­›é€‰å†…å®¹çš„è®¿é—®æƒé™";
	}
	...
	{
		return $"{escapeLiteralStart}é‡ç½® Roblox ç”µå­é‚®ä»¶{escapeLiteralEnd}{fromEmailAddress}";
	}
	...
	{
		return $"äº²çˆ±çš„ Roblox ç”¨æˆ·ï¼Œ{lineBreak}{lineBreak}æˆ‘ä»¬æ³¨æ„åˆ°ä½ å·²å°† {username} å¸æˆ·çš„ç”µå­é‚®ä»¶åœ°å€ä»Ž {oldEmailAddress} æ›´æ”¹ä¸º {newEmailAddress}ã€‚å¦‚æžœä½ ä¸æƒ³çœŸçš„æ›´æ”¹ï¼Œæˆ–è€…ä½ è®¤ä¸ºåˆ«äººå¯èƒ½ä¸å°å¿ƒä½œå‡ºäº†æ­¤æ›´æ”¹ï¼Œé‚£ä¹ˆæˆ‘ä»¬éœ€è¦ä½ ç‚¹æŒ‰æ­¤é“¾æŽ¥{lineBreak}{aTagWithHref}{revertAccountEmailLinkWithTicket}{hrefEnd}{revertAccountEmailLink}{aTagEnd}{lineBreak}ä»¥å°†ç”µå­é‚®ä»¶æ”¹å›žåŽŸåœ°å€ã€‚ä½ è¿˜å°†éœ€è¦è¾“å…¥ä¸€ä¸ªæ–°å¯†ç ã€‚è¿™æ ·ï¼Œæˆ‘ä»¬æ‰èƒ½ç¡®è®¤ä½ å¸æˆ·çš„å®‰å…¨æ€§ã€‚{lineBreak}{lineBreak}å¦‚æžœä½ æ›´å€¾å‘äºŽåœ¨ Roblox ä¸Šä½¿ç”¨æ–°çš„ç”µå­é‚®ä»¶åœ°å€ï¼Œæ— éœ€ä»»ä½•æ­¥éª¤ï¼Œå¸æˆ·å·²ä¸ºä½ è®¾ç½®å¥½ã€‚{lineBreak}{lineBreak}è¯·ä¸è¦å›žå¤æ­¤ä¿¡æ¯ã€‚å¦‚æžœä½ æœ‰ä»»ä½•é—®é¢˜ï¼Œè¯·å‘é€ç”µå­é‚®ä»¶è‡³ {robloxInfoEmailAddress}ã€‚";
	}
	...
	{
		return $"äº²çˆ±çš„ Roblox ç”¨æˆ·ï¼Œ{lineBreak}{lineBreak}æˆ‘ä»¬æ³¨æ„åˆ°ä½ å·²å°† {username} å¸æˆ·çš„ç”µå­é‚®ä»¶åœ°å€ä»Ž {oldEmailAddress} æ›´æ”¹ä¸º {newEmailAddress}ã€‚å¦‚æžœä½ ä¸æƒ³çœŸçš„æ›´æ”¹ï¼Œæˆ–è€…ä½ è®¤ä¸ºåˆ«äººå¯èƒ½ä¸å°å¿ƒä½œå‡ºäº†æ­¤æ›´æ”¹ï¼Œé‚£ä¹ˆæˆ‘ä»¬éœ€è¦ä½ ç‚¹æŒ‰æ­¤é“¾æŽ¥{lineBreak}{revertAccountEmailLink}{lineBreak}ä»¥å°†ç”µå­é‚®ä»¶æ”¹å›žåŽŸåœ°å€ã€‚ä½ è¿˜å°†éœ€è¦è¾“å…¥ä¸€ä¸ªæ–°å¯†ç ã€‚è¿™æ ·ï¼Œæˆ‘ä»¬æ‰èƒ½ç¡®è®¤ä½ å¸æˆ·çš„å®‰å…¨æ€§ã€‚{lineBreak}{lineBreak}å¦‚æžœä½ æ›´å€¾å‘äºŽåœ¨ Roblox ä¸Šä½¿ç”¨æ–°çš„ç”µå­é‚®ä»¶åœ°å€ï¼Œæ— éœ€ä»»ä½•æ­¥éª¤ï¼Œå¸æˆ·å·²è®¾ç½®å¥½ã€‚{lineBreak}è¯·ä¸è¦å›žå¤æ­¤ä¿¡æ¯ã€‚å¦‚æžœä½ æœ‰ä»»ä½•é—®é¢˜ï¼Œè¯·å‘é€ç”µå­é‚®ä»¶è‡³ {robloxInfoEmailAddress}ã€‚";
	}
	...
	{
		return $"æ­¤å¸æˆ·åªèƒ½è®¿é—®æˆ‘ä»¬å¹³å°ä¸Šçš„å·²ç­›é€‰å†…å®¹ã€‚æ­¤å¤–ï¼Œâ€œè”ç³»äººè®¾ç½®â€éƒ¨åˆ†ï¼ˆä½äºŽ{linkStart}éšç§{linkEnd}é¡µé¢ä¸Šæ–¹ï¼‰å°†è¢«è®¾ä¸ºâ€œå…³é—­â€ã€‚";
	}
	...
	{
		return $"ä½ å·²å±è”½ {totalBlockedCount} åç”¨æˆ·ï¼ˆæœ€å¤š {maxBlockedCount} åï¼‰ï¼š";
	}
	...
	{
		return $"ç”±äºŽå¯ç”¨å¸æˆ·é™åˆ¶ï¼ˆä½äºŽ{linkStart}å®‰å…¨æ€§{linkEnd}é¡µé¢ä¸‹æ–¹ï¼‰ï¼Œâ€œè”ç³»äººè®¾ç½®â€éƒ¨åˆ†å·²é”å®š";
	}
	...
	{
		return $"ä»¥ {robuxIcon} {price} çš„ä»·æ ¼æ›´æ”¹ç”¨æˆ·åï¼Ÿ";
	}
	...
	{
		return $"ä½ è¿˜éœ€è¦ {robuxToBuy} æ‰èƒ½æ›´æ”¹ç”¨æˆ·åã€‚æ˜¯å¦è¦è´­ä¹°æ›´å¤š Robuxï¼Ÿ";
	}
	...
	{
		return "ä½ å¿…é¡»å…ˆæä¾›å¹¶éªŒè¯ç”µå­é‚®ä»¶ï¼Œæ‰èƒ½æ·»åŠ å¸æˆ· PINã€‚";
	}

	protected override string _GetTemplateForDescriptionDialogMissingEmailTwoStepVerification()
	{
		return "ä½ å¿…é¡»å…ˆæä¾›å¹¶éªŒè¯ç”µå­é‚®ä»¶ï¼Œæ‰èƒ½å¯ç”¨ä¸¤æ­¥éªŒè¯ã€‚";
	}
	...
	{
		return "è¯·è¾“å…¥ä¸Žä½ çš„å¸æˆ·ç›¸å…³è”çš„ PIN";
	}
	...
	{
		return $"æ˜¯å¦ç¡®å®šç§»é™¤ä½ å°¾å·ä¸º {phoneLast4} çš„æ‰‹æœºå·ç ï¼Ÿ";
	}
	...
	{
		return "ä½ å¿…é¡»å…ˆéªŒè¯ç”µå­é‚®ä»¶ï¼Œæ‰èƒ½æ·»åŠ å¸æˆ· PIN ç ã€‚";
	}

	protected override string _GetTemplateForDescriptionDialogUnverifiedEmailTwoStepVerification()
	{
		return "ä½ å¿…é¡»å…ˆéªŒè¯ç”µå­é‚®ä»¶ï¼Œæ‰èƒ½å¯ç”¨ä¸¤æ­¥éªŒè¯ã€‚";
	}
	...
	{
		return "ç”±äºŽä½ æŒç»­æäº¤äº†ä¼˜è´¨çš„æ»¥ç”¨è¡Œä¸ºæŠ¥å‘Šï¼Œä½ å·²è¢«åŠ è‡³å¿«é€Ÿè¿½è¸ªæŠ¥å‘Šè®¡åˆ’ã€‚ä½ æäº¤çš„æ»¥ç”¨è¡Œä¸ºæŠ¥å‘Šå°†ä¼šæ›´å¿«åœ°å¾—åˆ°å®¡æ ¸ã€‚ç»§ç»­æäº¤ä¼˜è´¨çš„æ»¥ç”¨è¡Œä¸ºæŠ¥å‘Šï¼Œä½ å³å¯ç»§ç»­ç•™åœ¨æœ¬è®¡åˆ’ã€‚æ„Ÿè°¢ä½ å¸®åŠ© Roblox ç»´æŠ¤ä¼˜è´¨çŽ¯å¢ƒï¼";
	}
	...
	{
		return "è¯·å‹¿æä¾›ä»»ä½•èƒ½åœ¨ Roblox ä»¥å¤–ç”¨äºŽè¯†åˆ«ä¸ªäººèº«ä»½çš„è¯¦ç»†ä¿¡æ¯ã€‚";
	}

	protected override string _GetTemplateForDescriptionHelpTextFastTrackAccuracy()
	{
		return "å‡†ç¡®æ€§ä»£è¡¨çš„æ˜¯å®¡æ ¸å›¢é˜Ÿæ‰¹å‡†æ»¥ç”¨æŠ¥å‘Šçš„é¢‘çŽ‡ã€‚åœ¨ä½ æäº¤ä¸€å®šæ•°é‡çš„æŠ¥å‘ŠåŽå°†ä¼šæ˜¾ç¤ºè¯¥é¡¹æ•°æ®ã€‚â€œæ‰€æœ‰äººâ€åˆ™æ˜¯ä»£è¡¨æ‰€æœ‰å¿«é€Ÿè¿½è¸ªè®¡åˆ’çš„æˆå‘˜ã€‚";
	}

	protected override string _GetTemplateForDescriptionHelpTextPrivacyMode()
	{
		return "å°†å¹´é¾„æ›´æ–°ä¸º 13 å²ä»¥ä¸‹ä¼šå¯ç”¨éšç§æ¨¡å¼ã€‚";
	}
	...
	{
		return $"å½“ä½ ä»Žæ–°è®¾å¤‡ç™»å½•æ—¶ï¼ŒéªŒè¯ç ä¼šå‘é€è‡³ {email}";
	}
	...
	{
		return $"ä½ å¥½ Roblox ç”¨æˆ·ï¼Œ{lineBreaks}ä½ çš„ç”¨æˆ·åæœ€è¿‘ä»Žâ€œ{oldUsername}â€æ›´æ”¹ä¸ºâ€œ{newUsername}â€ã€‚å¦‚æžœä½ æœªç”³è¯·æ›´æ”¹ç”¨æˆ·åï¼Œè¯·å‘é€ç”µå­é‚®ä»¶è‡³ {robloxInfoEmailAddress}ã€‚";
	}
	...
	{
		return $"{escapeLiteralStart}Roblox ç”¨æˆ·åæ›´æ”¹{escapeLiteralEnd} {fromEmailAddress}";
	}
	...
	{
		return $"{escapeLiteratStart}Roblox ç”µå­é‚®ä»¶éªŒè¯{escapeLiteralEnd} {fromEmailAddress}";
	}
	...
	{
		return $"{escapeLiteratStart}Roblox å¸æˆ·æŽˆæƒ{escapeLiteralEnd} {fromEmailAddress}";
	}
	...
	{
		return $"äº²çˆ±çš„ Roblox ç”¨æˆ·ï¼Œ{lineBreak}{lineBreak}å¾ˆé«˜å…´ä½ é€‰æ‹©æä¾›ç”µå­é‚®ä»¶åœ°å€ä»¥ä¿æŠ¤ä½ çš„å¸æˆ·â€œ{username}â€ã€‚{lineBreak}é€šè¿‡éªŒè¯ä½  Roblox å¸æˆ·çš„å…³è”ç”µå­é‚®ä»¶åœ°å€ï¼Œä½ å°†å¾—åˆ°æ›´é«˜çº§åˆ«çš„å¸æˆ·å®‰å…¨ä¿éšœã€‚{lineBreak}è¯·ç‚¹æŒ‰ä¸‹é¢çš„æŒ‰é’®ä»¥å®ŒæˆéªŒè¯ã€‚{lineBreak}{lineBreak}{aTagStartWithHref}{verificationLink}{targetBlank}{buttonStart}éªŒè¯ç”µå­é‚®ä»¶{buttonEnd}{aTagEnd}";
	}
	...
	{
		return $"æ‚¨å¥½ï¼Œ{lineBreak}{lineBreak}æ‚¨çš„å­©å­å·²åœ¨ Roblox ä¸Šåˆ›å»ºè´¦æˆ·ï¼Œç”¨æˆ·åä¸º {boldTagStart}{username}{boldTagEnd}ã€‚Roblox æ˜¯ä¸€ä¸ªç½‘ç»œå¨±ä¹å¹³å°ï¼Œè®©å­©å­ä»¬å¯ä»¥åœ¨æˆ‘ä»¬ä¼—å¤šèº«ä¸´å…¶å¢ƒçš„ 3D ä¸–ç•Œä¸­ä¸€èµ·å‘æŒ¥æƒ³è±¡åŠ›ï¼Œäº«å—æ¸¸æˆå¸¦æ¥çš„ä¹è¶£ã€‚ä»–ä»¬ä¹Ÿå¯ä»¥ä½¿ç”¨æˆ‘ä»¬å¼€å‘çš„å…è´¹å·¥å…· Roblox Studioã€‚æ— è®ºæ˜¯åˆ›ä½œç®€å•çš„æ¨¡å—ï¼Œè¿˜æ˜¯è¿›é˜¶åˆ°è®¾è®¡å¤æ‚çš„å¤šäººæ¸¸æˆï¼Œä»–ä»¬éƒ½èƒ½åœ¨è¿™é‡Œå°½æƒ…æŒ¥æ´’åˆ›æ„ã€‚æ— è®ºæ˜¯è®¾è®¡ç‹¬ä¸€æ— äºŒçš„ä¸»é¢˜ä¹å›­ï¼Œä»¥èŒä¸šèµ›è½¦æ‰‹çš„èº«ä»½ç«žæŠ€ï¼Œæˆä¸º T å°ä¸Šé—ªäº®çš„æ˜Žæ˜Ÿï¼Œè¿˜æ˜¯é‚€è¯·æœ‹å‹åˆ°è‡ªå·±çš„æ¢¦å¹»å®¶å›­åšå®¢ï¼Œç›®å‰ï¼Œå·²ç»æœ‰æ•°ç™¾ä¸‡å„¿ç«¥é€šè¿‡ Roblox å®žçŽ°äº†ä»–ä»¬çš„åˆ›æ„ã€‚{lineBreak}{lineBreak}æˆ‘ä»¬æƒ³è®©æ‚¨çŸ¥é“ï¼Œæ‚¨çš„å­©å­å·²å‘æˆ‘ä»¬æä¾›äº†ç”¨æˆ·åã€ç”Ÿæ—¥å’Œå®¶é•¿çš„ç”µå­é‚®ä»¶åœ°å€ã€‚å®¶é•¿ç”µå­é‚®ä»¶å°†ä»…ç”¨äºŽå¸æˆ·ç®¡ç†ã€å¯†ç é‡ç½®ä»¥åŠé€šçŸ¥å¸æˆ·ä½¿ç”¨æƒé™æ›´æ”¹ç­‰ç”¨é€”ã€‚è¯·ç‚¹æŒ‰æ­¤æŒ‰é’®éªŒè¯æ‚¨çš„ç”µå­é‚®ä»¶åœ°å€ï¼š{lineBreak}{lineBreak}{aTagStartWithHref}{verificationLink}{hrefEnd}{buttonStart}éªŒè¯ç”µå­é‚®ä»¶åœ°å€{buttonEnd}{aTagEnd}{lineBreak}{lineBreak}{boldTagStart}å…³äºŽ Roblox{boldTagEnd}{lineBreak}{lineBreak}Roblox è‡´åŠ›æ‰“é€ ä¸€ä¸ªé€‚åˆå…¨å®¶è€å°‘çš„æ„‰å¿«çŽ¯å¢ƒã€‚æˆ‘ä»¬å’Œæ•°ç å®‰å…¨ä¸“å®¶ååŠ›ï¼Œä¸æ–­åœ°å¢žå¼ºæˆ‘ä»¬çš„å®‰å…¨æŽªæ–½ï¼Œç¡®ä¿æ‰€æœ‰çŽ©å®¶éƒ½èƒ½å®‰å¿ƒåœ°ä¸€èµ·æ¸¸æˆã€èŠå¤©ã€åˆä½œã€‚æˆ‘ä»¬å»ºè®®æ‚¨è®¿é—®ä»¥ä¸‹çš„ã€Šå®¶é•¿æŒ‡å—ã€‹ï¼Œè®©æ‚¨èƒ½å¤Ÿæ›´åŠ ç†Ÿæ‚‰æˆ‘ä»¬çš„å¹³å°ï¼Œå¹¶äº†è§£å¦‚ä½•è®©æ‚¨çš„å­©å­åœ¨ Roblox ä¸ŠèŽ·å¾—æ›´å¥½çš„ä½“éªŒï¼š{aTagStartWithHref}{parentalPageLink}{hrefEnd}{parentalPageLink}{aTagEnd}{lineBreak}{lineBreak}Roblox è¿˜æä¾›{boldTagStart}å®¶é•¿æŽ§åˆ¶åŠŸèƒ½{boldTagEnd}ã€‚å®¶é•¿å¯ä»¥å¯ç”¨å®¶é•¿ PINï¼Œæ›´æ”¹å­©å­çš„é€šä¿¡å’ŒèŠå¤©è®¾å®šã€‚è‹¥è¦æ‰¾åˆ°è¿™äº›æŽ§åˆ¶ç©ºèƒ½ï¼Œæ‚¨å¯ä»¥ç™»å½•å­©å­çš„å¸æˆ·ï¼Œè®¿é—®å¸æˆ·è®¾ç½®ä¸­çš„å®‰å…¨å’Œéšç§æ ‡ç­¾ã€‚{lineBreak}{lineBreak}è‹¥è¦æ·»åŠ å®¶é•¿ PINï¼Œè¯·è®¿é—®ï¼š{aTagStartWithHref}{accountSecurityLink}{hrefEnd}{accountSecurityLink}{aTagEnd}{lineBreak}{lineBreak}è‹¥è¦æ›´æ”¹èŠå¤©è®¾ç½®ï¼Œè¯·è®¿é—®ï¼š {aTagStartWithHref}{accountPrivacyLink}{hrefEnd}{accountPrivacyLink}{aTagEnd}ã€‚{lineBreak}{lineBreak}{boldTagStart}éšç§{boldTagEnd}{lineBreak}{lineBreak}è‹¥è¦ç§»é™¤æ‚¨å­©å­çš„å¸æˆ·ï¼Œæ‚¨å¯ä»¥å‰å¾€æ­¤å¤„è”ç³»å®¢æˆ·æœåŠ¡ï¼š{aTagStartWithHref}{supportPageLink}{hrefEnd}{supportPageLink}{aTagEnd}ã€‚æ‚¨çš„ç”µå­é‚®ä»¶ä¸ä¼šç”¨äºŽå…¶ä»–ç”¨é€”ï¼›ä¸ä¼šæŠ«éœ²ç»™ç¬¬ä¸‰æ–¹ï¼›ä¹Ÿä¸ä¼šä¸Žæ‚¨å­©å­çš„ä¸ªäººèµ„æ–™åˆå¹¶ã€‚å¦‚éœ€è¦æ›´å¤šä¿¡æ¯ï¼Œæ‚¨å¯ä»¥è®¿é—®æ­¤é“¾æŽ¥æŸ¥çœ‹æˆ‘ä»¬çš„éšç§æ”¿ç­–ï¼š{aTagStartWithHref}{privacyPageLink}{hrefEnd}{privacyPageLink}{aTagEnd}ã€‚{lineBreak}{lineBreak}{lineBreak}è°¢è°¢æ‚¨ï¼Œ{lineBreak}{lineBreak}Roblox å›¢é˜Ÿ {lineBreak}{lineBreak} è¯·å‹¿ç›´æŽ¥å›žå¤æ­¤é‚®ä»¶ã€‚{lineBreak}{lineBreak} {aTagStartWithHref}{robloxWebsiteLink}{hrefEnd}{robloxWebsiteLink}{aTagEnd} {lineBreak}{lineBreak} {aTagStartWithHref}{supportPageLink}{hrefEnd}{supportPageLink}{aTagEnd}";
	}
	...
	{
		return $"è¦æ‰¾åˆ°è¿™äº›æŽ§åˆ¶åŠŸèƒ½ï¼Œä½ å¯ä»¥ç™»å½•å­©å­çš„å¸æˆ·ï¼Œè®¿é—®å¸æˆ·è®¾ç½®ä¸­çš„å®‰å…¨æ€§å’Œéšç§æ ‡ç­¾ã€‚{lineBreak}{lineBreak}è¦æ·»åŠ å®¶é•¿ PINï¼Œè¯·è®¿é—®ï¼š{aTagStartWithHref}{accountSecurityLink}{hrefEnd}{accountSecurityLink}{aTagEnd}ã€‚{lineBreak}{lineBreak}è¦æ›´æ”¹èŠå¤©è®¾ç½®ï¼Œè¯·è®¿é—®ï¼š{aTagStartWithHref}{accountPrivacyLink}{hrefEnd}{accountPrivacyLink}{aTagEnd}ã€‚{lineBreak}{lineBreak}{boldTagStart}éšç§{boldTagEnd}{lineBreak}{lineBreak}ä½ å¯ä»¥é€šè¿‡è”ç³»å®¢æˆ·æœåŠ¡ï¼Œç§»é™¤å­©å­çš„å¸æˆ·ï¼š{aTagStartWithHref}{supportPageLink}{hrefEnd}{supportPageLink}{aTagEnd}ã€‚ä½ çš„ç”µå­é‚®ä»¶ä¸ä¼šç”¨äºŽä»»ä½•å…¶ä»–ç›®çš„ï¼Œä¸ä¼šæŠ«éœ²ç»™ç¬¬ä¸‰æ–¹ï¼Œä¹Ÿä¸ä¼šä¸Žæ”¶é›†è‡ªä½ å­©å­çš„ä»»ä½•å…¶ä»–ä¸ªäººä¿¡æ¯åˆå¹¶ã€‚å¦‚éœ€æ›´å¤šä¿¡æ¯ï¼Œè¯·æŸ¥é˜…æˆ‘ä»¬çš„éšç§æ”¿ç­–ï¼š{aTagStartWithHref}{privacyPageLink}{hrefEnd}{privacyPageLink}{aTagEnd}ã€‚{lineBreak}{lineBreak}{lineBreak}è°¢è°¢ï¼Œ{lineBreak}{lineBreak}Roblox å›¢é˜Ÿ{lineBreak}{lineBreak}è¯·å‹¿ç›´æŽ¥å›žå¤æœ¬ç”µå­é‚®ä»¶ã€‚{lineBreak}{lineBreak} {aTagStartWithHref}{robloxWebsiteLink}{hrefEnd}{robloxWebsiteLink}{aTagEnd} {lineBreak}{lineBreak} {aTagStartWithHref}{supportPageLink}{hrefEnd}{supportPageLink}{aTagEnd}";
	}
	...
	{
		return $"äº²çˆ±çš„ Roblox ç”¨æˆ·ï¼Œ{lineBreak}{lineBreak}å¾ˆé«˜å…´ä½ é€‰æ‹©æä¾›ç”µå­é‚®ä»¶åœ°å€ä»¥ä¿æŠ¤ä½ çš„å¸æˆ·â€œ{username}â€ã€‚{lineBreak}é€šè¿‡éªŒè¯ä½  Roblox å¸æˆ·çš„å…³è”ç”µå­é‚®ä»¶åœ°å€ï¼Œä½ å°†å¾—åˆ°æ›´é«˜çº§åˆ«çš„å¸æˆ·å®‰å…¨ä¿éšœã€‚{lineBreak}è¯·ç‚¹æŒ‰ä¸‹é¢çš„é“¾æŽ¥ä»¥å®ŒæˆéªŒè¯{lineBreak}{verificationLink}ã€‚\n";
	}
	...
	{
		return $"æ‚¨å¥½ï¼Œ{lineBreak}{lineBreak}æ‚¨çš„å­©å­å·²åœ¨ Roblox ä¸Šåˆ›å»ºè´¦æˆ·ï¼Œç”¨æˆ·åä¸ºâ€œ{username}â€ã€‚Roblox æ˜¯ä¸€ä¸ªç½‘ç»œå¨±ä¹å¹³å°ï¼Œè®©å­©å­ä»¬å¯ä»¥åœ¨æˆ‘ä»¬ä¼—å¤šèº«ä¸´å…¶å¢ƒçš„ 3D ä¸–ç•Œä¸­ä¸€èµ·å‘æŒ¥æƒ³è±¡åŠ›ï¼Œäº«å—æ¸¸æˆå¸¦æ¥çš„ä¹è¶£ã€‚ä»–ä»¬ä¹Ÿå¯ä»¥ä½¿ç”¨æˆ‘ä»¬å¼€å‘çš„å…è´¹å·¥å…· Roblox Studioã€‚æ— è®ºæ˜¯åˆ›ä½œç®€å•çš„æ¨¡å—ï¼Œè¿˜æ˜¯è¿›é˜¶åˆ°è®¾è®¡å¤æ‚çš„å¤šäººæ¸¸æˆï¼Œä»–ä»¬éƒ½èƒ½åœ¨è¿™é‡Œå°½æƒ…æŒ¥æ´’åˆ›æ„ã€‚æ— è®ºæ˜¯è®¾è®¡ç‹¬ä¸€æ— äºŒçš„ä¸»é¢˜ä¹å›­ï¼Œä»¥èŒä¸šèµ›è½¦æ‰‹çš„èº«ä»½ç«žæŠ€ï¼Œæˆä¸º T å°ä¸Šé—ªäº®çš„æ˜Žæ˜Ÿï¼Œè¿˜æ˜¯é‚€è¯·æœ‹å‹åˆ°è‡ªå·±çš„æ¢¦å¹»å®¶å›­åšå®¢ï¼Œç›®å‰ï¼Œå·²ç»æœ‰æ•°ç™¾ä¸‡å„¿ç«¥é€šè¿‡ Roblox å®žçŽ°äº†ä»–ä»¬çš„åˆ›æ„ã€‚{lineBreak}{lineBreak}æˆ‘ä»¬æƒ³è®©æ‚¨çŸ¥é“ï¼Œæ‚¨çš„å­©å­å·²å‘æˆ‘ä»¬æä¾›äº†ç”¨æˆ·åã€ç”Ÿæ—¥å’Œå®¶é•¿çš„ç”µå­é‚®ä»¶åœ°å€ã€‚å®¶é•¿ç”µå­é‚®ä»¶å°†ä»…ç”¨äºŽå¸æˆ·ç®¡ç†ã€å¯†ç é‡ç½®ä»¥åŠé€šçŸ¥å¸æˆ·ä½¿ç”¨æƒé™æ›´æ”¹ç­‰ç”¨é€”ã€‚è¯·ç‚¹æŒ‰æ­¤æŒ‰é’®éªŒè¯æ‚¨çš„ç”µå­é‚®ä»¶åœ°å€ï¼š{lineBreak}{lineBreak}{verificationLink}{lineBreak}{lineBreak}å…³äºŽ Roblox{lineBreak}{lineBreak}Roblox è‡´åŠ›æ‰“é€ ä¸€ä¸ªé€‚åˆå…¨å®¶è€å°‘çš„æ„‰å¿«çŽ¯å¢ƒã€‚æˆ‘ä»¬å’Œæ•°ç å®‰å…¨ä¸“å®¶ååŠ›ï¼Œä¸æ–­åœ°å¢žå¼ºæˆ‘ä»¬çš„å®‰å…¨æŽªæ–½ï¼Œç¡®ä¿æ‰€æœ‰çŽ©å®¶éƒ½èƒ½å®‰å¿ƒåœ°ä¸€èµ·æ¸¸æˆã€èŠå¤©ã€åˆä½œã€‚æˆ‘ä»¬å»ºè®®æ‚¨è®¿é—®ä»¥ä¸‹çš„ã€Šå®¶é•¿æŒ‡å—ã€‹ï¼Œè®©æ‚¨èƒ½å¤Ÿæ›´åŠ ç†Ÿæ‚‰æˆ‘ä»¬çš„å¹³å°ï¼Œå¹¶äº†è§£å¦‚ä½•è®©æ‚¨çš„å­©å­åœ¨ Roblox ä¸ŠèŽ·å¾—æ›´å¥½çš„ä½“éªŒï¼š{parentalPageLink}{lineBreak}{lineBreak}Roblox è¿˜æä¾›å®¶é•¿æŽ§åˆ¶åŠŸèƒ½ã€‚å®¶é•¿å¯ä»¥å¯ç”¨å®¶é•¿ PINï¼Œæ›´æ”¹å­©å­çš„é€šä¿¡å’ŒèŠå¤©è®¾å®šã€‚è‹¥è¦æ‰¾åˆ°è¿™äº›æŽ§åˆ¶ç©ºèƒ½ï¼Œæ‚¨å¯ä»¥ç™»å½•å­©å­çš„å¸æˆ·ï¼Œè®¿é—®å¸æˆ·è®¾ç½®ä¸­çš„å®‰å…¨å’Œéšç§æ ‡ç­¾ã€‚{lineBreak}{lineBreak}è‹¥è¦æ·»åŠ å®¶é•¿ PINï¼Œè¯·è®¿é—®ï¼š{accountSecurityLink}{lineBreak}{lineBreak}è‹¥è¦æ›´æ”¹èŠå¤©è®¾ç½®ï¼Œè¯·è®¿é—®ï¼š{chatPrivacyLink} {lineBreak}{lineBreak}éšç§{lineBreak}{lineBreak}è‹¥è¦ç§»é™¤æ‚¨å­©å­çš„å¸æˆ·ï¼Œæ‚¨å¯ä»¥å‰å¾€æ­¤å¤„è”ç³»å®¢æˆ·æœåŠ¡ï¼š{supportPageLink}æ‚¨çš„ç”µå­é‚®ä»¶ä¸ä¼šç”¨äºŽå…¶ä»–ç”¨é€”ï¼›ä¸ä¼šæŠ«éœ²ç»™ç¬¬ä¸‰æ–¹ï¼›ä¹Ÿä¸ä¼šä¸Žæ‚¨å­©å­çš„ä¸ªäººèµ„æ–™åˆå¹¶ã€‚å¦‚æžœéœ€è¦æ›´å¤šä¿¡æ¯ï¼Œæ‚¨å¯ä»¥è®¿é—®æ­¤é“¾æŽ¥æŸ¥çœ‹æˆ‘ä»¬çš„éšç§æ”¿ç­–ï¼š{privacyPageLink}{lineBreak}{lineBreak}è°¢è°¢æ‚¨ï¼Œ{lineBreak}{lineBreak}Roblox å›¢é˜Ÿ{lineBreak}è¯·å‹¿ç›´æŽ¥å›žå¤æ­¤é‚®ä»¶ã€‚{lineBreak}{robloxWebiteLink}{lineBreak}{supportPageLink}";
	}
	...
	{
		return $"è‹¥è¦æ›´æ”¹èŠå¤©è®¾ç½®ï¼Œè¯·è®¿é—®ï¼š{chatPrivacyLink}{lineBreak}{lineBreak}éšç§{lineBreak}{lineBreak}è‹¥è¦ç§»é™¤æ‚¨å­©å­çš„å¸æˆ·ï¼Œè¯·è®¿é—®æ­¤å¤„è”ç³»å®¢æˆ·æœåŠ¡ï¼š{supportPageLink}ã€‚æ‚¨çš„ç”µå­é‚®ä»¶ä¸ä¼šç”¨äºŽå…¶ä»–ç”¨é€”ï¼›ä¸ä¼šæŠ«éœ²ç»™ç¬¬ä¸‰æ–¹ï¼›ä¹Ÿä¸ä¼šä¸Žæ‚¨å­©å­çš„ä¸ªäººèµ„æ–™åˆå¹¶ã€‚å¦‚éœ€æ›´å¤šä¿¡æ¯ï¼Œè¯·æŸ¥é˜…æˆ‘ä»¬çš„éšç§æ”¿ç­–ï¼š{privacyPageLink}ã€‚{lineBreak}{lineBreak}è°¢è°¢æ‚¨ï¼Œ{lineBreak}{lineBreak}Roblox å›¢é˜Ÿ{lineBreak}è¯·å‹¿ç›´æŽ¥å›žå¤æ­¤é‚®ä»¶ã€‚ {lineBreak}{robloxWebiteLink}{lineBreak}{supportPageLink}";
	}
	...
	{
		return "æœ‰ä¸‹åˆ—æƒ…å½¢æ—¶é€šçŸ¥æˆ‘";
	}
	...
	{
		return "å…³äºŽè´¦å•ä¸Žä»˜æ¬¾é—®é¢˜ï¼š";
	}
	...
	{
		return $"å…³äºŽè´¦å•ä¸Žä»˜æ¬¾é—®é¢˜ï¼Œè¯·æŸ¥çœ‹{aTagStartWithHref}{billingHelpPagesLink}{hrefEnd}è´¦å•å¸®åŠ©é¡µé¢{aTagEnd}ã€‚";
	}
	...
	{
		return "æœåŠ¡å½“å‰å·²åœç”¨ï¼Œè¯·ç¨åŽé‡è¯•ã€‚";
	}
	...
	{
		return $"ä½ è¿˜ä¸æ˜¯ä¼šå‘˜ã€‚é©¬ä¸ŠåŠ å…¥{startSpan} Builders Club {endSpan}å§ï¼";
	}
	...
	{
		return "æƒ³ä½¿ç”¨çš„ç”¨æˆ·åï¼ˆ3-20 ä¸ªå­—ç¬¦ï¼‰";
	}
	...
	{
		return $"åˆ›å»ºä¸€ä¸ª {digitCount} ä½ PIN";
	}
	...
	{
		return $"è¾“å…¥éªŒè¯ç ï¼ˆ{digitCount} ä½ï¼‰";
	}
	...
	{
		return "è¯·è¾“å…¥æˆ‘ä»¬åˆšå‘é€è‡³ä½ æ‰‹æœºçš„éªŒè¯ç ";
	}
	...
	{
		return $"å¤±æ•ˆæ—¥æœŸï¼š{startSpan}{expirationDate}{endSpan}.";
	}
	...
	{
		return $"{startSpan}Builders Club {endSpan}ä¼šå‘˜èµ„æ ¼";
	}
	...
	{
		return $"äºŽ {startSpan}{expirationDate}{endSpan} æœŸé—´è‡ªåŠ¨ç»­è®¢ã€‚";
	}
	...
	{
		return $"ä½¿ç”¨â€œ{socialUsername}â€è¿žæŽ¥";
	}
	...
	{
		return "è‡ªå®šä¹‰ - æŽ§åˆ¶ä½ è‡ªå·±çš„è®¾ç½®ã€‚é»˜è®¤ - å¯ç”¨ä¸Žå¥½å‹èŠå¤©å¹¶å‘é€ä¿¡æ¯ç­‰åŠŸèƒ½ã€‚å…³é—­ - åœç”¨èŠå¤©å’Œå‘é€ä¿¡æ¯åŠŸèƒ½ã€‚";
	}

	protected override string _GetTemplateForLabelToolTipPinLocked()
	{
		return "è®¾ç½®å·²å…¨éƒ¨é”å®šã€‚è‹¥è¦ç¼–è¾‘ï¼Œè¯·ä½¿ç”¨ PIN è§£é”";
	}

	protected override string _GetTemplateForLabelToolTipPinUnlocked()
	{
		return "ç‚¹æŒ‰ä»¥é”å®šä½ çš„è®¾ç½®é¡µé¢";
	}

	protected override string _GetTemplateForLabelToolTipPrivacyMode()
	{
		return "ç‚¹å‡»æ­¤å¤„äº†è§£æ›´å¤šä¿¡æ¯";
	}

	protected override string _GetTemplateForLabelToolTipWhoCanChatInApp()
	{
		return "æ­¤è®¾ç½®å†³å®šæ­¤ç”¨æˆ·åœ¨ App ä¸­åŠç½‘ç»œä¸Šå¯ä»¥èŠå¤©çš„å¯¹è±¡ï¼ˆæ— æ³•æŽ§åˆ¶æ¸¸æˆä¸­çš„èŠå¤©å¯¹è±¡ï¼‰ã€‚æ­¤è®¾ç½®ä¹Ÿå¯é˜»æ­¢æ­¤ç”¨æˆ·åœ¨è®ºå›å’Œç¾¤ç»„ç•™è¨€æ¿ä¸Šå‘å¸–ã€‚";
	}

	protected override string _GetTemplateForLabelToolTipWhoCanChatInGame()
	{
		return "æ­¤è®¾ç½®å†³å®šæ­¤ç”¨æˆ·åœ¨æ¸¸æˆä¸­å¯ä»¥èŠå¤©çš„å¯¹è±¡ã€‚";
	}

	protected override string _GetTemplateForLabelToolTipWhoCanFindMeByPhone()
	{
		return "æ­¤è®¾ç½®å†³å®šè°å¯ä»¥é€šè¿‡ä½ æä¾›çš„æ‰‹æœºå·ç æ‰¾åˆ°ä½ ã€‚";
	}

	protected override string _GetTemplateForLabelToolTipWhoCanInviteVIP()
	{
		return "æ­¤è®¾ç½®å†³å®šè°å¯ä»¥åœ¨ VIP æœåŠ¡å™¨ä¸­åŠ å…¥æ­¤ç”¨æˆ· - VIP æœåŠ¡å™¨åªèƒ½é€šè¿‡æœåŠ¡å™¨ä¸»äººçš„é‚€è¯·æ‰èƒ½åŠ å…¥ã€‚";
	}

	protected override string _GetTemplateForLabelToolTipWhoCanJoinGame()
	{
		return "æ­¤è®¾ç½®å†³å®šè°èƒ½çœ‹åˆ°æˆ‘åœ¨å“ªä¸ªæ¸¸æˆä¸­ï¼Œå¹¶åŠ å…¥æˆ‘çš„æœåŠ¡å™¨ã€‚é€‰æ‹©â€œæ²¡æœ‰äººâ€ï¼Œè¡¨ç¤ºæ²¡æœ‰äººå¯ä»¥è·Ÿéšæˆ‘è¿›å…¥æˆ‘çš„ç‰¹å®šæœåŠ¡å™¨ï¼Œä½†æˆ‘å¯ä»¥è·Ÿå…¶ä»–ç”¨æˆ·ä¸€èµ·çŽ©æ¸¸æˆã€‚";
	}

	protected override string _GetTemplateForLabelToolTipWhoCanMessageMe()
	{
		return "æ­¤è®¾ç½®å†³å®šè°å¯ä»¥å‘æ­¤ç”¨æˆ·çš„ä¿¡æ¯æ”¶ä»¶ç®±å‘é€ä¿¡æ¯ã€‚";
	}

	protected override string _GetTemplateForLabelToolTipWhoCanSeeInventory()
	{
		return "è¿™é¡¹è®¾ç½®å†³å®šè°å¯ä»¥çœ‹åˆ°ä½ çš„é“å…·ã€‚";
	}

	protected override string _GetTemplateForLabelTradeFilter()
	{
		return "äº¤æ˜“å“è´¨è¿‡æ»¤å™¨";
	}
	...
	{
		return "è°å¯ä»¥åœ¨ App ä¸­ä¸Žæˆ‘èŠå¤©ï¼Ÿ";
	}

	protected override string _GetTemplateForLabelWhoCanChatInGame()
	{
		return "è°å¯ä»¥ä¸Žæˆ‘èŠå¤©ï¼Ÿ";
	}
	...
	{
		return "æ²¡æœ‰ä¸Žæ­¤å¸æˆ·å…³è”çš„ç”µå­é‚®ä»¶ã€‚";
	}
	...
	{
		return "ä½ çš„ Robux ä½™é¢ä¸è¶³ï¼Œæ— æ³•æ›´æ”¹ç”¨æˆ·åã€‚";
	}
	...
	{
		return "ä½ å¿…é¡»å°†ç”µå­é‚®ä»¶åœ°å€ä¸Žä½ çš„å¸æˆ·ç›¸å…³è”";
	}

	protected override string _GetTemplateForMessagePermissionError()
	{
		return "ä½ çš„ Robux ä¸è¶³ï¼Œæ— æ³•æ›´æ”¹ç”¨æˆ·åã€‚";
	}
	...
	{
		return "å°†ä½ çš„ç”Ÿæ—¥æ›´æ”¹ä¸º 13 å²ä»¥ä¸‹åˆ™æ— æ³•è¿˜åŽŸã€‚ä½ çš„ Facebook ç¤¾äº¤ç™»å½•å°†è¢«åœç”¨ï¼Œä½ ä¹Ÿå°†å¿…é¡»ä½¿ç”¨ Roblox å¯†ç ç™»å½•ã€‚";
	}
	...
	{
		return "æŒ‰â€œå‘é€â€æäº¤ç¥¨å•ï¼Œæˆ–æŒ‰â€å–æ¶ˆâ€ä»¥ç¼–è¾‘ç”¨æˆ·åã€‚ç”¨æˆ·åæ˜¯éžå¸¸é‡è¦çš„ä¿¡æ¯ï¼Œæœ‰åŠ©äºŽåŠ å¿«è§£å†³ä½ çš„é—®é¢˜ã€‚";
	}

	protected override string _GetTemplateForResponseDialogPasswordRulesError()
	{
		return "å¯†ç é¡»è‡³å°‘åŒ…å« 2 ä¸ªæ•°å­—ã€4 ä¸ªå­—æ¯ã€1 ä¸ªç¬¦å·ï¼Œä¸”è‡³å°‘ä¸º 8 ä¸ªå­—ç¬¦ã€‚";
	}

	protected override string _GetTemplateForResponseDialogPinCreateConfirmation()
	{
		return "ä½ çš„ PIN çŽ°å·²è®¾ç½®å¥½ã€‚ä½ å°†éœ€è¦å…ˆè¾“å…¥æ­¤ PINï¼Œæ‰èƒ½è®¿é—®è®¾ç½®é¡µé¢ã€‚";
	}
