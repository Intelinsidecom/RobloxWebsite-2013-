...
/// </summary>
internal class PremiumResources_zh_cjv : PremiumResources_en_us, IPremiumResources, ITranslationResources
{
	/// <summary>
	/// Key: "Action.Bought"
	...
	/// </summary>
	public override string DescriptionGooglePlayMonthlySubscriptionDisclosure => "";
	...
	public PremiumResources_zh_cjv(TranslationResourceState state)
		: base(state)
	{
	}
