...
/// </summary>
internal class SurveysGameRatingsResources_es_es : SurveysGameRatingsResources_en_us, ISurveysGameRatingsResources, ITranslationResources
{
	/// <summary>
	...
	/// </summary>
	public override string DescriptionAnswerToDoesThisGameContainFrequently => "Con frecuencia";
	...
	/// </summary>
	public override string DescriptionAnswerToDoesThisGameContainInfrequently => "Con poca frecuencia";
	...
	/// English String: "No"
	/// </summary>
	public override string DescriptionAnswerToDoesThisGameContainNo => "No";
	...
	/// English String: "Yes"
	/// </summary>
	public override string DescriptionAnswerToDoesThisGameContainYes => "Sí";
	...
	/// </summary>
	public override string DescriptionCanUsersWagerRobuxInGameCurrencyPurchasedWithRobuxOrOtherItemsOfRealValue => "¿Pueden los usuarios apostar usando Robux, comprar con Robux dinero virtual dentro del juego u otros objetos que tengan un valor real?";
	...
	/// </summary>
	public override string DescriptionDefenselessViolenceQuestion => "¿Este juego contiene actos de violencia dirigidos a personajes indefensos?";
	...
	/// </summary>
	public override string DescriptionDoesThisGameContainBathroomHumor => "¿Este juego contiene humor que hace referencia a actos fisiológicos o corporales (orinar, defecar, vomitar, etc.)?";
	...
	/// </summary>
	public override string DescriptionDoesThisGameContainCrudeHumor => "¿Este juego contiene humor vulgar?";
	...
	/// </summary>
	public override string DescriptionDoesThisGameContainNudityOrDepictionsOfSex => "¿Este juego contiene desnudez o escenas de sexo?";
	...
	/// </summary>
	public override string DescriptionDoesThisGameContainReferencesToAlcoholTobaccoOrDrugs => "¿Este juego contiene referencias al alcohol, tabaco o drogas?";
	...
	/// </summary>
	public override string DescriptionDoesThisGameContainReferencesToAlcoholTobaccoOrDrugsCharactersAreShownUsingAlcoholTobac => "Se muestran personajes que consumen alcohol, drogas o fuman";
	...
	/// </summary>
	public override string DescriptionDoesThisGameContainReferencesToAlcoholTobaccoOrDrugsFrequentReferences => "Referencias frecuentes";
	...
	/// </summary>
	public override string DescriptionDoesThisGameContainReferencesToAlcoholTobaccoOrDrugsInfrequentReferences => "Referencias infrecuentes";
	...
	/// English String: "No"
	/// </summary>
	public override string DescriptionDoesThisGameContainReferencesToAlcoholTobaccoOrDrugsNo => "No";
	...
	/// </summary>
	public override string DescriptionDoesThisGameContainSimulatedGamblingOrPaidLootBoxes => "¿Este juego contiene apuestas simuladas o cajas de botín de pago?";
	...
	/// </summary>
	public override string DescriptionDoesThisGameContainSuggestiveSexualThemes => "¿Este juego contiene temas sexuales sugestivos?";
	...
	/// </summary>
	public override string DescriptionDoesThisGameFollowTheCommunityRules => "¿Este juego sigue las directrices de la comunidad? ";
	...
	/// English String: "No"
	/// </summary>
	public override string DescriptionDoesThisGameFollowTheCommunityRulesNo => "No";
	...
	/// English String: "Yes"
	/// </summary>
	public override string DescriptionDoesThisGameFollowTheCommunityRulesYes => "Sí";
	...
	/// </summary>
	public override string DescriptionDoesThisGameUseProfanity => "¿Este juego contiene lenguaje soez?";
	...
	/// </summary>
	public override string DescriptionDoesThisGameUseProfanityFrequentProfanity => "Palabrotas frecuentes";
	...
	/// </summary>
	public override string DescriptionDoesThisGameUseProfanityInfrequentProfanity => "Palabrotas infrecuentes";
	...
	/// English String: "No"
	/// </summary>
	public override string DescriptionDoesThisGameUseProfanityNo => "No";
	...
	/// </summary>
	public override string DescriptionDoesThisGameUseProfanitySomeMildBadLanguage => "Algunas palabrotas leves";
	...
	/// </summary>
	public override string DescriptionScaryForChildUnderEightQuestion => "¿Este juego presenta contenido que puede asustar a niños menores de 8 años?";
	...
	/// </summary>
	public override string DescriptionScaryForChildUnderTwelveQuestion => "¿Este juego presenta contenido que puede asustar a niños menores de 12 años?";
	...
	/// </summary>
	public override string DescriptionViolenceQuestionComicalViolence => "Violencia cómica";
	...
	/// </summary>
	public override string DescriptionViolenceQuestionDoesThisGameContainViolentContent => "¿Este juego presenta contenido violento?";
	...
	/// </summary>
	public override string DescriptionViolenceQuestionEasilyDistinguishableFromRealLife => "Fácilmente distinguible de la vida real";
	...
	/// </summary>
	public override string DescriptionViolenceQuestionExtremeRealisticViolence => "Violencia extrema y realista";
	...
	/// English String: "No"
	/// </summary>
	public override string DescriptionViolenceQuestionNo => "No";
	...
	/// </summary>
	public override string DescriptionViolenceQuestionSomeRealisticViolence => "Algo de violencia realista";

	public SurveysGameRatingsResources_es_es(TranslationResourceState state)
		: base(state)
	{
	}
	...
	{
		return "¿Pueden los usuarios apostar usando Robux, comprar con Robux dinero virtual dentro del juego u otros objetos que tengan un valor real?";
	}

	protected override string _GetTemplateForDescriptionDefenselessViolenceQuestion()
	{
		return "¿Este juego contiene actos de violencia dirigidos a personajes indefensos?";
	}

	protected override string _GetTemplateForDescriptionDoesThisGameContainBathroomHumor()
	{
		return "¿Este juego contiene humor que hace referencia a actos fisiológicos o corporales (orinar, defecar, vomitar, etc.)?";
	}

	protected override string _GetTemplateForDescriptionDoesThisGameContainCrudeHumor()
	{
		return "¿Este juego contiene humor vulgar?";
	}

	protected override string _GetTemplateForDescriptionDoesThisGameContainNudityOrDepictionsOfSex()
	{
		return "¿Este juego contiene desnudez o escenas de sexo?";
	}

	protected override string _GetTemplateForDescriptionDoesThisGameContainReferencesToAlcoholTobaccoOrDrugs()
	{
		return "¿Este juego contiene referencias al alcohol, tabaco o drogas?";
	}
	...
	{
		return "Se muestran personajes que consumen alcohol, drogas o fuman";
	}
	...
	{
		return "Referencias infrecuentes";
	}
	...
	{
		return "Algo de violencia realista";
	}
}
