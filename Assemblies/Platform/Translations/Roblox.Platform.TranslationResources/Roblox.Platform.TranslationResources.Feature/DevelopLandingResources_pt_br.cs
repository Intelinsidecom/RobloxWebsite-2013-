...
internal class DevelopLandingResources_pt_br : DevelopLandingResources_en_us, IDevelopLandingResources, ITranslationResources
{
	...
	/// </summary>
	public override string DescriptionEarnSeriousCash => "Criadores como vocÃª podem ganhar dinheiro para fazerem aquilo que mais gostam. Nossos melhores desenvolvedores ganham atÃ© 2 milhÃµes de dÃ³lares por ano fornecendo compras no jogo";
	...
	/// </summary>
	public override string DescriptionFreeImmersiveCreationEngine => "Com nosso sistema de criaÃ§Ã£o imersivo GRÃTIS";
	...
	/// </summary>
	public override string DescriptionMakeAnything => "Roblox Studio permite que vocÃª crie e lance qualquer coisa com um clique para: smartphones, tablets, desktops, consoles e dispositivos de realidade virtual";
	...
	/// </summary>
	public override string DescriptionReachMillionsPlayers => "Conecte-se com um pÃºblico gigantesco participando de uma comunidade extremamente empolgada e internacional com mais de 50 milhÃµes de jogadores todo mÃªs";
	...
	/// </summary>
	public override string DescriptionRobloxDevHub => "O Centro do Desenvolvedor Ã© o local para publicar no Roblox. Aprenda com vÃ¡rios tutoriais, interaja com outros desenvolvedores, confira atualizaÃ§Ãµes de plataformas, consulte nossas referÃªncias de API e muito mais.";
	...
	/// </summary>
	public override string DescriptionRobloxWiki => "A Wiki Roblox Ã© a fonte definitiva de documento, tutoriais e amostras que vÃ£o ajudar vocÃª a aprender a fazer jogos com o Roblox Studio";
	...
	/// </summary>
	public override string DescriptionTestimonialAlexBalfanz => "Foi muito fÃ¡cil comeÃ§ar a usar o Roblox. VocÃª pode ter uma carreira inteira nesta plataforma porque ela Ã© tÃ£o popular e a equipe deles estÃ¡ sempre fornecendo recursos incrÃ­veis para os desenvolvedores.";
	...
	/// </summary>
	public override string DescriptionTestimonialAndrewBereza => "O Roblox permite que eu foque na minha futura carreira potencial de desenvolvedor de jogos sem ter que me preocupar com os problemas financeiros tÃ­picos de um universitÃ¡rio.";
	...
	/// </summary>
	public override string DescriptionTestimonialJacksonMunsell => "Adoro criar jogos no Roblox pois ele Ã© uma plataforma social. Ele utiliza a socializaÃ§Ã£o de outras plataformas, como o Facebook, e as levam a um novo nÃ­vel com os jogos e criatividade da comunidade.";
	...
	/// English String: "Roblox allows me to focus on my game development and potential future career without having to worry about the financial hardships of being a college student."
	/// </summary>
	public override string DescriptionTestimonialOne => "O Roblox permite que eu foque na minha futura carreira potencial de desenvolvedor de jogos sem ter que me preocupar com os problemas financeiros tÃ­picos de um universitÃ¡rio.";
	...
	/// English String: "Roblox was so easy to get into. You can have a whole career on it because itâ€™s such a hot platform and the team there is always providing great resources for developers."
	/// </summary>
	public override string DescriptionTestimonialThree => "Foi muito fÃ¡cil comeÃ§ar a usar o Roblox. VocÃª pode ter uma carreira inteira nesta plataforma porque ela Ã© tÃ£o popular e a equipe deles estÃ¡ sempre fornecendo recursos incrÃ­veis para os desenvolvedores.";
	...
	/// English String: "I enjoy creating games on Roblox because itâ€™s social. It takes the socialization of platforms like Facebook to a new level with the games and creativity of the community."
	/// </summary>
	public override string DescriptionTestimonialTwo => "Adoro criar jogos no Roblox pois ele Ã© uma plataforma social. Ele utiliza a socializaÃ§Ã£o de outras plataformas, como o Facebook, e as levam a um novo nÃ­vel com os jogos e criatividade da comunidade.";
	...
	/// </summary>
	public override string HeadingMakeAnything => "Crie qualquer coisa que vocÃª possa imaginar";
	...
	/// </summary>
	public override string HeadingReachMillionsPlayers => "Interaja com milhÃµes de jogadores";
	...
	/// </summary>
	public override string HeadingTryFreeRobloxStudioToday => "Roblox Studio Ã© GRÃTIS! Experimente hoje!";
	...
	/// </summary>
	public override string HeadingWhatCreatorsSaying => "O que nossos criadores estÃ£o dizendo";
	...
	/// </summary>
	public override string LabelGetStarted => "ComeÃ§ando";
	...
	/// </summary>
	public override string LabelRobloxStudioOnWindowsAndMac => "Roblox Studio estÃ¡ disponÃ­vel para Windows e Mac";
	...
	{
		return "Criadores como vocÃª podem ganhar dinheiro para fazerem aquilo que mais gostam. Nossos melhores desenvolvedores ganham atÃ© 2 milhÃµes de dÃ³lares por ano fornecendo compras no jogo";
	}

	protected override string _GetTemplateForDescriptionFreeImmersiveCreationEngine()
	{
		return "Com nosso sistema de criaÃ§Ã£o imersivo GRÃTIS";
	}

	protected override string _GetTemplateForDescriptionMakeAnything()
	{
		return "Roblox Studio permite que vocÃª crie e lance qualquer coisa com um clique para: smartphones, tablets, desktops, consoles e dispositivos de realidade virtual";
	}

	protected override string _GetTemplateForDescriptionReachMillionsPlayers()
	{
		return "Conecte-se com um pÃºblico gigantesco participando de uma comunidade extremamente empolgada e internacional com mais de 50 milhÃµes de jogadores todo mÃªs";
	}

	protected override string _GetTemplateForDescriptionRobloxDevHub()
	{
		return "O Centro do Desenvolvedor Ã© o local para publicar no Roblox. Aprenda com vÃ¡rios tutoriais, interaja com outros desenvolvedores, confira atualizaÃ§Ãµes de plataformas, consulte nossas referÃªncias de API e muito mais.";
	}

	protected override string _GetTemplateForDescriptionRobloxWiki()
	{
		return "A Wiki Roblox Ã© a fonte definitiva de documento, tutoriais e amostras que vÃ£o ajudar vocÃª a aprender a fazer jogos com o Roblox Studio";
	}

	protected override string _GetTemplateForDescriptionTestimonialAlexBalfanz()
	{
		return "Foi muito fÃ¡cil comeÃ§ar a usar o Roblox. VocÃª pode ter uma carreira inteira nesta plataforma porque ela Ã© tÃ£o popular e a equipe deles estÃ¡ sempre fornecendo recursos incrÃ­veis para os desenvolvedores.";
	}

	protected override string _GetTemplateForDescriptionTestimonialAndrewBereza()
	{
		return "O Roblox permite que eu foque na minha futura carreira potencial de desenvolvedor de jogos sem ter que me preocupar com os problemas financeiros tÃ­picos de um universitÃ¡rio.";
	}

	protected override string _GetTemplateForDescriptionTestimonialJacksonMunsell()
	{
		return "Adoro criar jogos no Roblox pois ele Ã© uma plataforma social. Ele utiliza a socializaÃ§Ã£o de outras plataformas, como o Facebook, e as levam a um novo nÃ­vel com os jogos e criatividade da comunidade.";
	}
	...
	{
		return "Crie qualquer coisa que vocÃª possa imaginar";
	}
	...
	{
		return "Interaja com milhÃµes de jogadores";
	}
	...
	{
		return "Roblox Studio Ã© GRÃTIS! Experimente hoje!";
	}

	protected override string _GetTemplateForHeadingWhatCreatorsSaying()
	{
		return "O que nossos criadores estÃ£o dizendo";
	}
	...
	{
		return "Roblox Studio estÃ¡ disponÃ­vel para Windows e Mac";
	}
