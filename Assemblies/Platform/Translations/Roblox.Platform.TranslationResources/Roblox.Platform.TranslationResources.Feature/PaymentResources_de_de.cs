...
internal class PaymentResources_de_de : PaymentResources_en_us, IPaymentResources, ITranslationResources
{
	...
	/// </summary>
	public override string MessageFraudBlockedPaymentCheckInfoErrorMessage => "Wir kÃ¶nnen deine Zahlung leider nicht verarbeiten. Bitte Ã¼berprÃ¼fe, ob die eingegebenen Rechnungsdaten mit der Karte Ã¼bereinstimmen, und versuche es dann erneut. Probiere bitte eine andere Karte oder Zahlungsart aus, falls der Vorgang erneut fehlschlÃ¤gt.\t";
	...
	/// </summary>
	public override string MessageFraudWarningForUnder13WithCreditCard => "Stell sicher, dass du die Erlaubnis deiner Eltern hast, bevor du deren Kreditkarten verwendest. Karteninhaber kÃ¶nnen zur BestÃ¤tigung kontaktiert werden. Wenn du eine Karte ohne Erlaubnis verwendest, wird dein Konto gelÃ¶scht.";
	...
	{
		return "Wir kÃ¶nnen deine Zahlung leider nicht verarbeiten. Bitte Ã¼berprÃ¼fe, ob die eingegebenen Rechnungsdaten mit der Karte Ã¼bereinstimmen, und versuche es dann erneut. Probiere bitte eine andere Karte oder Zahlungsart aus, falls der Vorgang erneut fehlschlÃ¤gt.\t";
	}
	...
	{
		return $"Deine Transaktion wurde wegen verdÃ¤chtiger AktivitÃ¤ten gesperrt. Falls du glaubst, dass es sich dabei um einen Irrtum handelt, kontaktiere uns bitte Ã¼ber {linkStart}roblox.com/support{linkEnd}.";
	}
	...
	{
		return $"Stell sicher, dass du die Erlaubnis deiner Eltern hast, bevor du deren Kreditkarten verwendest. Karteninhaber kÃ¶nnen zur BestÃ¤tigung kontaktiert werden. {lineStart}Wenn du eine Karte ohne Erlaubnis verwendest, wird dein Konto gelÃ¶scht.{lineEnd}";
	}
	...
	{
		return "Stell sicher, dass du die Erlaubnis deiner Eltern hast, bevor du deren Kreditkarten verwendest. Karteninhaber kÃ¶nnen zur BestÃ¤tigung kontaktiert werden. Wenn du eine Karte ohne Erlaubnis verwendest, wird dein Konto gelÃ¶scht.";
	}
}
