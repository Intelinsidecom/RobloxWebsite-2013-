...
/// </summary>
internal class RobloxProductsResources_zh_cjv : RobloxProductsResources_en_us, IRobloxProductsResources, ITranslationResources
{
	/// <summary>
	/// Key: "Heading.Sorry"
	...
	public RobloxProductsResources_zh_cjv(TranslationResourceState state)
		: base(state)
	{
	}
