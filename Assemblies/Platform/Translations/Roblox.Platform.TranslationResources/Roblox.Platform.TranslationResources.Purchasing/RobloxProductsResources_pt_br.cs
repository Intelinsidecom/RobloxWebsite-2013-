...
internal class RobloxProductsResources_pt_br : RobloxProductsResources_en_us, IRobloxProductsResources, ITranslationResources
{
	...
	/// </summary>
	public override string MessageTryAgainLater => "Compras de Robux esṭo desabilitadas no momento. Tente de novo mais tarde.";
	...
	{
		return "Compras de Robux esṭo desabilitadas no momento. Tente de novo mais tarde.";
	}
}
