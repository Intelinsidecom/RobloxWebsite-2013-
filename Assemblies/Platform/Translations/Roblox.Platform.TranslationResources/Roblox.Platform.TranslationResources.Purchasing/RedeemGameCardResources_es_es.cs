...
internal class RedeemGameCardResources_es_es : RedeemGameCardResources_en_us, IRedeemGameCardResources, ITranslationResources
{
	...
	/// </summary>
	public override string DescriptionCombineCards => "Combina las tarjetas para aumentar tu crÃ©dito de Roblox.";
	...
	/// </summary>
	public override string DescriptionDialogRobloxRedeemCard => "Â¡Debes iniciar sesiÃ³n con tu cuenta de Roblox para canjear la tarjeta de juego!";
	...
	/// </summary>
	public override string DescriptionLegalDisclaimer => "Las compras se pueden realizar con un solo mÃ©todo de pago. Los crÃ©ditos de las tarjetas de juego no se pueden combinar con otras formas de pago.";
	...
	/// </summary>
	public override string DescriptionSpendRobloxCredit => "Â¡Utiliza tu crÃ©dito de Roblox para comprar Robux y para unirte al Builders Club!";
	...
	/// </summary>
	public override string DescriptionTypeCardPin => "Ingresa el PIN de tu tarjeta en la secciÃ³n de canjeo.";
	...
	/// </summary>
	public override string HeadingGetRobloxCreditFor => "ObtÃ©n crÃ©dito de Roblox para";
	...
	/// </summary>
	public override string HeadingHowToRedeem => "CÃ³mo canjearlas";
	...
	/// </summary>
	public override string LabelNeedGameCard => "Â¿Necesitas una tarjeta de juego de Roblox?";
	...
	/// </summary>
	public override string ResponseBuildersClubExtended => "Â¡Tu membresÃ­a al Builders Club ha sido extendida correctamente!";
	...
	/// </summary>
	public override string ResponseBuildersClubRedeemed => "Â¡Tu membresÃ­a al Builders Club ha sido activada correctamente!";
	...
	/// </summary>
	public override string ResponseCodeNotFoundError => "No se ha encontrado un cÃ³digo correspondiente.";
	...
	/// </summary>
	public override string ResponseFeatureDisabledError => "Esta funciÃ³n estÃ¡ desactivada en este momento.";
	...
	/// </summary>
	public override string ResponseGenericError => "Algo ha ido mal. IntÃ©ntalo de nuevo mÃ¡s tarde.";
	...
	/// </summary>
	public override string ResponseInvalidPIN => "PIN no vÃ¡lido";
	...
	/// </summary>
	public override string ResponseLoginRequiredError => "Debes iniciar sesiÃ³n para realizar esta acciÃ³n.";
	...
	/// </summary>
	public override string ResponseObjectNotFoundError => "No se ha podido encontrar el objeto solicitado. IntÃ©ntalo de nuevo mÃ¡s tarde o ponte en contacto con el servicio al cliente si el problema persiste.";
	...
	/// </summary>
	public override string ResponseRedeemSuccess => "Â¡Has canjeado correctamente tu tarjeta!";
	...
	/// </summary>
	public override string ResponseTooManyCodesRedeemedError => "Se han canjeado demasiados cÃ³digos. IntÃ©ntalo de nuevo mÃ¡s tarde.";
	...
	/// </summary>
	public override string ResponseTooManyRequestsError => "Demasiados intentos de solicitud incorrectos. IntÃ©ntalo de nuevo mÃ¡s tarde.";
	...
	{
		return "Â¡Debes iniciar sesiÃ³n con tu cuenta de Roblox para canjear la tarjeta de juego!";
	}

	protected override string _GetTemplateForDescriptionLegalDisclaimer()
	{
		return "Las compras se pueden realizar con un solo mÃ©todo de pago. Los crÃ©ditos de las tarjetas de juego no se pueden combinar con otras formas de pago.";
	}
	...
	{
		return "Ingresa el PIN de tu tarjeta en la secciÃ³n de canjeo.";
	}
	...
	{
		return "ObtÃ©n crÃ©dito de Roblox para";
	}

	protected override string _GetTemplateForHeadingHowToRedeem()
	{
		return "CÃ³mo canjearlas";
	}
	...
	{
		return "Â¿Necesitas una tarjeta de juego de Roblox?";
	}
	...
	{
		return "Â¡Tu membresÃ­a al Builders Club ha sido extendida correctamente!";
	}
	...
	{
		return "Â¡Tu membresÃ­a al Builders Club ha sido activada correctamente!";
	}

	protected override string _GetTemplateForResponseCodeNotFoundError()
	{
		return "No se ha encontrado un cÃ³digo correspondiente.";
	}
	...
	{
		return $"El usuario ha intentado canjear el PIN, pero el comercio no existe. ID del usuario: {authenticatedUserId} NÃºmero PIN: {cardPin}";
	}
	...
	{
		return "No se ha podido encontrar el objeto solicitado. IntÃ©ntalo de nuevo mÃ¡s tarde o ponte en contacto con el servicio al cliente si el problema persiste.";
	}

	protected override string _GetTemplateForResponseRedeemSuccess()
	{
		return "Â¡Has canjeado correctamente tu tarjeta!";
	}
	...
	{
		return "Se han canjeado demasiados cÃ³digos. IntÃ©ntalo de nuevo mÃ¡s tarde.";
	}

	protected override string _GetTemplateForResponseTooManyRequestsError()
	{
		return "Demasiados intentos de solicitud incorrectos. IntÃ©ntalo de nuevo mÃ¡s tarde.";
	}
	...
	{
		return $"Gracias por canjear dos tarjetas de Roblox en GameStop. Se han aÃ±adido {robuxCount} Robux a tu cuenta.";
	}
