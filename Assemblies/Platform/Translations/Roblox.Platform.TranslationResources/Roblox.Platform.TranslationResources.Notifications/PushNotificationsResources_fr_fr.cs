...
internal class PushNotificationsResources_fr_fr : PushNotificationsResources_en_us, IPushNotificationsResources, ITranslationResources
{
	...
	/// </summary>
	public override string MessageAddedToPrivateServerWhiteListDefault => "Vous Ãªtes invitÃ©(e) Ã  rejoindre un serveur\u00a0VIP\u00a0!";
	...
	/// </summary>
	public override string MessageDefaultSystemMessageBody => "Nouvelle activitÃ© sur Roblox\u00a0!";
	...
	/// </summary>
	public override string MessageFriendRequestAcceptedDefault => "Ta demande d'amitiÃ© a Ã©tÃ© acceptÃ©e\u00a0!";
	...
	/// </summary>
	public override string MessageFriendRequestReceivedDefault => "Vous avez une nouvelle demande d'amitiÃ©\u00a0!";
	...
	/// </summary>
	public override string MessagePartyInvitationDefault => "Vous Ãªtes invitÃ©(e) Ã  rejoindre un groupe\u00a0!";
	...
	/// </summary>
	public override string MessagePrivateMessageReceivedDefault => "Vous avez un nouveau message privÃ©.";
	...
	/// </summary>
	public override string MessageTeamCreateInvitationDefault => "Vous Ãªtes invitÃ©(e) Ã  modifier un jeu\u00a0!";
	...
	{
		return $"{vipInviter} vous a ajoutÃ© Ã  son serveur\u00a0VIP, {server}, Ã  l'emplacement {place}\u00a0!";
	}
	...
	{
		return "Vous Ãªtes invitÃ©(e) Ã  rejoindre un serveur\u00a0VIP\u00a0!";
	}

	protected override string _GetTemplateForMessageDefaultSystemMessageBody()
	{
		return "Nouvelle activitÃ© sur Roblox\u00a0!";
	}
	...
	{
		return $"{friend} a acceptÃ© ta demande d'amitiÃ©\u00a0!";
	}
	...
	{
		return "Ta demande d'amitiÃ© a Ã©tÃ© acceptÃ©e\u00a0!";
	}
	...
	{
		return $"Vous Ãªtes dÃ©sormais ami(e) avec {friend}\u00a0!";
	}
	...
	{
		return "Vous avez une nouvelle demande d'amitiÃ©\u00a0!";
	}
	...
	{
		return $"{friend} vous a envoyÃ© une demande d'amitiÃ©\u00a0!";
	}
	...
	{
		return $"{senderUserName} Ã  {conversationTitle}\u00a0: {messageContent}";
	}
	...
	{
		return "Vous Ãªtes invitÃ©(e) Ã  rejoindre un groupe\u00a0!";
	}
	...
	{
		return $"{partyInviter} vous a invitÃ©(e) Ã  rejoindre un groupe\u00a0!";
	}
	...
	{
		return $"{partyInviter} vous a invitÃ©(e) Ã  rejoindre un groupe Xbox\u00a0!";
	}
	...
	{
		return "Vous avez un nouveau message privÃ©.";
	}
	...
	{
		return $"{messageSender} vous a envoyÃ© un nouveau message privÃ©.";
	}
	...
	{
		return $"{inviter} vous a invitÃ©(e) Ã  modifier le jeu\u00a0: {gameName}\u00a0!";
	}
	...
	{
		return "Vous Ãªtes invitÃ©(e) Ã  modifier un jeu\u00a0!";
	}
