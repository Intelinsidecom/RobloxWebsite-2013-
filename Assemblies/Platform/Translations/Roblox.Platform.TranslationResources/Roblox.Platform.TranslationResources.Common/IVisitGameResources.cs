...

{
	...
	/// </summary>
	string HeadingErrorStartingGame { get; }
	...
	/// </summary>
	string HeadingSwitchToDesktopToPlay { get; }
	...
	/// </summary>
	string LabelCheckingForStudio { get; }
	...
	/// </summary>
	string LabelClickHereForHelp { get; }
	...
	/// </summary>
	string LabelConnectingToPlayers { get; }

	/// <summary>
	/// Key: "Label.DevelopPageTitle"
	/// English String: "Develop"
	/// </summary>
	string LabelDevelopPageTitle { get; }
	...
	/// </summary>
	string LabelDownloadInstallRoblox { get; }
	...
	/// </summary>
	string LabelGameUnavailableCurrentlyIsPrivateVisitor { get; }
	...
	/// </summary>
	string LabelGameUnavailablePlatform { get; }

	/// <summary>
	/// Key: "Label.GameWarning"
	/// English String: "Warning"
	/// </summary>
	string LabelGameWarning { get; }
	...
	/// </summary>
	string LabelInstallationInstructions { get; }
	...
	/// </summary>
	string LabelLaunchApplication { get; }
	...
	/// </summary>
	string LabelPersuadeToDevelopRoblox { get; }
	...
	/// </summary>
	string LabelPersuadeToInstallRoblox { get; }
	...
	/// </summary>
	string LabelRobloxLoadingToPlay { get; }
	...
	/// </summary>
	string LabelStartingRoblox { get; }
	...
	/// </summary>
	string LabelSwitchToDesktopMode { get; }
	...
	/// </summary>
	string LabelUniverseConfigurePageTitle { get; }
	...
	/// </summary>
	string ResponseDialogClickHere { get; }
	...
	/// </summary>
	string ResponseDialogErrorLaunching { get; }
	...
	/// </summary>
	string ResponseDialogHavingTroubleInstallQuestion { get; }
	...
	/// </summary>
	string ResponseDialogMacChromeSecondInstruction { get; }
	...
	/// </summary>
	string ResponseDialogThanksForPlayingRoblox { get; }
	...
	/// </summary>
	string LabelGameIsPrivatePlayableByGroupOnly(string linkStart, string linkEnd);
	...
	/// </summary>
	string LabelGameIsPrivatePlayableByOwnerOnly(string linkStart, string linkEnd);
	...
	/// </summary>
	string LabelGameUnavailableCurrentlyIsPrivateGroup(string linkStart, string linkEnd);
	...
	/// </summary>
	string LabelGameUnavailableCurrentlyIsPrivateOwner(string linkStart, string linkEnd);
	...
	/// </summary>
	string LabelGameUnavailableCurrentlyPrivate(string gameTypeName, string developPageLink);
	...
	/// </summary>
	string LabelGameUnavailableNoRootPlace(string gameConfigureLink);
	...
	/// </summary>
	string LabelGameUnavailablePlaceNotPartOfGame(string developPageLink);
	...
	/// </summary>
	string LabelOperaInstallSteps(string startBold, string endBold, string breakLine);
	...
	/// </summary>
	string ResponseCheckAlwaysOpenRoblox(string startBold, string endBold, string startBold2, string endBold2);
	...
	/// </summary>
	string ResponseCheckAlwaysOpenRobloxURL(string startBold, string endBold, string startBold2, string endBold2);
	...
	/// </summary>
	string ResponseCheckRememberMyChoiceOK(string startBold, string endBold, string startBold2, string endBold2);
	...
	/// </summary>
	string ResponseDialogMacChromeFifthInstruction(string startBold, string endBold);
	...
	/// </summary>
	string ResponseDialogMacChromeFirstInstruction(string startBold, string endBold);
	...
	/// </summary>
	string ResponseDialogMacChromeFourthInstruction(string startBold, string endBold);
	...
	/// </summary>
	string ResponseDialogMacChromeThirdInstruction(string startBold, string endBold);
	...
	/// </summary>
	string ResponseDialogMacFirefoxFifthInstruction(string startBold, string endBold, string startBold2, string endBold2);
	...
	/// </summary>
	string ResponseDialogMacFirefoxFirstInstruction(string startBold, string endBold, string startBold2, string endBold2);
	...
	/// </summary>
	string ResponseDialogMacFirefoxFourthInstruction(string startBold, string endBold);
	...
	/// </summary>
	string ResponseDialogMacFirefoxSecondInstruction(string startBold, string endBold);
	...
	/// </summary>
	string ResponseDialogMacFirefoxThirdInstruction(string startBold, string endBold);
	...
	/// </summary>
	string ResponseDialogMacSafariFirstInstruction(string startBold, string endBold);
	...
	/// English String: "Once installed, click {startBold}Play{endBold} to join the action!"
	/// </summary>
	string ResponseDialogMacSafariFourthInstruction(string startBold, string endBold);
	...
	/// English String: "Double-click the {startBold}Roblox Icon{endBold} to begin the installation process"
	/// </summary>
	string ResponseDialogMacSafariSecondInstruction(string startBold, string endBold);
	...
	/// English String: "You will receive a warning, click {startBold}Open{endBold}"
	/// </summary>
	string ResponseDialogMacSafariThirdInstruction(string startBold, string endBold);
	...
	/// </summary>
	string ResponseDialogPcChromeFirstInstruction(string startBold, string endBold);
	...
	/// English String: "After installation, click {startBold}Play{endBold} below to join the action!"
	/// </summary>
	string ResponseDialogPcChromeFourthInstruction(string startBold, string endBold);
	...
	/// </summary>
	string ResponseDialogPcChromeSecondInstruction(string startBold, string endBold);
	...
	/// English String: "Click {startBold}Ok{endBold} once you've successfully installed Roblox."
	/// </summary>
	string ResponseDialogPcChromeThirdInstruction(string startBold, string endBold);
	...
	/// </summary>
	string ResponseDialogPcEdgeFirstInstruction(string startBold, string endBold);
	...
	/// </summary>
	string ResponseDialogPcEdgeSecondInstruction(string startBold, string endBold);
	...
	/// </summary>
	string ResponseDialogPcEdgeThirdInstruction(string startBold, string endBold);
	...
	/// </summary>
	string ResponseDialogPcFirefoxFifthInstruction(string startBold, string endBold);
	...
	/// </summary>
	string ResponseDialogPcFirefoxFirstInstruction(string startBold, string endBold);
	...
	/// English String: "Once installed, click {startBold}Play{endBold} to join the action!"
	/// </summary>
	string ResponseDialogPcFirefoxFourthInstruction(string startBold, string endBold);
	...
	/// </summary>
	string ResponseDialogPcFirefoxSecondInstruction(string startBold, string endBold);
	...
	/// </summary>
	string ResponseDialogPcFirefoxThirdInstruction(string startBold, string endBold);
	...
	/// </summary>
	string ResponseDialogPcIEFirstInstruction(string startBold, string endBold);
	...
	/// English String: "You will receive a warning, click {startBold}Run{endBold}"
	/// </summary>
	string ResponseDialogPcIeInstructionOne(string startBold, string endBold);
	...
	/// English String: "Click {startBold}Run{endBold}"
	/// </summary>
	string ResponseDialogPcIeInstructionThree(string startBold, string endBold);
	...
	/// English String: "Go to Downloads and double click {startBold}RobloxPlayer.exe{endBold}"
	/// </summary>
	string ResponseDialogPcIeInstructionTwo(string startBold, string endBold);
	...
	/// </summary>
	string ResponseDialogPcIESecondInstruction(string startBold, string endBold);
	...
	/// English String: "Once installed, click {startBold}Play{endBold} to join the action!"
	/// </summary>
	string ResponseDialogPcIEThirdInstruction(string startBold, string endBold);
