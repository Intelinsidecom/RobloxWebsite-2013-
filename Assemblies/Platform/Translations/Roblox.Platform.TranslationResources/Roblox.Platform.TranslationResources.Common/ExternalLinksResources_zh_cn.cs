...
/// </summary>
internal class ExternalLinksResources_zh_cn : ExternalLinksResources_en_us, IExternalLinksResources, ITranslationResources
{
	/// <summary>
	/// Key: "Link.Help"
	/// Help page link
	...
	public ExternalLinksResources_zh_cn(TranslationResourceState state)
		: base(state)
	{
	}
