...
/// </summary>
internal class GameSortsResources_zh_cn : GameSortsResources_en_us, IGameSortsResources, ITranslationResources
{
	/// <summary>
	/// Key: "Label.Adventure"
	...
	public GameSortsResources_zh_cn(TranslationResourceState state)
		: base(state)
	{
	}
