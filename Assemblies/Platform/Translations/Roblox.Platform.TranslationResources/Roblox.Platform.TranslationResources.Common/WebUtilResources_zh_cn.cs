...
/// </summary>
internal class WebUtilResources_zh_cn : WebUtilResources_en_us, IWebUtilResources, ITranslationResources
{
	public WebUtilResources_zh_cn(TranslationResourceState state)
		: base(state)
	{
	}
