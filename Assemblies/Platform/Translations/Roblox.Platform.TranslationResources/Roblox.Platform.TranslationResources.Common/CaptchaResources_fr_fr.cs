...
internal class CaptchaResources_fr_fr : CaptchaResources_en_us, ICaptchaResources, ITranslationResources
{
	...
	/// </summary>
	public override string ResponseCaptchaErrorFailedToLoad => "Nous devons v̩rifier que vous n'̻tes pas un robot. Veuillez d̩sactiver le bloqueur de votre navigateur ou essayer un autre navigateur.";
	...
	/// </summary>
	public override string ResponseCaptchaErrorFailedToVerify => "Erreur temporaire. Veuillez r̩essayer dans quelques minutes.";
	...
	/// English String: "Temporary error. Please try again in a few minutes"
	/// </summary>
	public override string ResponseCaptchaErrorVerifyFailed => "Erreur temporaire. Veuillez r̩essayer dans quelques minutes.";
	...
	{
		return "Nous devons v̩rifier que vous n'̻tes pas un robot. Veuillez d̩sactiver le bloqueur de votre navigateur ou essayer un autre navigateur.";
	}

	protected override string _GetTemplateForResponseCaptchaErrorFailedToVerify()
	{
		return "Erreur temporaire. Veuillez r̩essayer dans quelques minutes.";
	}
