...
internal class TranslationStorageBuilder : ITranslationStorageBuilder
{
    ...
    /// logger
    /// </exception>
    public TranslationStorageBuilder(Client.ITranslationStorageClient client, ITranslationStorageResponseConverter translationStorageResponseConverter, ILogger logger)
    {
    ...
    public void MigrateTranslations(IEnumerable<MigrateTranslationId> migrateTranslationIds, ContentSourceType contentSourceType, ContentVariantType contentVariantType)
    {
        ...
        Client.MigrateTranslationsRequest migrationRequest = new Client.MigrateTranslationsRequest();
        List<Client.MigrateTranslation> migrations = new List<Client.MigrateTranslation>();
        Client.ContentSourceType contentSource = new Client.ContentSourceType
        {
            Value = contentSourceType.ToString(),
            Description = contentSourceType.ToDescription()
        };
        Client.ContentVariantType variantType = GetClientContentVariantType(contentVariantType);
        foreach (MigrateTranslationId migrateTranslationId in migrateTranslationIds)
        {
            ...
            {
                migrations.Add(new Client.MigrateTranslation
                {
    ...
    private void CreateTranslation(ContentSourceType contentSourceType, ContentVariantType contentVariantType, string contentSourceTargetId, string supportedLocaleOrLanguageCode, string translationValue, bool isSourceContentVariantAndLocale, IChangeAgent changeAgent = null)
    {
        ...
        Client.CreateTranslationRequest createTranslationRequest = new Client.CreateTranslationRequest
        {
    ...
    private CreateOrUpdateTranslationStatus CreateOrUpdateTranslation(ContentSourceType contentSourceType, ContentVariantType contentVariantType, string contentSourceTargetId, string supportedLocaleOrLanguageCode, string translationValue, bool isSourceContentVariantAndLocale, IChangeAgent changeAgent = null)
    {
        ...
        Client.CreateOrUpdateTranslationRequest createOrUpdateCreateTranslationRequest = new Client.CreateOrUpdateTranslationRequest
        {
            ContentSourceType = new Client.ContentSourceType
            {
                Value = contentSourceType.ToString(),
        ...
        try
        {
            Client.CreateOrUpdateTranslationResponse clientResponse = _Client.CreateOrUpdateTranslation(createOrUpdateCreateTranslationRequest);
    ...
    private DeleteTranslationResponse DeleteTranslation(ContentSourceType contentSourceType, ContentVariantType contentVariantType, string contentSourceTargetId, string supportedLocaleOrLanguageCode, IChangeAgent changeAgent = null)
    {
        ...
        Client.DeleteTranslationRequest deleteTranslationRequest = new Client.DeleteTranslationRequest
        {
            ContentSourceType = new Client.ContentSourceType
            {
                Value = contentSourceType.ToString(),
        ...
        try
        {
            Client.DeleteTranslationResponse clientResponse = _Client.DeleteTranslation(deleteTranslationRequest);
    ...
    private void UpdateTranslation(ContentSourceType contentSourceType, ContentVariantType contentVariantType, string contentSourceTargetId, string supportedLocaleOrLanguageCode, string translationValue, IChangeAgent changeAgent = null)
    {
        ...
        Client.UpdateTranslationRequest updateTranslationRequest = new Client.UpdateTranslationRequest
        {
            ContentSourceType = new Client.ContentSourceType
            {
                Value = contentSourceType.ToString(),
    ...
    private Client.ContentVariantType GetClientContentVariantType(ContentVariantType contentVariantType)
    {
        //IL_0029: Unknown result type (might be due to invalid IL or missing references)
        Client.ContentVariantType? variantType = EnumUtils.StrictTryParseEnum<Client.ContentVariantType>(contentVariantType.ToString());
