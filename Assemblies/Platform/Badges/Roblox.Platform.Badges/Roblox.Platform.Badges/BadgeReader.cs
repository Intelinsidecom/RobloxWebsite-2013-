...
public class BadgeReader : IBadgeReader
{
    ...
    public BadgeReader(Roblox.Badges.Client.IBadgesClient badgesClient, ISettings settings)
    {
    ...
    public Badge GetBadge(long badgeId)
    {
        ...
        Roblox.Badges.Client.GetBadgeByIdResult getBadgeResult = _BadgesClient.GetById(new Roblox.Badges.Client.BadgeIdentifier
        {
            Id = badgeId
        });
    ...
    public ICollection<Badge> GetBadges(ICollection<long> badgeIds)
    {
        ...
        Roblox.Badges.Client.GetBadgesByIdsResult getBadgesByIdsResult = _BadgesClient.GetByIds((IReadOnlyCollection<Roblox.Badges.Client.BadgeIdentifier>)(object)((IEnumerable<long>)badgeIds).Select((Func<long, Roblox.Badges.Client.BadgeIdentifier>)((long bid) => new Roblox.Badges.Client.BadgeIdentifier
        {
            Id = bid
        })).ToArray());
        ...
        {
            Roblox.Badges.Client.Badge clientBadge = getBadgesByIdsResult.Badges.FirstOrDefault((Roblox.Badges.Client.Badge b) => ((Roblox.Badges.Client.BadgeIdentifier)b).Id == badgeId);
            if (clientBadge != null)
            {
                orderedBadges.Add(_BadgeConverter.ConvertToPlatformBadge(clientBadge));
            }
        }
    ...
    public IPlatformPageResponse<long, Badge> GetBadgesByAwarder(IBadgeAwarder badgeAwarder, IExclusiveStartKeyInfo<long> exclusiveStartInfo)
    {
        ...
        Roblox.Badges.Client.BadgeIdentifier exclusiveBadgeIdentifier = null;
        if (exclusiveStartInfo.TryGetExclusiveStartKey(out var exclusiveStartKey))
        {
            ...
            exclusiveBadgeIdentifier = new Roblox.Badges.Client.BadgeIdentifier
            {
