...
public interface IGameLocalizationSettingsAuthority
{
	...
	/// <returns>An <see cref="T:Roblox.Localization.Core.ILanguageFamily" /> which is the source language for the game or null.</returns>
	...
	/// <returns>A <see cref="T:System.Collections.Generic.IReadOnlyDictionary`2" /> of universe and corresponding <see cref="T:Roblox.Localization.Core.ILanguageFamily" />.</returns>
