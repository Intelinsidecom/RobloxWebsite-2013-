...
public class PrivateServerPermissionsFactory : IPrivateServerPermissionsFactory
{
	...
	/// <inheritdoc />
	public Roblox.Platform.Permissions.Core.IPermissionGroup GetPrivateServerPermissionGroup(long privateServerId)
	{
		List<Roblox.Platform.Permissions.Core.IPermissionGroup> permissionGroups = _PermissionGroupFactory.GetPermissionGroupsByAction("AccessPrivateServer", privateServerId).ToList();
    ...
    /// <inheritdoc />
    public Roblox.Platform.Permissions.Core.IPermissionGroup CreatePrivateServerPermissions(long privateServerId, long ownerUserId)
    {
        Roblox.Platform.Permissions.Core.IPermissionGroup permissionGroup = _PermissionGroupFactory.CreatePermissionGroup(evaluateByAND: false, $"Private Server {privateServerId}", ownerUserId, "User");
    ...
    {
        Roblox.Platform.Permissions.Core.IPermissionGroup permissionGroup = GetPrivateServerPermissionGroup(privateServerId);
    ...
    /// <inheritdoc />
    public IReadOnlyCollection<long> GetPrivateServerClanIdsWithAccess(long privateServerId, Roblox.Platform.Permissions.Core.IPermissionGroup permissionGroup = null)
    {
        if (permissionGroup == null)
        {
    ...
    /// <inheritdoc />
    public bool SetPrivateServerClanAccess(long privateServerId, IReadOnlyCollection<long> allowedClanIds, Roblox.Platform.Permissions.Core.IPermissionGroup permissionGroup = null)
    {
    ...
    public ICustomList GetPrivateServerWhitelist(long privateServerId)
    {
        ...
        Roblox.Platform.Permissions.Core.IPermission permission = GetPrivateServerWhitelistPermission(permissionGroup);
        if (permission == null)
        {
            return null;
        }
    ...
    private static Roblox.Platform.Permissions.Core.IPermission GetPrivateServerWhitelistPermission(Roblox.Platform.Permissions.Core.IPermissionGroup permissionGroup)
    {
        foreach (Roblox.Platform.Permissions.Core.IPermission perm in permissionGroup.GetPermissions(1))
        {
            if (Enum.TryParse<Roblox.Platform.Permissions.Core.PermissionType>(perm.PermissionType, out var permissionType) && permissionType == Roblox.Platform.Permissions.Core.PermissionType.IsInList)
            {
                return perm;
            }
        }
    ...
    private static Roblox.Platform.Permissions.Core.IPermission GetPrivateServerFriendsAccessPermission(Roblox.Platform.Permissions.Core.IPermissionGroup permissionGroup)
    {
        ...
        foreach (Roblox.Platform.Permissions.Core.IPermission perm in permissions)
        {
            if (Enum.TryParse<Roblox.Platform.Permissions.Core.PermissionType>(perm.PermissionType, out var permissionType) && permissionType == Roblox.Platform.Permissions.Core.PermissionType.IsFriend)
            {
                return perm;
            }
        }
    ...
    private static IEnumerable<Roblox.Platform.Permissions.Core.IPermission> GetPrivateServerClanAccessPermissions(Roblox.Platform.Permissions.Core.IPermissionGroup permissionGroup)
    {
        if (permissionGroup == null)
        {
        ...
        foreach (Roblox.Platform.Permissions.Core.IPermission perm in permissions)
        {
            if (perm.PermissionTypeTargetId.HasValue && Enum.TryParse<Roblox.Platform.Permissions.Core.PermissionType>(perm.PermissionType, out var permissionType) && permissionType == Roblox.Platform.Permissions.Core.PermissionType.IsInClan)
            {
                yield return perm;
            }
        }
