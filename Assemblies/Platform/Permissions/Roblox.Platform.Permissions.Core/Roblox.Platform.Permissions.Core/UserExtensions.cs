...
{
    public static IEnumerable<IPermissionGroup> GetPermissionGroups(this IUserIdentifier user, Api.IPermissionsClient permissionsApiClient, int page)
    {
        return permissionsApiClient.GetPermissionGroups(user.Id, "User", (int?)page)
            .PageItems
            .Select((Api.PermissionGroup apiPermissionGroup) => apiPermissionGroup.Translate(permissionsApiClient));
    }

    public static IPermissionGroup CreatePermissionGroup(this IUserIdentifier user, bool evaluateByAND, string name, Api.IPermissionsClient permissionsApiClient)
    {
        return permissionsApiClient.CreatePermissionGroup(evaluateByAND, name, user.Id, "User").Translate(permissionsApiClient);
    }
    ...
    public static IEnumerable<ICustomList> GetCustomLists(this IUserIdentifier user, Api.IPermissionsClient permissionsApiClient)
    {
        ...
        foreach (Api.List apiList in apiLists)
        {
            yield return apiList.Translate(permissionsApiClient);
        }
    }

    public static ICustomList CreateCustomList(this IUserIdentifier user, string name, Api.IPermissionsClient permissionsApiClient)
    {
    ...
    public static void AddListMember(this IUserIdentifier user, long listId, long userId, Api.IPermissionsClient permissionsApiClient)
    {
        permissionsApiClient.CreateListMember(listId, userId, user.Id, "User");
    }

    public static void DeleteListMember(this IUserIdentifier user, long listId, long userId, Api.IPermissionsClient permissionsApiClient)
    {
    ...
    public static void AddPermissionGroup(this IUserIdentifier user, IActionType actionType, IPermissionGroup permissionGroup, Api.IPermissionsClient permissionsApiClient, long? actionTargetTypeId = null)
    {
        user.VerifyIsNotNull();
    ...
    public static void RemovePermissionGroup(this IUserIdentifier user, IActionType actionType, IPermissionGroup permissionGroup, Api.IPermissionsClient permissionsApiClient, long? actionTargetTypeId = null)
    {
        permissionGroup.VerifyIsNotNull();
        user.VerifyIsCreator(permissionGroup);
