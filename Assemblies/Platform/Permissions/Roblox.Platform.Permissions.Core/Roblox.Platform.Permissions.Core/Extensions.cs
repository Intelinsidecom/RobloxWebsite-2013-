...
{
    internal static IPermissionGroup Translate(this Api.IPermissionGroup apiClientPermissionGroup, Api.IPermissionsClient permissionsApiClient)
    {
    ...
    internal static IAction Translate(this Api.Action apiAction)
    {
        return new Action(apiAction.ActionType, apiAction.ActionTargetId);
    }

    internal static ICustomList Translate(this Api.List apiList, Api.IPermissionsClient permissionsApiClient)
    {
        if (apiList == null)
        {
            return null;
    ...
    public static void AddPermissionGroup(this IActionType actionType, IPermissionGroup permissionGroup, Api.IPermissionsClient permissionsApiClient, long? actionTargetTypeId = null)
    {
    ...
    public static IEnumerable<IPermissionGroup> GetPermissionGroups(this IActionType actionType, long? targetId, Api.IPermissionsClient permissionsApiClient)
    {
        return from apiPermissionGroup in permissionsApiClient.GetPermissions(actionType.Value, targetId)
            select apiPermissionGroup.Translate(permissionsApiClient);
    }

    public static void RemovePermissionGroup(this IActionType actionType, IPermissionGroup permissionGroup, Api.IPermissionsClient permissionsApiClient, long? actionTargetTypeId = null)
    {
        permissionGroup.VerifyIsNotNull();
    ...
    public static bool IsCustomList(this IPermission permission, Api.IPermissionsClient permissionsApiClient)
    {
