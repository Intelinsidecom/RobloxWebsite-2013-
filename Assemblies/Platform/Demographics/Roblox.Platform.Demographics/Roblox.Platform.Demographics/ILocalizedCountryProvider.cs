...
{
	/// <summary>
	/// Get an <see cref="T:Roblox.Platform.Demographics.ILocalizedCountry" /> of a given <see cref="T:Roblox.Platform.Demographics.ICountry" /> for a specific <see cref="T:Roblox.Localization.Core.ISupportedLocale" />
	/// </summary>
	/// <param name="country"><see cref="T:Roblox.Platform.Demographics.ICountry" /></param>
	/// <param name="supportedLocale"><see cref="T:Roblox.Localization.Core.ISupportedLocale" /></param>
	...
	/// <summary>
	/// Get <see cref="T:Roblox.Platform.Demographics.ILocalizedCountry" /> collection of a given <see cref="T:Roblox.Platform.Demographics.ICountry" /> collection for a specific <see cref="T:Roblox.Localization.Core.ISupportedLocale" />
	/// </summary>
