...
public interface IPlaceIcon
{
	...
	/// <summary>
	/// Gets the <see cref="T:Roblox.Platform.Thumbs.ThumbResult" /> for this <see cref="T:Roblox.Platform.AssetMedia.IPlaceIcon" />'s image in the specified format, and size.
	/// </summary>
	...
	/// <summary>
	/// Gets the game icon <see cref="T:Roblox.Platform.Thumbs.ThumbResult" /> for this <see cref="T:Roblox.Platform.AssetMedia.IPlaceIcon" />.
	/// </summary>
	/// <param name="imageParameters">The <see cref="T:Roblox.Platform.Thumbs.ImageParameters" /> of the image to get.</param>
	/// <param name="returnAutoGenerated">The image will be auto generated using the thumbnail service of the user's place, if true.</param>
	/// <returns>The <see cref="T:Roblox.Platform.Thumbs.ThumbResult" /> for the game icon.</returns>
