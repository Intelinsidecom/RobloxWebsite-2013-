...
{
	/// <summary>
	/// Gets the <see cref="T:Roblox.Platform.Thumbs.ThumbResult" /> for a place icon image in the specified format, and size.
	/// </summary>
	...
	/// <returns>The <see cref="T:Roblox.Platform.Thumbs.ThumbResult" /> for the place icon image.</returns>
	...
	/// <summary>
	/// Gets the <see cref="T:Roblox.Platform.Thumbs.ThumbResult" /> for a place icon image with the given <see cref="T:Roblox.Platform.Thumbs.ImageParameters" />.
	/// </summary>
	/// <param name="placeId">The place ID.</param>
	/// <param name="imageId">The image ID of a place icon.</param>
