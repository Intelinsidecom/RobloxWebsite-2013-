...
public class PlaceMediaItem : IRobloxEntity<int, PlaceMediaItemDAL>, ICacheableObject<int>, ICacheableObject, IRemoteCacheableObject
{
	...
	public static CacheInfo EntityCacheInfo = new CacheInfo(new CacheabilitySettings(collectionsAreCacheable: true, countsAreCacheable: true, entityIsCacheable: true, idLookupsAreCacheable: true), "Roblox.Platform.AssetMedia.PlaceMediaItem", isNullCacheable: true);

	public int ID => _EntityDAL.ID;

	public long PlaceID
	{
		get => _EntityDAL.PlaceID;
		set => _EntityDAL.PlaceID = value;
	}

	public long MediaAssetID
	{
		get => _EntityDAL.MediaAssetID;
		set => _EntityDAL.MediaAssetID = value;
	}

	public long UploaderUserID
	{
		get => _EntityDAL.UploaderUserID;
		set => _EntityDAL.UploaderUserID = value;
	}

	public int SortOrder
	{
		get => _EntityDAL.SortOrder;
		set => _EntityDAL.SortOrder = value;
	}

	public DateTime Created
	{
		get => _EntityDAL.Created;
		set => _EntityDAL.Created = value;
	}

	public DateTime Updated
	{
		get => _EntityDAL.Updated;
