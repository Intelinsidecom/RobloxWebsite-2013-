...
public class SessionToken : IRobloxEntity<long, SessionTokenDAL>, ICacheableObject<long>, ICacheableObject, IRemoteCacheableObject
{
    ...
    internal SessionToken(SessionTokenDAL entityDAL)
    {
    ...
    public static SessionToken GetByToken(Guid token)
    {
