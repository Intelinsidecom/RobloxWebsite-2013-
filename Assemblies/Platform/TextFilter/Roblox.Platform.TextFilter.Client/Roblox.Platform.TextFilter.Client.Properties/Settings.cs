...
namespace Roblox.Platform.TextFilter.Client.Properties {
...
internal sealed class Settings : ApplicationSettingsBase, IServiceClientSettings, IHttpClientSettings, IDefaultCircuitBreakerPolicyConfig
{
	...
	public string Endpoint => RobloxEnvironment.GetInternalApiServiceEndpoint("textfilter");

	public string ClientName => "TextFilter";
