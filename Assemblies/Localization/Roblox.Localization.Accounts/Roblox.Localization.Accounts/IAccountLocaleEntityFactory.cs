...
{
	/// <summary>
	/// Gets an <see cref="T:Roblox.Localization.Accounts.IAccountLocaleEntity" /> by its ID.
	/// </summary>
	/// <param name="id">The ID.</param>
	/// <returns>The <see cref="T:Roblox.Localization.Accounts.IAccountLocaleEntity" /> with the given ID, or null if none existed.</returns>
	IAccountLocaleEntity Get(long id);

	/// <summary>
	/// Gets the <see cref="T:Roblox.Localization.Accounts.IAccountLocaleEntity" /> with the given accountId
	/// </summary>
	/// <param name="accountId">The accountId associated with AccountLocale.</param>
	/// <returns>The <see cref="T:Roblox.Localization.Accounts.IAccountLocaleEntity" /> with given accountId, or null if none existed.</returns>
	IAccountLocaleEntity GetByAccountId(long accountId);

	/// <summary>
	/// Create instance of <see cref="T:Roblox.Localization.Accounts.IAccountLocaleEntity" /> with the given account id, observed locale id and supported locale id
	/// </summary>
