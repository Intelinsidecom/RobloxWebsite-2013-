...
namespace Roblox.Localization.Audit {
    interface IAccountCountriesAuditMetadataEntityFactory

{
	...
	/// <summary>
	/// Gets a page of <see cref="T:Roblox.Platform.Localization.Audit.IAccountCountriesAuditMetadataEntity" />s by their AuditId and <see cref="T:Roblox.Localization.Accounts.AccountCountriesAuditEntryMetadataType" />.
	/// </summary>
	/// <param name="accountCountriesAuditEntryAuditId">The AccountCountries row ID.</param>
	/// <param name="accountCountriesAuditMetadataTypeId">The data that was changed. <see cref="T:Roblox.Localization.Accounts.AccountCountriesAuditEntryMetadataType" />.</param>
	...
	/// <param name="metadataType">The <see cref="T:Roblox.Localization.Accounts.AccountCountriesAuditEntryMetadataType" />.</param>
