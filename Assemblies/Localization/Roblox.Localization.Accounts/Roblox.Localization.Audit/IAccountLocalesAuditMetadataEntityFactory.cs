...

{
	...
	/// <summary>
	/// Gets a page of <see cref="T:Roblox.Platform.Localization.Audit.IAccountLocalesAuditMetadataEntity" />s by their AuditId and <see cref="T:Roblox.Localization.Accounts.AccountLocalesAuditEntryMetadataType" />.
	/// </summary>
	/// <param name="accountLocalesAuditEntryAuditId">The AccountLocales row ID.</param>
	/// <param name="accountLocalesAuditMetadataTypeId">The data that was changed. <see cref="T:Roblox.Localization.Accounts.AccountLocalesAuditEntryMetadataType" />.</param>
	...
	/// <param name="metadataType">The <see cref="T:Roblox.Localization.Accounts.AccountLocalesAuditEntryMetadataType" />.</param>
	/// <param name="changeAgentType">The <see cref="T:Roblox.Localization.Accounts.AccountLocalesChangeAgentType" />.</param>
