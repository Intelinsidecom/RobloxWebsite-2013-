...
{
    private readonly Client.ITranslationStorageClient _Client;
    ...
    /// logger
    /// </exception>
    public TranslationStorageAccessor(Client.ITranslationStorageClient client, ILogger logger)
    {
    ...
    public IReadOnlyCollection<ITranslationForContentLocale> GetTranslationForContentLocales(ContentSourceType contentSourceType, ContentVariantType contentVariantType, string contentSourceTargetId)
    {
        ...
        Client.ContentVariantType clientContentVariantType = ConvertToClientContentVariantType(contentVariantType);
        Client.GetTranslationsForContentLocalesRequest getTranslationsRequest = new Client.GetTranslationsForContentLocalesRequest
        {
            ContentSourceType = new Client.ContentSourceType
            {
        ...
        try
        {
            Client.GetTranslationsForContentLocalesResponse getTranslationsResponse = _Client.GetTranslationsForContentLocales(getTranslationsRequest);
    ...
    private string GetTranslation(ContentSourceType contentSourceType, ContentVariantType contentVariantType, string contentSourceTargetId, string supportedLocaleOrLangaugeCode)
    {
        ...
        Client.ContentVariantType clientContentVariantType = ConvertToClientContentVariantType(contentVariantType);
        Client.GetTranslationRequest getTranslationRequest = new Client.GetTranslationRequest
        {
            ContentSourceType = new Client.ContentSourceType
            {
                Value = contentSourceType.ToString()
    ...
    private IReadOnlyCollection<ITranslationForContentSourceTargetId> GetTranslationsForContentSourceTargetIds(ContentSourceType contentSourceType, ContentVariantType contentVariantType, IReadOnlyCollection<string> contentSourceTargetIds, string supportedLocaleOrLangaugeCode)
    {
        ...
        Client.ContentVariantType clientContentVariantType = ConvertToClientContentVariantType(contentVariantType);
        Client.GetTranslationsForContentSourceTargetIdsRequest getTranslationsRequest = new Client.GetTranslationsForContentSourceTargetIdsRequest
        {
            ContentSourceType = new Client.ContentSourceType
            {
                Value = contentSourceType.ToString()
        ...
        try
        {
            Client.GetTranslationsForContentSourceTargetIdsResponse getTranslationsResponse = _Client.GetTranslationsForContentSourceTargetIds(getTranslationsRequest);
            return ConvertToPlatform(getTranslationsResponse);
        }
        catch (Exception ex)
        {
    ...
    private IReadOnlyCollection<ITranslationForContentLocale> ConvertToPlatform(Client.GetTranslationsForContentLocalesResponse response)
    {
        List<ITranslationForContentLocale> translations = new List<ITranslationForContentLocale>();
        foreach (Client.ContentLocaleTranslationValue responseEntry in response.Translations)
        {
    ...
    private IReadOnlyCollection<ITranslationForContentSourceTargetId> ConvertToPlatform(Client.GetTranslationsForContentSourceTargetIdsResponse response)
    {
        List<ITranslationForContentSourceTargetId> translations = new List<ITranslationForContentSourceTargetId>();
        foreach (Client.ContentSourceTargetIdTranslationValue translation in response.Translations)
        {
    ...
    private Client.ContentVariantType ConvertToClientContentVariantType(ContentVariantType contentVariantType)
    {
        //IL_0029: Unknown result type (might be due to invalid IL or missing references)
        Client.ContentVariantType? clientContentVariantType = EnumUtils.StrictTryParseEnum<Client.ContentVariantType>(contentVariantType.ToString());
    ...
    private IGetTranslationHistoryResult DoGetTranslationHistory(string supportedLocaleOrLanguageCode, ContentSourceType contentSourceType, ContentVariantType contentVariantType, string contentSourceTargetId, string exclusiveStartId, int count, Roblox.DataV2.Core.SortOrder sortOrder)
    {
        ...
        Client.ContentVariantType clientContentVariantType = ConvertToClientContentVariantType(contentVariantType);
        Client.GetTranslationHistoryRequest getTranslationHistoryRequest = new Client.GetTranslationHistoryRequest
        {
            ContentSourceType = new Client.ContentSourceType
            {
                Value = contentSourceType.ToString()
        ...
        try
        {
            Client.GetTranslationHistoryResponse getTranslationHistoryResponse = _Client.GetTranslationHistory(getTranslationHistoryRequest);
    ...
    private IGetTranslationHistoryResult ConvertToPlatform(Client.GetTranslationHistoryResponse response)
    {
        List<ITranslationSummary> translationSummaries = new List<ITranslationSummary>();
        foreach (Client.TranslationSummary clientTranslationSummary in response.History)
        {
