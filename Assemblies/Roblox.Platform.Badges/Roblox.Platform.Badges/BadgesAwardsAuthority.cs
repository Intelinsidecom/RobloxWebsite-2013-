...
public class BadgesAwardsAuthority : IBadgesAwardsAuthority
{
    ...
    public BadgesAwardsAuthority(Roblox.Badges.Client.IBadgesClient badgesClient)
        : this(new RecipientFactory(), badgesClient)
    {
    }

    private static Roblox.Badges.Client.RecipientType ParseRecipientType(string targetType)
    {
        if (string.IsNullOrWhiteSpace(targetType))
        {
            return Roblox.Badges.Client.RecipientType.User;
        }
        if (Enum.TryParse<Roblox.Badges.Client.RecipientType>(targetType, true, out var parsed))
        {
            return parsed;
        }
        // Default to User if unexpected string provided
        return Roblox.Badges.Client.RecipientType.User;
    }
    ...
    internal BadgesAwardsAuthority(IRecipientFactory recipientFactory, Roblox.Badges.Client.IBadgesClient badgesClient)
    {
    ...
    public DateTime? GetBadgeAwardedDate(IUserIdentifier user, IBadgeIdentifier badge)
    {
        ...
        Roblox.Badges.Client.IsAwardedResult obj = _BadgesClient.IsAwarded(new Roblox.Badges.Client.Recipient
        {
            TargetId = recipient.TargetId,
            Type = ParseRecipientType(recipient.TargetType)
        }, new Roblox.Badges.Client.BadgeIdentifier
        {
            Id = badge.Id
        });
        if (obj == null)
    ...
    private bool Award(IRecipient recipient, IBadgeIdentifier badgeIdentifier)
    {
        ...
        try
        {
            return (int)_BadgesClient.AwardBadge(new Roblox.Badges.Client.Recipient
            {
                TargetId = recipient.TargetId,
                Type = ParseRecipientType(recipient.TargetType)
            }, new Roblox.Badges.Client.BadgeIdentifier
    ...
    private bool IsAwarded(IRecipient recipient, IBadgeIdentifier badgeIdentifier)
    {
        ...
        Roblox.Badges.Client.IsAwardedResult result;
        try
        {
            result = _BadgesClient.IsAwarded(new Roblox.Badges.Client.Recipient
            {
                TargetId = recipient.TargetId,
                Type = ParseRecipientType(recipient.TargetType)
            }, new Roblox.Badges.Client.BadgeIdentifier
    ...
    private bool Revoke(IRecipient recipient, IBadgeIdentifier badgeIdentifier)
    {
        ...
        Roblox.Badges.Client.RevokeBadgeResult result;
        try
        {
            result = _BadgesClient.RevokeBadge(new Roblox.Badges.Client.Recipient
            {
                TargetId = recipient.TargetId,
                Type = ParseRecipientType(recipient.TargetType)
            }, new Roblox.Badges.Client.BadgeIdentifier
    ...
    private IPlatformPageResponse<IAwardedBadgeIdentifier, IAwardedBadgeIdentifier> GetAwardedBadgesIdentifiersByRecipient(IRecipient recipient, IExclusiveStartKeyInfo<IAwardedBadgeIdentifier> exclusiveStartKeyInfo)
    {
        ...
        Roblox.Badges.Client.Recipient recipientDto = new Roblox.Badges.Client.Recipient
        {
            TargetId = recipient.TargetId,
            Type = ParseRecipientType(recipient.TargetType)
        };
        Roblox.Badges.Client.AwardedBadge exclusiveStartAwardedBadge = null;
        if (exclusiveStartKeyInfo.TryGetExclusiveStartKey(out var exclusiveStartKey))
        {
            exclusiveStartAwardedBadge = new Roblox.Badges.Client.AwardedBadge
            {
                BadgeIdentifier = new Roblox.Badges.Client.BadgeIdentifier
                {
        ...
        Roblox.Badges.Client.GetAwardedBadgesByRecipientResult result;
        try
        {
        ...
        return new PlatformPageResponse<IAwardedBadgeIdentifier, IAwardedBadgeIdentifier>(((IEnumerable<Roblox.Badges.Client.AwardedBadge>)result.AwardedBadges).Select((Func<Roblox.Badges.Client.AwardedBadge, IAwardedBadgeIdentifier>)((Roblox.Badges.Client.AwardedBadge ab) => new AwardedBadgeIdentifier(ab.BadgeIdentifier.Id, ab.Created))).ToArray(), exclusiveStartKeyInfo, _GetExclusiveStartKeyFunc);
    }
