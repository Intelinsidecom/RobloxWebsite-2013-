...
public class BadgeUpdater : IBadgeUpdater
{
    ...
    public BadgeUpdater(ISettings settings, Roblox.Badges.Client.IBadgesClient badgesClient, IBadgeTextFilter badgeTextFilter)
    {
    ...
    public void SetNameAndDescription(Badge badge, IClientTextAuthor textAuthor, string newName, string newDescription, IUserIdentifier actorUserIdentity)
    {
        ...
        Roblox.Badges.Client.Badge clientBadge = _BadgeConverter.ConvertToClientBadge(badge);
        clientBadge.Name = badgeTextFilterResult.Name;
        clientBadge.Description = badgeTextFilterResult.Description;
        Roblox.Badges.Client.UpdateBadgeResult updateBadgeResult = _BadgesClient.Update(clientBadge);
