...
internal sealed class Settings : ApplicationSettingsBase, IServiceClientSettings, IHttpClientSettings, IDefaultCircuitBreakerPolicyConfig, ISettings
{
	...
	public string ClientName => "Localization";
	...
	public TimeSpan LanguageFamilyLocalCacheExpiry => (TimeSpan)((SettingsBase)this)["LanguageFamilyLocalCacheExpiry"];

	[ApplicationScopedSetting]
	[DebuggerNonUserCode]
	[DefaultSettingValue("00:10:00")]
	public TimeSpan SupportedLocaleLocalCacheExpiry => (TimeSpan)((SettingsBase)this)["SupportedLocaleLocalCacheExpiry"];

	[ApplicationScopedSetting]
	[DebuggerNonUserCode]
	[DefaultSettingValue("01:00:00")]
	public TimeSpan DeviceReportedLocaleCacheExpiry => (TimeSpan)((SettingsBase)this)["DeviceReportedLocaleCacheExpiry"];

	[ApplicationScopedSetting]
	[DebuggerNonUserCode]
	[DefaultSettingValue("")]
	public string Endpoint => (string)((SettingsBase)this)["Endpoint"];
