...
{
	/// <summary>
	/// The absolute <see cref="T:System.Uri" /> of the static content given a <see cref="T:Roblox.Platform.StaticContent.StaticContentComponent" /> and <see cref="T:Roblox.Platform.StaticContent.Client.StaticContentContentType" />. 
	/// </summary>
	...
	/// </exception>
	/// <returns>An <see cref="T:System.Collections.Generic.ISet`1" /> of <see cref="T:System.Uri" />s for a specific <see cref="T:Roblox.Platform.StaticContent.Client.StaticContentContentType" /> (could be empty if no content is available.)</returns>
	ISet<Uri> GetStaticContentUrls(Roblox.Platform.StaticContent.StaticContentComponent component, Roblox.Platform.StaticContent.Client.StaticContentContentType contentType);
	...
	ISet<string> GetTranslationResourceNamespaces(Roblox.Platform.StaticContent.StaticContentComponent component);
	...
	ISet<Roblox.Platform.StaticContent.StaticContentComponent> GetComponentDependencies(Roblox.Platform.StaticContent.StaticContentComponent component);
}
