...
{
    private Dictionary<SupportedLocaleEnum, LocaleSettings> _LocaleSettingsMap;

    private LocaleRolloutSettings _LocaleRolloutSettings;

    private UgcLocaleRolloutSettings _UgcLocaleRolloutSettings;

    public LocaleSettingsMapper(LocaleRolloutSettings localeRolloutSettings, UgcLocaleRolloutSettings ugcLocaleRolloutSettings)
    {
    ...
    private Dictionary<SupportedLocaleEnum, LocaleSettings> GetLocaleSettingsMap()
    {
        return new Dictionary<SupportedLocaleEnum, LocaleSettings>
        {
            {
