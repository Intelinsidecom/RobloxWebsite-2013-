...
public class Program
{
	...
	private readonly Roblox.Platform.StaticContent.Client.IStaticContentClient _StaticContentClient;
	...
	public Program(ILogger logger, Func<string> apiKeyGetter, string staticContentServiceEndpoint)
	{
		...
		Roblox.Platform.StaticContent.Client.StaticContentClient staticContentClient = new Roblox.Platform.StaticContent.Client.StaticContentClient(new HttpClientBuilder(staticContentClientSettings, counterRegistry, apiKeyGetter), staticContentClientSettings);
	...
	public static void Main(string[] args)
	{
		...
		{
			if (Enum.TryParse<Roblox.Platform.StaticContent.StaticContentComponent>(componentConfiguration.Name, ignoreCase: true, out var component))
			{
	...
	public void Run(Roblox.Platform.StaticContent.StaticContentComponent component, string contentPackName, ICollection<string> fileNames, ISet<string> translationResourceNamespaces, ISet<string> componentDependencies)
	{
