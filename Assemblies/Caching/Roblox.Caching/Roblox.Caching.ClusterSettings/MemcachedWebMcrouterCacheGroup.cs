...
internal sealed class MemcachedWebMcrouterCacheGroup : ApplicationSettingsBase, IExposedMemCachedClientSettings, INotifyPropertyChanged, ISamplingSharedCacheClientSettings
{
	...
	public bool IsForceResetBytesEnabled => (bool)base["IsForceResetBytesEnabled"];
	...
	[DebuggerNonUserCode]
	[DefaultSettingValue("00:01:00")]
	public TimeSpan LogExpiration => (TimeSpan)base["LogExpiration"];

	[ApplicationScopedSetting]
	[DebuggerNonUserCode]
	[DefaultSettingValue("")]
	public string InfluxUrl => (string)base["InfluxUrl"];

	[ApplicationScopedSetting]
	[DebuggerNonUserCode]
	[DefaultSettingValue("")]
	public string InfluxDatabase => (string)base["InfluxDatabase"];

	[ApplicationScopedSetting]
	[DebuggerNonUserCode]
	[DefaultSettingValue("2000")]
	public int SampleStackTraceSubstringLength => (int)base["SampleStackTraceSubstringLength"];

	[ApplicationScopedSetting]
	[DebuggerNonUserCode]
	[DefaultSettingValue("00:15:00")]
	public TimeSpan SampleLogExpiration => (TimeSpan)base["SampleLogExpiration"];

	[ApplicationScopedSetting]
	[DebuggerNonUserCode]
	[DefaultSettingValue("0")]
	public uint SampleRatePerThousand => (uint)base["SampleRatePerThousand"];
