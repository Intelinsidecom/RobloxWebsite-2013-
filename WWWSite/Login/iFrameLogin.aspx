...
<head><title>
    ...
    <link rel='text/javascript' href='/js/iFrameLogin.js' />
                ...
                <div class="newLogin" id="newLoginContainer">
                    ...
                    <div class="LoginFormFieldSet">
                        ...
                        <span id="LoggingInStatus" style="display: none; position: absolute; right: 8px;margin-top: -11px;top: 50%;">
						    <img src="https://localhost:44352/Images/ProgressIndicator2.gif" style="margin-right: 5px;width: 20px;height: 20px;" alt="" />
