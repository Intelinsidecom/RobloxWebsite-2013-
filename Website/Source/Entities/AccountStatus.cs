...
{
    [Serializable]
    public class AccountStatus : IAccountStatus, IComparable<AccountStatus>, IRobloxEntity<byte, AccountStatusDAL>, ICacheableObject<byte>, ICacheableObject, IRemoteCacheableObject
    {
	...
	public int CompareTo(AccountStatus other)
	{
