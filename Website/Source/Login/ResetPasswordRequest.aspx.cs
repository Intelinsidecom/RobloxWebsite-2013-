...
namespace Roblox.Website.Login
{
    public partial class ResetPasswordRequest : System.Web.UI.Page
    {
        ...
        private bool AttemptUsernamesReminder(out string message, string emailAddress)
        {
            ...
            // Using CredentialValidator to validate email
            var credentialValidator = Global.AuthenticationDomainFactories.CredentialValidator;
            // We need a userId for the ValidateEmail method, using 0 as a placeholder
            if (credentialValidator.ValidateEmail(0, emailAddress))
            {
